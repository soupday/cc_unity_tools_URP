...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g975( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g972( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g972 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g972 = lerp( break109_g972.g , ( 1.0 - break109_g972.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g972 = (float3(break109_g972.r , lerpResult123_g972 , break109_g972.b));
				float3 NormalTS13_g975 = ( ( appendResult98_g972 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g975 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g975 = float3x3(ase_worldTangent, Binormal5_g975, ase_worldNormal);
				float3x3 TBN13_g975 = TBN1_g975;
				float3 localTangentToWorld13_g975 = TangentToWorld13_g975( NormalTS13_g975 , TBN13_g975 );
				float3 flowTangent107_g972 = localTangentToWorld13_g975;
				...
				float3 tanNormal85_g972 = normal282;
				float3 worldNormal85_g972 = normalize( float3(dot(tanToWorld0,tanNormal85_g972), dot(tanToWorld1,tanNormal85_g972), dot(tanToWorld2,tanNormal85_g972)) );
				float3 worldNormal86_g972 = worldNormal85_g972;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g972 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g976 = normalize( ( flowTangent107_g972 + ( worldNormal86_g972 * lerpResult81_g972 ) ) );
				float3 shiftedTangent119_g972 = normalizeResult10_g976;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g973 = ase_worldViewDir;
				float3 worldLight248_g972 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g973 = worldLight248_g972;
				float3 normalizeResult14_g974 = normalize( ( viewDIr52_g973 + lightDir55_g973 ) );
				float dotResult16_g974 = dot( shiftedTangent119_g972 , normalizeResult14_g974 );
				float smoothstepResult22_g974 = smoothstep( -1.0 , 0.0 , dotResult16_g974);
				...
				float temp_output_233_0_g972 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g972 = ( max( ( ( 2.0 / ( temp_output_233_0_g972 * temp_output_233_0_g972 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g972 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g972 = _SpecularTint;
				float4 temp_output_13_0_g973 = ( ( smoothstepResult22_g974 * pow( saturate( ( 1.0 - ( dotResult16_g974 * dotResult16_g974 ) ) ) , specularPower237_g972 ) ) * temp_output_132_0_g972 * temp_output_131_0_g972 );
				...
				float4 lerpResult18_g978 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g978 = root58;
				float lerpResult23_g978 = lerp( temp_output_27_0_g978 , ( 1.0 - temp_output_27_0_g978 ) , _InvertRootMap);
				float4 lerpResult3_g978 = lerp( _RootColor , _EndColor , lerpResult23_g978);
				float lerpResult40_g978 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g978);
				float4 lerpResult6_g978 = lerp( lerpResult18_g978 , lerpResult3_g978 , ( lerpResult40_g978 * _GlobalStrength ));
				float3 From8_g977 = _HighlightADistribution;
				float ID8_g977 = idMap383;
				float Fac8_g977 = _HighlightAStrength;
				float localThreePointDistribution8_g977 = ThreePointDistribution( From8_g977 , ID8_g977 , Fac8_g977 );
				float temp_output_24_0_g977 = root58;
				float lerpResult16_g977 = lerp( temp_output_24_0_g977 , ( 1.0 - temp_output_24_0_g977 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g977 = lerp( lerpResult6_g978 , _HighlightAColor , saturate( ( localThreePointDistribution8_g977 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g977 ) ) * _HighlightBlend ) ));
				float3 From8_g971 = _HighlightBDistribution;
				float ID8_g971 = idMap383;
				float Fac8_g971 = _HighlightBStrength;
				float localThreePointDistribution8_g971 = ThreePointDistribution( From8_g971 , ID8_g971 , Fac8_g971 );
				float temp_output_24_0_g971 = root58;
				float lerpResult16_g971 = lerp( temp_output_24_0_g971 , ( 1.0 - temp_output_24_0_g971 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g971 = lerp( lerpResult18_g977 , _HighlightBColor , saturate( ( localThreePointDistribution8_g971 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g971 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g971;
				#else
				...
				float4 temp_output_42_0_g972 = baseColor331;
				float4 temp_output_32_0_g973 = temp_output_42_0_g972;
				float temp_output_172_0_g972 = _SpecularMix;
				float4 lerpResult36_g973 = lerp( temp_output_13_0_g973 , ( temp_output_13_0_g973 * temp_output_32_0_g973 ) , temp_output_172_0_g972);
				float3 temp_output_24_0_g973 = worldNormal86_g972;
				float dotResult15_g973 = dot( lightDir55_g973 , temp_output_24_0_g973 );
				float temp_output_200_0_g972 = _Translucency;
				float temp_output_40_0_g973 = temp_output_200_0_g972;
				float dotResult54_g973 = dot( temp_output_24_0_g973 , viewDIr52_g973 );
				float dotResult57_g973 = dot( viewDIr52_g973 , lightDir55_g973 );
				float temp_output_208_0_g972 = _RimPower;
				float temp_output_207_0_g972 = _RimTransmissionIntensity;
				float3 Color126_g972 = temp_output_42_0_g972.rgb;
				float3 TangentWorld126_g972 = shiftedTangent119_g972;
				float3 ViewDir126_g972 = ase_worldViewDir;
				float3 NormalWorld126_g972 = worldNormal86_g972;
				float3 SpecularColor126_g972 = temp_output_131_0_g972.rgb;
				float SpecularTint126_g972 = temp_output_172_0_g972;
				float SpecularPower126_g972 = specularPower237_g972;
				float SpecularMultiplier126_g972 = temp_output_132_0_g972;
				float3 worldPosition129_g972 = WorldPosition;
				float3 PositionWorld126_g972 = worldPosition129_g972;
				float Translucency126_g972 = temp_output_200_0_g972;
				float RimTransmission126_g972 = temp_output_207_0_g972;
				float RimPower126_g972 = temp_output_208_0_g972;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g972 = RL_Amplify_Expression_HairLighting_Additional126_g972( Color126_g972 , TangentWorld126_g972 , ViewDir126_g972 , NormalWorld126_g972 , SpecularColor126_g972 , SpecularTint126_g972 , SpecularPower126_g972 , SpecularMultiplier126_g972 , PositionWorld126_g972 , Translucency126_g972 , RimTransmission126_g972 , RimPower126_g972 );
				float lerpResult632 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult632;
				float temp_output_161_0_g972 = ambientOcclusion570;
				float lerpResult280_g972 = lerp( 1.0 , temp_output_161_0_g972 , _AOOccludeAll);
				float3 bakedGI53_g972 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g972);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g972, bakedGI53_g972, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g973 + ( ( saturate( ( ( dotResult15_g973 * ( 1.0 - temp_output_40_0_g973 ) ) + temp_output_40_0_g973 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g973 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g973 ) , 0.0 ) ) , temp_output_208_0_g972 ) * temp_output_207_0_g972 ) ) * temp_output_32_0_g973 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g972 , 0.0 ) ) * lerpResult280_g972 ) + ( float4( bakedGI53_g972 , 0.0 ) * temp_output_42_0_g972 * temp_output_161_0_g972 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=19001
1913;36;1920;993;1874.827;-670.8317;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;627;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;971;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;978.6932,1167.645;Float;False;True;-1;2;ASEMaterialInspector;0;12;Reallusion/Amplify/RL_HairShader_Coverage_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992251365997;DOTS Instancing;0;0;Meta Pass;1;637793397279481765;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;5;False;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=EADEF551BDFC24630ECFF5259A24DB66274FFB3C