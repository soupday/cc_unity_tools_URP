	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * saturate( ( ( lerpResult36_g991 + ( ( saturate( ( ( dotResult15_g991 * ( 1.0 - temp_output_40_0_g991 ) ) + temp_output_40_0_g991 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g991 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g991 ) , 0.0 ) ) , temp_output_208_0_g988 ) * temp_output_207_0_g988 ) ) * temp_output_32_0_g991 ) ) * ase_lightColor ) ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g988 , 0.0 ) ) * lerpResult280_g988 ) + ( half4( bakedGI53_g988 , 0.0 ) * temp_output_42_0_g988 * temp_output_161_0_g988 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
ASEEND*/
//CHKSM=6C10C03DB425E8395189C86D026FBAB9B607ECB6