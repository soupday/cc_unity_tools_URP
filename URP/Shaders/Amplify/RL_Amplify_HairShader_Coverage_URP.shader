...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g964( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g963( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g963 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g963 = lerp( break109_g963.g , ( 1.0 - break109_g963.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g963 = (float3(break109_g963.r , lerpResult123_g963 , break109_g963.b));
				float3 NormalTS13_g964 = ( ( appendResult98_g963 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g964 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g964 = float3x3(ase_worldTangent, Binormal5_g964, ase_worldNormal);
				float3x3 TBN13_g964 = TBN1_g964;
				float3 localTangentToWorld13_g964 = TangentToWorld13_g964( NormalTS13_g964 , TBN13_g964 );
				float3 flowTangent107_g963 = localTangentToWorld13_g964;
				...
				float3 tanNormal85_g963 = normal282;
				float3 worldNormal85_g963 = normalize( float3(dot(tanToWorld0,tanNormal85_g963), dot(tanToWorld1,tanNormal85_g963), dot(tanToWorld2,tanNormal85_g963)) );
				float3 worldNormal86_g963 = worldNormal85_g963;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g963 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g965 = normalize( ( flowTangent107_g963 + ( worldNormal86_g963 * lerpResult81_g963 ) ) );
				float3 shiftedTangent119_g963 = normalizeResult10_g965;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g966 = ase_worldViewDir;
				float3 worldLight248_g963 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g966 = worldLight248_g963;
				float3 normalizeResult14_g967 = normalize( ( viewDIr52_g966 + lightDir55_g966 ) );
				float dotResult16_g967 = dot( shiftedTangent119_g963 , normalizeResult14_g967 );
				float smoothstepResult22_g967 = smoothstep( -1.0 , 0.0 , dotResult16_g967);
				...
				float temp_output_233_0_g963 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g963 = ( max( ( ( 2.0 / ( temp_output_233_0_g963 * temp_output_233_0_g963 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g963 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g963 = _SpecularTint;
				float4 temp_output_13_0_g966 = ( ( smoothstepResult22_g967 * pow( saturate( ( 1.0 - ( dotResult16_g967 * dotResult16_g967 ) ) ) , specularPower237_g963 ) ) * temp_output_132_0_g963 * temp_output_131_0_g963 );
				...
				float4 lerpResult18_g971 = lerp( lerpResult18_g970 , _HighlightBColor , saturate( ( localThreePointDistribution8_g971 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g971 ) ) * _HighlightBlend ) ));
				...
				float4 temp_output_42_0_g963 = baseColor331;
				float4 temp_output_32_0_g966 = temp_output_42_0_g963;
				float temp_output_172_0_g963 = _SpecularMix;
				float4 lerpResult36_g966 = lerp( temp_output_13_0_g966 , ( temp_output_13_0_g966 * temp_output_32_0_g966 ) , temp_output_172_0_g963);
				float3 temp_output_24_0_g966 = worldNormal86_g963;
				float dotResult15_g966 = dot( lightDir55_g966 , temp_output_24_0_g966 );
				float temp_output_200_0_g963 = _Translucency;
				float temp_output_40_0_g966 = temp_output_200_0_g963;
				float dotResult54_g966 = dot( temp_output_24_0_g966 , viewDIr52_g966 );
				float dotResult57_g966 = dot( viewDIr52_g966 , lightDir55_g966 );
				float temp_output_208_0_g963 = _RimPower;
				float temp_output_207_0_g963 = _RimTransmissionIntensity;
				float3 Color126_g963 = temp_output_42_0_g963.rgb;
				float3 TangentWorld126_g963 = shiftedTangent119_g963;
				float3 ViewDir126_g963 = ase_worldViewDir;
				float3 NormalWorld126_g963 = worldNormal86_g963;
				float3 SpecularColor126_g963 = temp_output_131_0_g963.rgb;
				float SpecularTint126_g963 = temp_output_172_0_g963;
				float SpecularPower126_g963 = specularPower237_g963;
				float SpecularMultiplier126_g963 = temp_output_132_0_g963;
				float3 worldPosition129_g963 = WorldPosition;
				float3 PositionWorld126_g963 = worldPosition129_g963;
				float Translucency126_g963 = temp_output_200_0_g963;
				float RimTransmission126_g963 = temp_output_207_0_g963;
				float RimPower126_g963 = temp_output_208_0_g963;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g963 = RL_Amplify_Expression_HairLighting_Additional126_g963( Color126_g963 , TangentWorld126_g963 , ViewDir126_g963 , NormalWorld126_g963 , SpecularColor126_g963 , SpecularTint126_g963 , SpecularPower126_g963 , SpecularMultiplier126_g963 , PositionWorld126_g963 , Translucency126_g963 , RimTransmission126_g963 , RimPower126_g963 );
				float lerpResult632 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult632;
				float temp_output_161_0_g963 = ambientOcclusion570;
				float lerpResult280_g963 = lerp( 1.0 , temp_output_161_0_g963 , _AOOccludeAll);
				float3 bakedGI53_g963 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g963);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g963, bakedGI53_g963, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g966 + ( ( saturate( ( ( dotResult15_g966 * ( 1.0 - temp_output_40_0_g966 ) ) + temp_output_40_0_g966 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g966 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g966 ) , 0.0 ) ) , temp_output_208_0_g963 ) * temp_output_207_0_g963 ) ) * temp_output_32_0_g966 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g963 , 0.0 ) ) * lerpResult280_g963 ) + ( float4( bakedGI53_g963 , 0.0 ) * temp_output_42_0_g963 * temp_output_161_0_g963 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
ASEEND*/
//CHKSM=6219BED3410C0000CD4B854D80B9AD01CBEE0954