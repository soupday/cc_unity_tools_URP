...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g915( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g914( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g914 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g914 = lerp( break109_g914.g , ( 1.0 - break109_g914.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g914 = (float3(break109_g914.r , lerpResult123_g914 , break109_g914.b));
				float3 NormalTS13_g915 = ( ( appendResult98_g914 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g915 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g915 = float3x3(ase_worldTangent, Binormal5_g915, ase_worldNormal);
				float3x3 TBN13_g915 = TBN1_g915;
				float3 localTangentToWorld13_g915 = TangentToWorld13_g915( NormalTS13_g915 , TBN13_g915 );
				float3 flowTangent107_g914 = localTangentToWorld13_g915;
				...
				float3 tanNormal85_g914 = normal282;
				float3 worldNormal85_g914 = normalize( float3(dot(tanToWorld0,tanNormal85_g914), dot(tanToWorld1,tanNormal85_g914), dot(tanToWorld2,tanNormal85_g914)) );
				float3 worldNormal86_g914 = worldNormal85_g914;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g914 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g918 = normalize( ( flowTangent107_g914 + ( worldNormal86_g914 * lerpResult81_g914 ) ) );
				float3 shiftedTangent119_g914 = normalizeResult10_g918;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g916 = ase_worldViewDir;
				float3 lightDir55_g916 = SafeNormalize(_MainLightPosition.xyz);
				float3 normalizeResult14_g917 = normalize( ( viewDIr52_g916 + lightDir55_g916 ) );
				float dotResult16_g917 = dot( shiftedTangent119_g914 , normalizeResult14_g917 );
				float smoothstepResult22_g917 = smoothstep( -1.0 , 0.0 , dotResult16_g917);
				...
				float temp_output_233_0_g914 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g914 = ( max( ( ( 2.0 / ( temp_output_233_0_g914 * temp_output_233_0_g914 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float temp_output_132_0_g914 = _SpecularMultiplier;
				float4 temp_output_131_0_g914 = _SpecularTint;
				float4 temp_output_13_0_g916 = ( ( smoothstepResult22_g917 * pow( saturate( ( 1.0 - ( dotResult16_g917 * dotResult16_g917 ) ) ) , specularPower237_g914 ) ) * temp_output_132_0_g914 * temp_output_131_0_g914 );
				...
				float3 From8_g912 = _HighlightADistribution;
				float ID8_g912 = idMap383;
				float Fac8_g912 = _HighlightAStrength;
				float localThreePointDistribution8_g912 = ThreePointDistribution( From8_g912 , ID8_g912 , Fac8_g912 );
				float temp_output_24_0_g912 = root58;
				float lerpResult16_g912 = lerp( ( 1.0 - temp_output_24_0_g912 ) , temp_output_24_0_g912 , _HighlightAOverlapInvert);
				float4 lerpResult18_g912 = lerp( lerpResult6_g913 , _HighlightAColor , saturate( ( localThreePointDistribution8_g912 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g912 ) ) ) ) ));
				...
				float4 lerpResult18_g919 = lerp( lerpResult18_g912 , _HighlightBColor , saturate( ( localThreePointDistribution8_g919 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g919 ) ) ) ) ));
				...
				float4 temp_output_42_0_g914 = baseColor331;
				float4 temp_output_32_0_g916 = temp_output_42_0_g914;
				float temp_output_172_0_g914 = _SpecularMix;
				float4 lerpResult36_g916 = lerp( temp_output_13_0_g916 , ( temp_output_13_0_g916 * temp_output_32_0_g916 ) , temp_output_172_0_g914);
				float3 temp_output_24_0_g916 = worldNormal86_g914;
				float dotResult15_g916 = dot( lightDir55_g916 , temp_output_24_0_g916 );
				float temp_output_200_0_g914 = _Translucency;
				float temp_output_40_0_g916 = temp_output_200_0_g914;
				float dotResult54_g916 = dot( temp_output_24_0_g916 , viewDIr52_g916 );
				float dotResult57_g916 = dot( viewDIr52_g916 , lightDir55_g916 );
				float temp_output_208_0_g914 = _RimPower;
				float temp_output_207_0_g914 = _RimTransmissionIntensity;
				float3 Color126_g914 = temp_output_42_0_g914.rgb;
				float3 TangentWorld126_g914 = shiftedTangent119_g914;
				float3 ViewDir126_g914 = ase_worldViewDir;
				float3 NormalWorld126_g914 = worldNormal86_g914;
				float3 SpecularColor126_g914 = temp_output_131_0_g914.rgb;
				float SpecularTint126_g914 = temp_output_172_0_g914;
				float SpecularPower126_g914 = specularPower237_g914;
				float SpecularMultiplier126_g914 = temp_output_132_0_g914;
				float3 worldPosition129_g914 = WorldPosition;
				float3 PositionWorld126_g914 = worldPosition129_g914;
				float Translucency126_g914 = temp_output_200_0_g914;
				float RimTransmission126_g914 = temp_output_207_0_g914;
				float RimPower126_g914 = temp_output_208_0_g914;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g914 = RL_Amplify_Expression_HairLighting_Additional126_g914( Color126_g914 , TangentWorld126_g914 , ViewDir126_g914 , NormalWorld126_g914 , SpecularColor126_g914 , SpecularTint126_g914 , SpecularPower126_g914 , SpecularMultiplier126_g914 , PositionWorld126_g914 , Translucency126_g914 , RimTransmission126_g914 , RimPower126_g914 );
				float3 tanNormal53_g914 = worldNormal86_g914;
				float3 bakedGI53_g914 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g914), dot(tanToWorld1,tanNormal53_g914), dot(tanToWorld2,tanNormal53_g914)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g914), dot(tanToWorld1,tanNormal53_g914), dot(tanToWorld2,tanNormal53_g914)), bakedGI53_g914, half4(0,0,0,0));
				float ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
				float temp_output_161_0_g914 = ambientOcclusion570;
				float temp_output_178_0_g914 = _AOOccludeAll;
				float lerpResult180_g914 = lerp( temp_output_161_0_g914 , 1.0 , temp_output_178_0_g914);
				float lerpResult183_g914 = lerp( 1.0 , temp_output_161_0_g914 , temp_output_178_0_g914);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g916 + ( ( saturate( ( ( dotResult15_g916 * ( 1.0 - temp_output_40_0_g916 ) ) + temp_output_40_0_g916 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g916 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g916 ) , 0.0 ) ) , temp_output_208_0_g914 ) * temp_output_207_0_g914 ) ) * temp_output_32_0_g916 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g914 , 0.0 ) ) + ( float4( bakedGI53_g914 , 0.0 ) * temp_output_42_0_g914 * lerpResult180_g914 ) ) * lerpResult183_g914 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1913;24;1920;1005;153.3198;-1131.86;1;True;False
...
ASEEND*/
//CHKSM=5615870A1044B76E188D9432C96BF95C075C3943