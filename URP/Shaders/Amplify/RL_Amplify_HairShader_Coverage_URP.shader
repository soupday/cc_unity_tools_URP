...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g955( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g954( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g954 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g954 = lerp( break109_g954.g , ( 1.0 - break109_g954.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g954 = (float3(break109_g954.r , lerpResult123_g954 , break109_g954.b));
				float3 NormalTS13_g955 = ( ( appendResult98_g954 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g955 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g955 = float3x3(ase_worldTangent, Binormal5_g955, ase_worldNormal);
				float3x3 TBN13_g955 = TBN1_g955;
				float3 localTangentToWorld13_g955 = TangentToWorld13_g955( NormalTS13_g955 , TBN13_g955 );
				float3 flowTangent107_g954 = localTangentToWorld13_g955;
				...
				float3 tanNormal85_g954 = normal282;
				float3 worldNormal85_g954 = normalize( float3(dot(tanToWorld0,tanNormal85_g954), dot(tanToWorld1,tanNormal85_g954), dot(tanToWorld2,tanNormal85_g954)) );
				float3 worldNormal86_g954 = worldNormal85_g954;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g954 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g956 = normalize( ( flowTangent107_g954 + ( worldNormal86_g954 * lerpResult81_g954 ) ) );
				float3 shiftedTangent119_g954 = normalizeResult10_g956;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g957 = ase_worldViewDir;
				float3 worldLight248_g954 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g957 = worldLight248_g954;
				float3 normalizeResult14_g958 = normalize( ( viewDIr52_g957 + lightDir55_g957 ) );
				float dotResult16_g958 = dot( shiftedTangent119_g954 , normalizeResult14_g958 );
				float smoothstepResult22_g958 = smoothstep( -1.0 , 0.0 , dotResult16_g958);
				...
				float temp_output_233_0_g954 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g954 = ( max( ( ( 2.0 / ( temp_output_233_0_g954 * temp_output_233_0_g954 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g954 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g954 = _SpecularTint;
				float4 temp_output_13_0_g957 = ( ( smoothstepResult22_g958 * pow( saturate( ( 1.0 - ( dotResult16_g958 * dotResult16_g958 ) ) ) , specularPower237_g954 ) ) * temp_output_132_0_g954 * temp_output_131_0_g954 );
				...
				float3 From8_g961 = _HighlightADistribution;
				float ID8_g961 = idMap383;
				float Fac8_g961 = _HighlightAStrength;
				float localThreePointDistribution8_g961 = ThreePointDistribution( From8_g961 , ID8_g961 , Fac8_g961 );
				float temp_output_24_0_g961 = root58;
				float lerpResult16_g961 = lerp( temp_output_24_0_g961 , ( 1.0 - temp_output_24_0_g961 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g961 = lerp( lerpResult6_g960 , _HighlightAColor , saturate( ( localThreePointDistribution8_g961 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g961 ) ) * _HighlightBlend ) ));
				float3 From8_g962 = _HighlightBDistribution;
				float ID8_g962 = idMap383;
				float Fac8_g962 = _HighlightBStrength;
				float localThreePointDistribution8_g962 = ThreePointDistribution( From8_g962 , ID8_g962 , Fac8_g962 );
				float temp_output_24_0_g962 = root58;
				float lerpResult16_g962 = lerp( temp_output_24_0_g962 , ( 1.0 - temp_output_24_0_g962 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g962 = lerp( lerpResult18_g961 , _HighlightBColor , saturate( ( localThreePointDistribution8_g962 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g962 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g962;
				#else
				...
				float4 temp_output_42_0_g954 = baseColor331;
				float4 temp_output_32_0_g957 = temp_output_42_0_g954;
				float temp_output_172_0_g954 = _SpecularMix;
				float4 lerpResult36_g957 = lerp( temp_output_13_0_g957 , ( temp_output_13_0_g957 * temp_output_32_0_g957 ) , temp_output_172_0_g954);
				float3 temp_output_24_0_g957 = worldNormal86_g954;
				float dotResult15_g957 = dot( lightDir55_g957 , temp_output_24_0_g957 );
				float temp_output_200_0_g954 = _Translucency;
				float temp_output_40_0_g957 = temp_output_200_0_g954;
				float dotResult54_g957 = dot( temp_output_24_0_g957 , viewDIr52_g957 );
				float dotResult57_g957 = dot( viewDIr52_g957 , lightDir55_g957 );
				float temp_output_208_0_g954 = _RimPower;
				float temp_output_207_0_g954 = _RimTransmissionIntensity;
				float3 Color126_g954 = temp_output_42_0_g954.rgb;
				float3 TangentWorld126_g954 = shiftedTangent119_g954;
				float3 ViewDir126_g954 = ase_worldViewDir;
				float3 NormalWorld126_g954 = worldNormal86_g954;
				float3 SpecularColor126_g954 = temp_output_131_0_g954.rgb;
				float SpecularTint126_g954 = temp_output_172_0_g954;
				float SpecularPower126_g954 = specularPower237_g954;
				float SpecularMultiplier126_g954 = temp_output_132_0_g954;
				float3 worldPosition129_g954 = WorldPosition;
				float3 PositionWorld126_g954 = worldPosition129_g954;
				float Translucency126_g954 = temp_output_200_0_g954;
				float RimTransmission126_g954 = temp_output_207_0_g954;
				float RimPower126_g954 = temp_output_208_0_g954;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g954 = RL_Amplify_Expression_HairLighting_Additional126_g954( Color126_g954 , TangentWorld126_g954 , ViewDir126_g954 , NormalWorld126_g954 , SpecularColor126_g954 , SpecularTint126_g954 , SpecularPower126_g954 , SpecularMultiplier126_g954 , PositionWorld126_g954 , Translucency126_g954 , RimTransmission126_g954 , RimPower126_g954 );
				float lerpResult632 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult632;
				float temp_output_161_0_g954 = ambientOcclusion570;
				float lerpResult280_g954 = lerp( 1.0 , temp_output_161_0_g954 , _AOOccludeAll);
				float3 tanNormal53_g954 = worldNormal86_g954;
				float3 bakedGI53_g954 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g954), dot(tanToWorld1,tanNormal53_g954), dot(tanToWorld2,tanNormal53_g954)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g954), dot(tanToWorld1,tanNormal53_g954), dot(tanToWorld2,tanNormal53_g954)), bakedGI53_g954, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g957 + ( ( saturate( ( ( dotResult15_g957 * ( 1.0 - temp_output_40_0_g957 ) ) + temp_output_40_0_g957 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g957 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g957 ) , 0.0 ) ) , temp_output_208_0_g954 ) * temp_output_207_0_g954 ) ) * temp_output_32_0_g957 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g954 , 0.0 ) ) * lerpResult280_g954 ) + ( float4( bakedGI53_g954 , 0.0 ) * temp_output_42_0_g954 * temp_output_161_0_g954 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;3187.17;-1423.466;1.552379;True;False
...
Node;AmplifyShaderEditor.FunctionNode;627;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;962;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;45;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=38344812A42A58CE473AD54036837DD6C3FFFED8