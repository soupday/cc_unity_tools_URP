...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g1097( half3 NormalTS, half3x3 TBN )
			{
			...
			half3 RL_Amplify_Expression_HairLighting_Additional126_g1096( half3 Color, half3 TangentWorld, half3 ViewDir, half3 NormalWorld, half3 SpecularColor, half SpecularTint, half SpecularPower, half SpecularMultiplier, half3 PositionWorld, half Translucency, half RimTransmission, half RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half4 break109_g1096 = SAMPLE_TEXTURE2D( _FlowMap, sampler_DiffuseMap, uv_FlowMap );
				half lerpResult123_g1096 = lerp( break109_g1096.g , ( 1.0 - break109_g1096.g ) , _FlowMapFlipGreen);
				half3 appendResult98_g1096 = (half3(break109_g1096.r , lerpResult123_g1096 , break109_g1096.b));
				half3 NormalTS13_g1097 = ( ( appendResult98_g1096 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_worldTangent = IN.ase_texcoord5.xyz;
				half3 ase_worldNormal = IN.ase_texcoord6.xyz;
				half3 Binormal5_g1097 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g1097 = float3x3(ase_worldTangent, Binormal5_g1097, ase_worldNormal);
				half3x3 TBN13_g1097 = TBN1_g1097;
				half3 localTangentToWorld13_g1097 = TangentToWorld13_g1097( NormalTS13_g1097 , TBN13_g1097 );
				half3 flowTangent107_g1096 = localTangentToWorld13_g1097;
				...
				half3 worldNormal85_g1096 = normalize( float3(dot(tanToWorld0,tanNormal85_g1096), dot(tanToWorld1,tanNormal85_g1096), dot(tanToWorld2,tanNormal85_g1096)) );
				half3 worldNormal86_g1096 = worldNormal85_g1096;
				...
				half lerpResult81_g1096 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				half3 normalizeResult10_g1100 = normalize( ( flowTangent107_g1096 + ( worldNormal86_g1096 * lerpResult81_g1096 ) ) );
				half3 shiftedTangent119_g1096 = normalizeResult10_g1100;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				half3 viewDIr52_g1098 = ase_worldViewDir;
				half3 worldLight248_g1096 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g1098 = worldLight248_g1096;
				half3 normalizeResult14_g1099 = normalize( ( viewDIr52_g1098 + lightDir55_g1098 ) );
				half dotResult16_g1099 = dot( shiftedTangent119_g1096 , normalizeResult14_g1099 );
				half smoothstepResult22_g1099 = smoothstep( -1.0 , 0.0 , dotResult16_g1099);
				...
				half temp_output_233_0_g1096 = max( ( 1.0 - smoothness587 ) , 0.001 );
				half specularPower237_g1096 = ( max( ( ( 2.0 / ( temp_output_233_0_g1096 * temp_output_233_0_g1096 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord4.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				half temp_output_132_0_g1096 = ( SAMPLE_TEXTURE2D( _SpecularMap, sampler_DiffuseMap, uv_SpecularMap ).g * _SpecularMultiplier );
				half4 temp_output_131_0_g1096 = _SpecularTint;
				half4 temp_output_13_0_g1098 = ( ( smoothstepResult22_g1099 * pow( saturate( ( 1.0 - ( dotResult16_g1099 * dotResult16_g1099 ) ) ) , specularPower237_g1096 ) ) * temp_output_132_0_g1096 * temp_output_131_0_g1096 );
				...
				half4 temp_output_42_0_g1096 = baseColor331;
				half4 temp_output_32_0_g1098 = temp_output_42_0_g1096;
				half temp_output_172_0_g1096 = _SpecularMix;
				half4 lerpResult36_g1098 = lerp( temp_output_13_0_g1098 , ( temp_output_13_0_g1098 * temp_output_32_0_g1098 ) , temp_output_172_0_g1096);
				half3 temp_output_24_0_g1098 = worldNormal86_g1096;
				half dotResult15_g1098 = dot( lightDir55_g1098 , temp_output_24_0_g1098 );
				half temp_output_200_0_g1096 = _Translucency;
				half temp_output_40_0_g1098 = temp_output_200_0_g1096;
				half dotResult54_g1098 = dot( temp_output_24_0_g1098 , viewDIr52_g1098 );
				half dotResult57_g1098 = dot( viewDIr52_g1098 , lightDir55_g1098 );
				half temp_output_208_0_g1096 = _RimPower;
				half temp_output_207_0_g1096 = _RimTransmissionIntensity;
				...
				half3 Color126_g1096 = temp_output_42_0_g1096.rgb;
				half3 TangentWorld126_g1096 = shiftedTangent119_g1096;
				half3 ViewDir126_g1096 = ase_worldViewDir;
				half3 NormalWorld126_g1096 = worldNormal86_g1096;
				half3 SpecularColor126_g1096 = temp_output_131_0_g1096.rgb;
				half SpecularTint126_g1096 = temp_output_172_0_g1096;
				half SpecularPower126_g1096 = specularPower237_g1096;
				half SpecularMultiplier126_g1096 = temp_output_132_0_g1096;
				half3 worldPosition129_g1096 = WorldPosition;
				half3 PositionWorld126_g1096 = worldPosition129_g1096;
				half Translucency126_g1096 = temp_output_200_0_g1096;
				half RimTransmission126_g1096 = temp_output_207_0_g1096;
				half RimPower126_g1096 = temp_output_208_0_g1096;
				half3 localRL_Amplify_Expression_HairLighting_Additional126_g1096 = RL_Amplify_Expression_HairLighting_Additional126_g1096( Color126_g1096 , TangentWorld126_g1096 , ViewDir126_g1096 , NormalWorld126_g1096 , SpecularColor126_g1096 , SpecularTint126_g1096 , SpecularPower126_g1096 , SpecularMultiplier126_g1096 , PositionWorld126_g1096 , Translucency126_g1096 , RimTransmission126_g1096 , RimPower126_g1096 );
				half lerpResult631 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				half ambientOcclusion570 = lerpResult631;
				half temp_output_161_0_g1096 = ambientOcclusion570;
				half lerpResult280_g1096 = lerp( 1.0 , temp_output_161_0_g1096 , _AOOccludeAll);
				half3 bakedGI53_g1096 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g1096);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * saturate( ( ( lerpResult36_g1098 + ( ( saturate( ( ( dotResult15_g1098 * ( 1.0 - temp_output_40_0_g1098 ) ) + temp_output_40_0_g1098 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1098 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1098 ) , 0.0 ) ) , temp_output_208_0_g1096 ) * temp_output_207_0_g1096 ) ) * temp_output_32_0_g1098 ) ) * ase_lightColor ) ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g1096 , 0.0 ) ) * lerpResult280_g1096 ) + ( half4( max( bakedGI53_g1096 , float3( 0,0,0 ) ) , 0.0 ) * temp_output_42_0_g1096 * temp_output_161_0_g1096 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
Node;AmplifyShaderEditor.RangedFloatNode;162;-1209.455,2869.13;Inherit;False;Property;_AlphaClip2;Alpha Clip;7;0;Create;False;0;0;0;False;0;False;0.15;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;263;-675.4739,1076.239;Inherit;False;Property;_RimPower;Rim Hardness;29;0;Create;False;0;0;0;False;0;False;4;2;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;389;-680.9468,850.0183;Inherit;False;Property;_SpecularShiftMax;Specular Shift Max;27;0;Create;True;0;0;0;False;0;False;0.25;0.25;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;133;-1503.434,1109.366;Inherit;True;Property;_EmissionMap;Emission Map;31;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RegisterLocalVarNode;58;-5245.691,1959.615;Inherit;False;root;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;40;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294117,0.1411764,0.05098033,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;177;-708.1495,432.6585;Inherit;True;Property;_FlowMap;Flow Map;19;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;125;-1724.759,1811.414;Inherit;False;Property;_SmoothnessMax;Smoothness Max;14;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;92;-4296.681,19.90401;Inherit;False;Property;_HighlightBColor;Highlight B Color;50;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;69;-4960.777,-437.1049;Inherit;False;Property;_HighlightAColor;Highlight A Color;45;0;Create;True;0;0;0;False;0;False;0.9137255,0.7803922,0.6352941,0;0.9137255,0.7803922,0.635294,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;622;-4910.226,359.6802;Inherit;False;Property;_HighlightBlend;Highlight Blend;43;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;385;-683.2698,774.4863;Inherit;False;Property;_SpecularShiftMin;Specular Shift Min;26;0;Create;True;0;0;0;False;0;False;-0.25;-0.25;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;617;-1207.585,150.0571;Inherit;True;Property;_SpecularMap;Specular Map;21;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;620;-1542.835,-321.9772;Inherit;False;Property;_DiffuseColor;Diffuse Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;532;-1205.033,2967.59;Inherit;False;Property;_ShadowClip;Shadow Clip;8;0;Create;True;0;0;0;False;0;False;0.25;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;134;-1461.834,1309.566;Inherit;False;Property;_EmissiveColor;Emissive Color;32;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularMix;Specular Mix;25;0;Create;True;0;0;0;False;0;False;1;1;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;50;-5668.366,1711.348;Inherit;True;Property;_IDMap;ID Map;42;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-676.7613,1001.536;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;30;0;Create;True;0;0;0;False;0;False;4;10;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;32;-5612.805,-421.4388;Inherit;False;Property;_EndColor;End Color;41;0;Create;True;0;0;0;False;0;False;0.6039216,0.454902,0.2862745,0;0.6039216,0.454902,0.2862744,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.GetLocalVarNode;520;-3195.436,-172.8687;Inherit;False;517;diffuseMap;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;591;-689.9429,353.1747;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;24;0;Create;False;0;0;0;False;0;False;4;2;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;116;-1864.531,2426.636;Inherit;False;Property;_AOStrength;Ambient Occlusion Strength;10;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;380;-1187.927,344.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;23;0;Create;False;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;123;-2213.958,1968.688;Inherit;False;Property;_SmoothnessPower;Smoothness Power;12;0;Create;True;0;0;0;False;0;False;1.25;1.25;0.5;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;113;-1661.103,22.41703;Inherit;False;Property;_VertexBaseColor;Vertex Base Color;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;378;-628.2301,-49.07933;Inherit;False;Property;_SpecularTint;Specular Tint;22;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;539;-678.5594,926.0629;Inherit;False;Property;_Translucency;Translucency;28;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
WireConnection;655;42;572;0
WireConnection;655;161;571;0
WireConnection;655;178;108;0
WireConnection;655;84;569;0
WireConnection;655;131;378;0
WireConnection;655;7;588;0
WireConnection;655;172;482;0
WireConnection;655;132;619;0
WireConnection;655;245;591;0
WireConnection;655;108;177;0
WireConnection;655;112;180;0
WireConnection;655;71;384;0
WireConnection;655;75;385;0
WireConnection;655;80;389;0
WireConnection;655;200;539;0
WireConnection;655;207;265;0
WireConnection;655;208;263;0
WireConnection;297;2;574;0
WireConnection;297;3;536;0
WireConnection;297;4;576;0
WireConnection;297;7;534;0
ASEEND*/
//CHKSM=3B1EBA993A002AFA6E2DDB8CA7C400FC5165ECFE