	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_132_0_g915 = _SpecularMultiplier;
				...
				float4 lerpResult18_g803 = lerp( lerpResult6_g797 , _HighlightAColor , saturate( ( localThreePointDistribution8_g803 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g803 ) ) ) ) ));
...
/*ASEBEGIN
Version=18935
1913;25;1920;969;1069.529;223.1014;1;True;False
...
ASEEND*/
//CHKSM=82F3779332F188F82A1D465B8D970F04265BE9A4