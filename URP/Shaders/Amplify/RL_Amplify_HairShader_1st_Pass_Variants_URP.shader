...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g799( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g798( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g798 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g798 = lerp( break109_g798.g , ( 1.0 - break109_g798.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g798 = (float3(break109_g798.r , lerpResult123_g798 , break109_g798.b));
				float3 NormalTS13_g799 = ( ( appendResult98_g798 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g799 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g799 = float3x3(ase_worldTangent, Binormal5_g799, ase_worldNormal);
				float3x3 TBN13_g799 = TBN1_g799;
				float3 localTangentToWorld13_g799 = TangentToWorld13_g799( NormalTS13_g799 , TBN13_g799 );
				float3 flowTangent107_g798 = localTangentToWorld13_g799;
				...
				float3 tanNormal85_g798 = normal282;
				float3 worldNormal85_g798 = normalize( float3(dot(tanToWorld0,tanNormal85_g798), dot(tanToWorld1,tanNormal85_g798), dot(tanToWorld2,tanNormal85_g798)) );
				float3 worldNormal86_g798 = worldNormal85_g798;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g798 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g802 = normalize( ( flowTangent107_g798 + ( worldNormal86_g798 * lerpResult81_g798 ) ) );
				float3 shiftedTangent119_g798 = normalizeResult10_g802;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g800 = ase_worldViewDir;
				float3 lightDir55_g800 = SafeNormalize(_MainLightPosition.xyz);
				float3 normalizeResult14_g801 = normalize( ( viewDIr52_g800 + lightDir55_g800 ) );
				float dotResult16_g801 = dot( shiftedTangent119_g798 , normalizeResult14_g801 );
				float smoothstepResult22_g801 = smoothstep( -1.0 , 0.0 , dotResult16_g801);
				...
				float temp_output_233_0_g798 = max( ( 1.0 - smoothness587 ) , 0.001 );
				float specularPower237_g798 = ( max( ( ( 2.0 / ( temp_output_233_0_g798 * temp_output_233_0_g798 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float temp_output_132_0_g798 = _SpecularMultiplier;
				float4 temp_output_131_0_g798 = _SpecularTint;
				float4 temp_output_13_0_g800 = ( ( smoothstepResult22_g801 * pow( saturate( ( 1.0 - ( dotResult16_g801 * dotResult16_g801 ) ) ) , specularPower237_g798 ) ) * temp_output_132_0_g798 * temp_output_131_0_g798 );
				...
				float4 color10_g797 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 lerpResult18_g797 = lerp( color10_g797 , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g797 = root58;
				float lerpResult23_g797 = lerp( temp_output_27_0_g797 , ( 1.0 - temp_output_27_0_g797 ) , _InvertRootMap);
				float4 lerpResult3_g797 = lerp( _RootColor , _EndColor , lerpResult23_g797);
				float4 lerpResult6_g797 = lerp( lerpResult18_g797 , lerpResult3_g797 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g797 ) * _RootColorStrength ) + ( temp_output_27_0_g797 * _EndColorStrength ) ) ));
				float3 From8_g795 = _HighlightADistribution;
				float ID8_g795 = idMap383;
				float Fac8_g795 = _HighlightAStrength;
				float localThreePointDistribution8_g795 = ThreePointDistribution( From8_g795 , ID8_g795 , Fac8_g795 );
				float temp_output_24_0_g795 = root58;
				float lerpResult16_g795 = lerp( ( 1.0 - temp_output_24_0_g795 ) , temp_output_24_0_g795 , _HighlightAOverlapInvert);
				float4 lerpResult18_g795 = lerp( lerpResult6_g797 , _HighlightAColor , saturate( ( localThreePointDistribution8_g795 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g795 ) ) ) ) ));
				float3 From8_g796 = _HighlightBDistribution;
				float ID8_g796 = idMap383;
				float Fac8_g796 = _HighlightBStrength;
				float localThreePointDistribution8_g796 = ThreePointDistribution( From8_g796 , ID8_g796 , Fac8_g796 );
				float temp_output_24_0_g796 = root58;
				float lerpResult16_g796 = lerp( ( 1.0 - temp_output_24_0_g796 ) , temp_output_24_0_g796 , _HighlightBOverlapInvert);
				float4 lerpResult18_g796 = lerp( lerpResult18_g795 , _HighlightBColor , saturate( ( localThreePointDistribution8_g796 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g796 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g796;
				#else
				...
				float4 temp_output_42_0_g798 = baseColor331;
				float4 temp_output_32_0_g800 = temp_output_42_0_g798;
				float temp_output_172_0_g798 = _SpecularMix;
				float4 lerpResult36_g800 = lerp( temp_output_13_0_g800 , ( temp_output_13_0_g800 * temp_output_32_0_g800 ) , temp_output_172_0_g798);
				float3 temp_output_24_0_g800 = worldNormal86_g798;
				float dotResult15_g800 = dot( lightDir55_g800 , temp_output_24_0_g800 );
				float temp_output_200_0_g798 = _Translucency;
				float temp_output_40_0_g800 = temp_output_200_0_g798;
				float dotResult54_g800 = dot( temp_output_24_0_g800 , viewDIr52_g800 );
				float dotResult57_g800 = dot( viewDIr52_g800 , lightDir55_g800 );
				float temp_output_208_0_g798 = _RimPower;
				float temp_output_207_0_g798 = _RimTransmissionIntensity;
				float3 Color126_g798 = temp_output_42_0_g798.rgb;
				float3 TangentWorld126_g798 = shiftedTangent119_g798;
				float3 ViewDir126_g798 = ase_worldViewDir;
				float3 NormalWorld126_g798 = worldNormal86_g798;
				float3 SpecularColor126_g798 = temp_output_131_0_g798.rgb;
				float SpecularTint126_g798 = temp_output_172_0_g798;
				float SpecularPower126_g798 = specularPower237_g798;
				float SpecularMultiplier126_g798 = temp_output_132_0_g798;
				float3 worldPosition129_g798 = WorldPosition;
				float3 PositionWorld126_g798 = worldPosition129_g798;
				float Translucency126_g798 = temp_output_200_0_g798;
				float RimTransmission126_g798 = temp_output_207_0_g798;
				float RimPower126_g798 = temp_output_208_0_g798;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g798 = RL_Amplify_Expression_HairLighting_Additional126_g798( Color126_g798 , TangentWorld126_g798 , ViewDir126_g798 , NormalWorld126_g798 , SpecularColor126_g798 , SpecularTint126_g798 , SpecularPower126_g798 , SpecularMultiplier126_g798 , PositionWorld126_g798 , Translucency126_g798 , RimTransmission126_g798 , RimPower126_g798 );
				float3 tanNormal53_g798 = worldNormal86_g798;
				float3 bakedGI53_g798 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g798), dot(tanToWorld1,tanNormal53_g798), dot(tanToWorld2,tanNormal53_g798)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g798), dot(tanToWorld1,tanNormal53_g798), dot(tanToWorld2,tanNormal53_g798)), bakedGI53_g798, half4(0,0,0,0));
				float ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
				float temp_output_161_0_g798 = ambientOcclusion570;
				float temp_output_178_0_g798 = _AOOccludeAll;
				float lerpResult180_g798 = lerp( temp_output_161_0_g798 , 1.0 , temp_output_178_0_g798);
				float lerpResult183_g798 = lerp( 1.0 , temp_output_161_0_g798 , temp_output_178_0_g798);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g800 + ( ( saturate( ( ( dotResult15_g800 * ( 1.0 - temp_output_40_0_g800 ) ) + temp_output_40_0_g800 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g800 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g800 ) , 0.0 ) ) , temp_output_208_0_g798 ) * temp_output_207_0_g798 ) ) * temp_output_32_0_g800 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g798 , 0.0 ) ) + ( float4( bakedGI53_g798 , 0.0 ) * temp_output_42_0_g798 * lerpResult180_g798 ) ) * lerpResult183_g798 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1913;30;1920;999;4479.117;685.8443;4.55451;True;False
...
Node;AmplifyShaderEditor.FunctionNode;523;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;797;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-676.7613,1001.536;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;43;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;522;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;795;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;539;-678.5594,926.0629;Inherit;False;Property;_Translucency;Translucency;50;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
WireConnection;593;42;572;0
WireConnection;593;161;571;0
WireConnection;593;178;108;0
WireConnection;593;84;569;0
WireConnection;593;131;378;0
WireConnection;593;7;588;0
WireConnection;593;172;482;0
WireConnection;593;132;380;0
WireConnection;593;245;591;0
WireConnection;593;108;177;0
WireConnection;593;112;180;0
WireConnection;593;71;384;0
WireConnection;593;75;385;0
WireConnection;593;80;389;0
WireConnection;593;200;539;0
WireConnection;593;207;265;0
WireConnection;593;208;263;0
...
ASEEND*/
//CHKSM=C5537F0B56CD0E54DE4313B58550098F0DEE5209