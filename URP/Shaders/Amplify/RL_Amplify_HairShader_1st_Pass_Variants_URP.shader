...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g770( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g766( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g766 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g766 = lerp( break109_g766.g , ( 1.0 - break109_g766.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g766 = (float3(break109_g766.r , lerpResult123_g766 , break109_g766.b));
				float3 NormalTS13_g770 = ( ( appendResult98_g766 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g770 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g770 = float3x3(ase_worldTangent, Binormal5_g770, ase_worldNormal);
				float3x3 TBN13_g770 = TBN1_g770;
				float3 localTangentToWorld13_g770 = TangentToWorld13_g770( NormalTS13_g770 , TBN13_g770 );
				float3 flowTangent107_g766 = localTangentToWorld13_g770;
				...
				float3 tanNormal85_g766 = normal282;
				float3 worldNormal85_g766 = float3(dot(tanToWorld0,tanNormal85_g766), dot(tanToWorld1,tanNormal85_g766), dot(tanToWorld2,tanNormal85_g766));
				float3 worldNormal86_g766 = worldNormal85_g766;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g766 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g767 = normalize( ( flowTangent107_g766 + ( worldNormal86_g766 * lerpResult81_g766 ) ) );
				float3 shiftedTangent119_g766 = normalizeResult10_g767;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g768 = ase_worldViewDir;
				float3 lightDir55_g768 = _MainLightPosition.xyz;
				float3 normalizeResult14_g769 = normalize( ( viewDIr52_g768 + lightDir55_g768 ) );
				float dotResult16_g769 = dot( shiftedTangent119_g766 , normalizeResult14_g769 );
				float smoothstepResult22_g769 = smoothstep( -1.0 , 0.0 , dotResult16_g769);
				...
				float temp_output_233_0_g766 = max( ( 1.0 - smoothness587 ) , 0.001 );
				float specularPower237_g766 = ( max( ( ( 2.0 / ( temp_output_233_0_g766 * temp_output_233_0_g766 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float temp_output_132_0_g766 = _SpecularMultiplier;
				float4 temp_output_131_0_g766 = _SpecularColor;
				float4 temp_output_13_0_g768 = ( ( smoothstepResult22_g769 * pow( saturate( ( 1.0 - ( dotResult16_g769 * dotResult16_g769 ) ) ) , specularPower237_g766 ) ) * temp_output_132_0_g766 * temp_output_131_0_g766 );
				...
				float4 color10_g756 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 lerpResult18_g756 = lerp( color10_g756 , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g756 = root58;
				float lerpResult23_g756 = lerp( temp_output_27_0_g756 , ( 1.0 - temp_output_27_0_g756 ) , _InvertRootMap);
				float4 lerpResult3_g756 = lerp( _RootColor , _EndColor , lerpResult23_g756);
				float4 lerpResult6_g756 = lerp( lerpResult18_g756 , lerpResult3_g756 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g756 ) * _RootColorStrength ) + ( temp_output_27_0_g756 * _EndColorStrength ) ) ));
				float3 From8_g754 = _HighlightADistribution;
				float ID8_g754 = idMap383;
				float Fac8_g754 = _HighlightAStrength;
				float localThreePointDistribution8_g754 = ThreePointDistribution( From8_g754 , ID8_g754 , Fac8_g754 );
				float temp_output_24_0_g754 = root58;
				float lerpResult16_g754 = lerp( ( 1.0 - temp_output_24_0_g754 ) , temp_output_24_0_g754 , _HighlightAOverlapInvert);
				float4 lerpResult18_g754 = lerp( lerpResult6_g756 , _HighlightAColor , saturate( ( localThreePointDistribution8_g754 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g754 ) ) ) ) ));
				float3 From8_g755 = _HighlightBDistribution;
				float ID8_g755 = idMap383;
				float Fac8_g755 = _HighlightBStrength;
				float localThreePointDistribution8_g755 = ThreePointDistribution( From8_g755 , ID8_g755 , Fac8_g755 );
				float temp_output_24_0_g755 = root58;
				float lerpResult16_g755 = lerp( ( 1.0 - temp_output_24_0_g755 ) , temp_output_24_0_g755 , _HighlightBOverlapInvert);
				float4 lerpResult18_g755 = lerp( lerpResult18_g754 , _HighlightBColor , saturate( ( localThreePointDistribution8_g755 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g755 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g755;
				#else
				...
				float4 temp_output_42_0_g766 = baseColor331;
				float4 temp_output_32_0_g768 = temp_output_42_0_g766;
				float temp_output_172_0_g766 = _SpecularTint;
				float4 lerpResult36_g768 = lerp( temp_output_13_0_g768 , ( temp_output_13_0_g768 * temp_output_32_0_g768 ) , temp_output_172_0_g766);
				float3 temp_output_24_0_g768 = worldNormal86_g766;
				float dotResult15_g768 = dot( lightDir55_g768 , temp_output_24_0_g768 );
				float temp_output_200_0_g766 = _Tranlucency;
				float temp_output_40_0_g768 = temp_output_200_0_g766;
				float dotResult54_g768 = dot( temp_output_24_0_g768 , viewDIr52_g768 );
				float dotResult57_g768 = dot( viewDIr52_g768 , lightDir55_g768 );
				float temp_output_208_0_g766 = _RimPower;
				float temp_output_207_0_g766 = _RimTransmission;
				float3 Color126_g766 = temp_output_42_0_g766.rgb;
				float3 TangentWorld126_g766 = shiftedTangent119_g766;
				float3 ViewDir126_g766 = ase_worldViewDir;
				float3 NormalWorld126_g766 = worldNormal86_g766;
				float3 SpecularColor126_g766 = temp_output_131_0_g766.rgb;
				float SpecularTint126_g766 = temp_output_172_0_g766;
				float SpecularPower126_g766 = specularPower237_g766;
				float SpecularMultiplier126_g766 = temp_output_132_0_g766;
				float3 worldPosition129_g766 = WorldPosition;
				float3 PositionWorld126_g766 = worldPosition129_g766;
				float Translucency126_g766 = temp_output_200_0_g766;
				float RimTransmission126_g766 = temp_output_207_0_g766;
				float RimPower126_g766 = temp_output_208_0_g766;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g766 = RL_Amplify_Expression_HairLighting_Additional126_g766( Color126_g766 , TangentWorld126_g766 , ViewDir126_g766 , NormalWorld126_g766 , SpecularColor126_g766 , SpecularTint126_g766 , SpecularPower126_g766 , SpecularMultiplier126_g766 , PositionWorld126_g766 , Translucency126_g766 , RimTransmission126_g766 , RimPower126_g766 );
				float3 tanNormal53_g766 = worldNormal86_g766;
				float3 bakedGI53_g766 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g766), dot(tanToWorld1,tanNormal53_g766), dot(tanToWorld2,tanNormal53_g766)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g766), dot(tanToWorld1,tanNormal53_g766), dot(tanToWorld2,tanNormal53_g766)), bakedGI53_g766, half4(0,0,0,0));
				float ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
				float temp_output_161_0_g766 = ambientOcclusion570;
				float temp_output_178_0_g766 = _AOOccludeAll;
				float lerpResult180_g766 = lerp( temp_output_161_0_g766 , 1.0 , temp_output_178_0_g766);
				float lerpResult183_g766 = lerp( 1.0 , temp_output_161_0_g766 , temp_output_178_0_g766);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g768 + ( ( saturate( ( ( dotResult15_g768 * ( 1.0 - temp_output_40_0_g768 ) ) + temp_output_40_0_g768 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g768 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g768 ) , 0.0 ) ) , temp_output_208_0_g766 ) * temp_output_207_0_g766 ) ) * temp_output_32_0_g768 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g766 , 0.0 ) ) + ( float4( bakedGI53_g766 , 0.0 ) * temp_output_42_0_g766 * lerpResult180_g766 ) ) * lerpResult183_g766 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18934
0;0;1680;999;1288.443;147.3253;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1124.398;1585.429;;17;384;571;378;265;180;263;389;482;572;177;385;588;380;108;569;539;591;Specular Highlights;1,0.7932334,0.514151,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;522;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;754;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;591;-689.9429,353.1747;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;46;0;Create;False;0;0;0;False;0;False;2;2;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;263;-675.4739,1076.239;Inherit;False;Property;_RimPower;Rim Hardness;42;0;Create;False;0;0;0;False;0;False;4;2;1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;524;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;755;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;24;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294117,0.1411764,0.05098034,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-689.9268,276.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;45;0;Create;False;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;385;-683.2698,774.4863;Inherit;False;Property;_SpecularShiftMin;Specular Shift Min;48;0;Create;True;0;0;0;False;0;False;-0.25;-0.25;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;177;-708.1495,432.6585;Inherit;True;Property;_FlowMap;Flow Map;40;0;Create;True;0;0;0;False;0;False;19;cc37af08370d26540b0e6725a8b8879e;cc37af08370d26540b0e6725a8b8879e;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;389;-680.9468,850.0183;Inherit;False;Property;_SpecularShiftMax;Specular Shift Max;49;0;Create;True;0;0;0;False;0;False;0.25;0.25;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;180;-626.772,622.0728;Inherit;False;Property;_FlowMapFlipGreen;Flow Map Flip Green;41;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;265;-676.7613,1001.536;Inherit;False;Property;_RimTransmission;Rim Transmission;43;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;592;-110.9783,9.531306;Inherit;False;RL_Amplify_Function_Hair_AnisotropicLighting;-1;;766;1c2ce0d33e6d0364e94912a58b37cdd2;1,88,0;18;42;COLOR;1,1,1,0;False;161;FLOAT;1;False;178;FLOAT;1;False;84;FLOAT3;0,0,1;False;26;FLOAT3;0,0,1;False;131;COLOR;1,1,1,0;False;7;FLOAT;50;False;172;FLOAT;0;False;132;FLOAT;1;False;245;FLOAT;2;False;108;COLOR;0,0,0,0;False;112;FLOAT;0;False;71;FLOAT;0.5;False;75;FLOAT;-0.1;False;80;FLOAT;0.1;False;200;FLOAT;0;False;207;FLOAT;0;False;208;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;539;-678.5594,926.0629;Inherit;False;Property;_Tranlucency;Tranlucency;50;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularTint;Specular Tint;47;0;Create;True;0;0;0;False;0;False;1;1;0.5;1;0;1;FLOAT;0
...
WireConnection;592;42;572;0
WireConnection;592;161;571;0
WireConnection;592;178;108;0
WireConnection;592;84;569;0
WireConnection;592;131;378;0
WireConnection;592;7;588;0
WireConnection;592;172;482;0
WireConnection;592;132;380;0
WireConnection;592;245;591;0
WireConnection;592;108;177;0
WireConnection;592;112;180;0
WireConnection;592;71;384;0
WireConnection;592;75;385;0
WireConnection;592;80;389;0
WireConnection;592;200;539;0
WireConnection;592;207;265;0
WireConnection;592;208;263;0
WireConnection;297;2;574;0
WireConnection;297;3;536;0
WireConnection;297;4;576;0
WireConnection;297;7;534;0
ASEEND*/
//CHKSM=62E36DCDF97A308705FF5B7BC04874A297E24469