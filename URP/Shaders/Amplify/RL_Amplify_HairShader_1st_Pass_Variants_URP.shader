	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				half3 normalizeResult10_g1098 = normalize( ( flowTangent107_g1096 + ( worldNormal86_g1096 * lerpResult81_g1096 ) ) );
				half3 shiftedTangent119_g1096 = normalizeResult10_g1098;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				half3 viewDIr52_g1099 = ase_worldViewDir;
				half3 worldLight248_g1096 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g1099 = worldLight248_g1096;
				half3 normalizeResult14_g1100 = normalize( ( viewDIr52_g1099 + lightDir55_g1099 ) );
				half dotResult16_g1100 = dot( shiftedTangent119_g1096 , normalizeResult14_g1100 );
				half smoothstepResult22_g1100 = smoothstep( -1.0 , 0.0 , dotResult16_g1100);
				...
				half4 temp_output_13_0_g1099 = ( ( smoothstepResult22_g1100 * pow( saturate( ( 1.0 - ( dotResult16_g1100 * dotResult16_g1100 ) ) ) , specularPower237_g1096 ) ) * temp_output_132_0_g1096 * temp_output_131_0_g1096 );
				...
				half4 temp_output_32_0_g1099 = temp_output_42_0_g1096;
				half temp_output_172_0_g1096 = _SpecularMix;
				half4 lerpResult36_g1099 = lerp( temp_output_13_0_g1099 , ( temp_output_13_0_g1099 * temp_output_32_0_g1099 ) , temp_output_172_0_g1096);
				half3 temp_output_24_0_g1099 = worldNormal86_g1096;
				half dotResult15_g1099 = dot( lightDir55_g1099 , temp_output_24_0_g1099 );
				half temp_output_200_0_g1096 = _Translucency;
				half temp_output_40_0_g1099 = temp_output_200_0_g1096;
				half dotResult54_g1099 = dot( temp_output_24_0_g1099 , viewDIr52_g1099 );
				half dotResult57_g1099 = dot( viewDIr52_g1099 , lightDir55_g1099 );
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * saturate( ( ( lerpResult36_g1099 + ( ( saturate( ( ( dotResult15_g1099 * ( 1.0 - temp_output_40_0_g1099 ) ) + temp_output_40_0_g1099 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1099 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1099 ) , 0.0 ) ) , temp_output_208_0_g1096 ) * temp_output_207_0_g1096 ) ) * temp_output_32_0_g1099 ) ) * ase_lightColor ) ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g1096 , 0.0 ) ) * lerpResult280_g1096 ) + ( half4( max( bakedGI53_g1096 , float3( 0,0,0 ) ) , 0.0 ) * temp_output_42_0_g1096 * temp_output_161_0_g1096 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;905.9279,1167.715;Half;False;True;-1;2;ASEMaterialInspector;0;13;Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Forward Only;1;638364387181301738;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992114575262;Meta Pass;0;638047158932840562;Extra Pre Pass;0;0;Tessellation;0;637788079052467337;  Phong;1;637788078022368415;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;False;False;;True;0
...
ASEEND*/
//CHKSM=5563A7352BFE77B23ADE2BF7D7991A5F5E7C5B4C