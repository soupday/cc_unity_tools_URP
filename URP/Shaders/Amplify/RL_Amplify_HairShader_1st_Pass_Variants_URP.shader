...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g1090( half3 NormalTS, half3x3 TBN )
			{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half4 break109_g1087 = tex2D( _FlowMap, uv_FlowMap );
				...
				half3 NormalTS13_g1090 = ( ( appendResult98_g1087 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_worldTangent = IN.ase_texcoord4.xyz;
				half3 ase_worldNormal = IN.ase_texcoord5.xyz;
				half3 Binormal5_g1090 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g1090 = float3x3(ase_worldTangent, Binormal5_g1090, ase_worldNormal);
				half3x3 TBN13_g1090 = TBN1_g1090;
				half3 localTangentToWorld13_g1090 = TangentToWorld13_g1090( NormalTS13_g1090 , TBN13_g1090 );
				half3 flowTangent107_g1087 = localTangentToWorld13_g1090;
				...
				half3 viewDIr52_g1088 = ase_worldViewDir;
				half3 worldLight248_g1087 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g1088 = worldLight248_g1087;
				half3 normalizeResult14_g1089 = normalize( ( viewDIr52_g1088 + lightDir55_g1088 ) );
				half dotResult16_g1089 = dot( shiftedTangent119_g1087 , normalizeResult14_g1089 );
				half smoothstepResult22_g1089 = smoothstep( -1.0 , 0.0 , dotResult16_g1089);
				...
				half temp_output_132_0_g1087 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				half4 temp_output_131_0_g1087 = _SpecularTint;
				half4 temp_output_13_0_g1088 = ( ( smoothstepResult22_g1089 * pow( saturate( ( 1.0 - ( dotResult16_g1089 * dotResult16_g1089 ) ) ) , specularPower237_g1087 ) ) * temp_output_132_0_g1087 * temp_output_131_0_g1087 );
				...
				half4 temp_output_32_0_g1088 = temp_output_42_0_g1087;
				half temp_output_172_0_g1087 = _SpecularMix;
				half4 lerpResult36_g1088 = lerp( temp_output_13_0_g1088 , ( temp_output_13_0_g1088 * temp_output_32_0_g1088 ) , temp_output_172_0_g1087);
				half3 temp_output_24_0_g1088 = worldNormal86_g1087;
				half dotResult15_g1088 = dot( lightDir55_g1088 , temp_output_24_0_g1088 );
				half temp_output_200_0_g1087 = _Translucency;
				half temp_output_40_0_g1088 = temp_output_200_0_g1087;
				half dotResult54_g1088 = dot( temp_output_24_0_g1088 , viewDIr52_g1088 );
				half dotResult57_g1088 = dot( viewDIr52_g1088 , lightDir55_g1088 );
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g1088 + ( ( saturate( ( ( dotResult15_g1088 * ( 1.0 - temp_output_40_0_g1088 ) ) + temp_output_40_0_g1088 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1088 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1088 ) , 0.0 ) ) , temp_output_208_0_g1087 ) * temp_output_207_0_g1087 ) ) * temp_output_32_0_g1088 ) ) * _MainLightColor ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g1087 , 0.0 ) ) * lerpResult280_g1087 ) + ( half4( bakedGI53_g1087 , 0.0 ) * temp_output_42_0_g1087 * temp_output_161_0_g1087 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
Node;AmplifyShaderEditor.SamplerNode;177;-708.1495,432.6585;Inherit;True;Property;_FlowMap;Flow Map;19;0;Create;True;0;0;0;False;0;False;19;cc37af08370d26540b0e6725a8b8879e;cc37af08370d26540b0e6725a8b8879e;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;905.9279,1167.715;Half;False;True;-1;2;ASEMaterialInspector;0;13;Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Forward Only;1;638048889497809373;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992114575262;DOTS Instancing;0;0;Meta Pass;0;638047158932840562;Extra Pre Pass;0;0;Tessellation;0;637788079052467337;  Phong;1;637788078022368415;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=7CFE61D9204DB0BD5BBECC3AD83ADADBB614714D