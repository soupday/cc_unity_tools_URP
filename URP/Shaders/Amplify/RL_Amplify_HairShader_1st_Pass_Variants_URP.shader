...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g752( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g748( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g748 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g748 = lerp( break109_g748.g , ( 1.0 - break109_g748.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g748 = (float3(break109_g748.r , lerpResult123_g748 , break109_g748.b));
				float3 NormalTS13_g752 = ( ( appendResult98_g748 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g752 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g752 = float3x3(ase_worldTangent, Binormal5_g752, ase_worldNormal);
				float3x3 TBN13_g752 = TBN1_g752;
				float3 localTangentToWorld13_g752 = TangentToWorld13_g752( NormalTS13_g752 , TBN13_g752 );
				float3 flowTangent107_g748 = localTangentToWorld13_g752;
				...
				float3 tanNormal85_g748 = normal282;
				float3 worldNormal85_g748 = float3(dot(tanToWorld0,tanNormal85_g748), dot(tanToWorld1,tanNormal85_g748), dot(tanToWorld2,tanNormal85_g748));
				float3 worldNormal86_g748 = worldNormal85_g748;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g748 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g749 = normalize( ( flowTangent107_g748 + ( worldNormal86_g748 * lerpResult81_g748 ) ) );
				float3 shiftedTangent119_g748 = normalizeResult10_g749;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g750 = ase_worldViewDir;
				float3 lightDir55_g750 = _MainLightPosition.xyz;
				float3 normalizeResult14_g751 = normalize( ( viewDIr52_g750 + lightDir55_g750 ) );
				float dotResult16_g751 = dot( shiftedTangent119_g748 , normalizeResult14_g751 );
				float smoothstepResult22_g751 = smoothstep( -1.0 , 0.0 , dotResult16_g751);
				float temp_output_7_0_g748 = _SpecularPower;
				float temp_output_132_0_g748 = _SpecularMultiplier;
				float4 temp_output_131_0_g748 = _SpecularColor;
				float4 temp_output_13_0_g750 = ( ( smoothstepResult22_g751 * pow( saturate( ( 1.0 - ( dotResult16_g751 * dotResult16_g751 ) ) ) , temp_output_7_0_g748 ) ) * temp_output_132_0_g748 * temp_output_131_0_g748 );
				...
				float4 color10_g707 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 lerpResult18_g707 = lerp( color10_g707 , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g707 = root58;
				float lerpResult23_g707 = lerp( temp_output_27_0_g707 , ( 1.0 - temp_output_27_0_g707 ) , _InvertRootMap);
				float4 lerpResult3_g707 = lerp( _RootColor , _EndColor , lerpResult23_g707);
				float4 lerpResult6_g707 = lerp( lerpResult18_g707 , lerpResult3_g707 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g707 ) * _RootColorStrength ) + ( temp_output_27_0_g707 * _EndColorStrength ) ) ));
				float3 From8_g701 = _HighlightADistribution;
				float ID8_g701 = idMap383;
				float Fac8_g701 = _HighlightAStrength;
				float localThreePointDistribution8_g701 = ThreePointDistribution( From8_g701 , ID8_g701 , Fac8_g701 );
				float temp_output_24_0_g701 = root58;
				float lerpResult16_g701 = lerp( ( 1.0 - temp_output_24_0_g701 ) , temp_output_24_0_g701 , _HighlightAOverlapInvert);
				float4 lerpResult18_g701 = lerp( lerpResult6_g707 , _HighlightAColor , saturate( ( localThreePointDistribution8_g701 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g701 ) ) ) ) ));
				float3 From8_g695 = _HighlightBDistribution;
				float ID8_g695 = idMap383;
				float Fac8_g695 = _HighlightBStrength;
				float localThreePointDistribution8_g695 = ThreePointDistribution( From8_g695 , ID8_g695 , Fac8_g695 );
				float temp_output_24_0_g695 = root58;
				float lerpResult16_g695 = lerp( ( 1.0 - temp_output_24_0_g695 ) , temp_output_24_0_g695 , _HighlightBOverlapInvert);
				float4 lerpResult18_g695 = lerp( lerpResult18_g701 , _HighlightBColor , saturate( ( localThreePointDistribution8_g695 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g695 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g695;
				#else
				...
				float4 temp_output_42_0_g748 = baseColor331;
				float4 temp_output_32_0_g750 = temp_output_42_0_g748;
				float temp_output_172_0_g748 = _SpecularTint;
				float4 lerpResult36_g750 = lerp( temp_output_13_0_g750 , ( temp_output_13_0_g750 * temp_output_32_0_g750 ) , temp_output_172_0_g748);
				float3 temp_output_24_0_g750 = worldNormal86_g748;
				float dotResult15_g750 = dot( lightDir55_g750 , temp_output_24_0_g750 );
				float temp_output_200_0_g748 = _Tranlucency;
				float temp_output_40_0_g750 = temp_output_200_0_g748;
				float dotResult54_g750 = dot( temp_output_24_0_g750 , viewDIr52_g750 );
				float dotResult57_g750 = dot( viewDIr52_g750 , lightDir55_g750 );
				float temp_output_208_0_g748 = _RimPower;
				float temp_output_207_0_g748 = _RimTransmission;
				float3 Color126_g748 = temp_output_42_0_g748.rgb;
				float3 TangentWorld126_g748 = shiftedTangent119_g748;
				float3 ViewDir126_g748 = ase_worldViewDir;
				float3 NormalWorld126_g748 = worldNormal86_g748;
				float3 SpecularColor126_g748 = temp_output_131_0_g748.rgb;
				float SpecularTint126_g748 = temp_output_172_0_g748;
				float SpecularPower126_g748 = temp_output_7_0_g748;
				float SpecularMultiplier126_g748 = temp_output_132_0_g748;
				float3 worldPosition129_g748 = WorldPosition;
				float3 PositionWorld126_g748 = worldPosition129_g748;
				float Translucency126_g748 = temp_output_200_0_g748;
				float RimTransmission126_g748 = temp_output_207_0_g748;
				float RimPower126_g748 = temp_output_208_0_g748;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g748 = RL_Amplify_Expression_HairLighting_Additional126_g748( Color126_g748 , TangentWorld126_g748 , ViewDir126_g748 , NormalWorld126_g748 , SpecularColor126_g748 , SpecularTint126_g748 , SpecularPower126_g748 , SpecularMultiplier126_g748 , PositionWorld126_g748 , Translucency126_g748 , RimTransmission126_g748 , RimPower126_g748 );
				float3 tanNormal53_g748 = worldNormal86_g748;
				float3 bakedGI53_g748 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g748), dot(tanToWorld1,tanNormal53_g748), dot(tanToWorld2,tanNormal53_g748)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g748), dot(tanToWorld1,tanNormal53_g748), dot(tanToWorld2,tanNormal53_g748)), bakedGI53_g748, half4(0,0,0,0));
				...
				float temp_output_161_0_g748 = ambientOcclusion570;
				float temp_output_178_0_g748 = _AOOccludeAll;
				float lerpResult180_g748 = lerp( temp_output_161_0_g748 , 1.0 , temp_output_178_0_g748);
				float lerpResult183_g748 = lerp( 1.0 , temp_output_161_0_g748 , temp_output_178_0_g748);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g750 + ( ( saturate( ( ( dotResult15_g750 * ( 1.0 - temp_output_40_0_g750 ) ) + temp_output_40_0_g750 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g750 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g750 ) , 0.0 ) ) , temp_output_208_0_g748 ) * temp_output_207_0_g748 ) ) * temp_output_32_0_g750 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g748 , 0.0 ) ) + ( float4( bakedGI53_g748 , 0.0 ) * temp_output_42_0_g748 * lerpResult180_g748 ) ) * lerpResult183_g748 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18934
1921;1;1920;1017;1398.858;320.7449;1.202944;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1115.322;1526.434;;16;263;571;265;108;539;572;569;379;378;482;384;385;180;177;380;389;Specular Highlights;1,0.7932334,0.514151,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;84;-4359.336,431.3161;Inherit;False;Property;_HighlightBOverlapEnd;Highlight B Overlap End;35;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;389;-682.5292,770.9006;Inherit;False;Property;_SpecularShiftMax;Specular Shift Max;49;0;Create;True;0;0;0;False;0;False;0.25;-0.15;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularTint;Specular Tint;47;0;Create;True;0;0;0;False;0;False;1;0.75;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;378;-628.2301,-49.07933;Inherit;False;Property;_SpecularColor;Specular Color;44;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;379;-692.7015,122.987;Inherit;False;Property;_SpecularPower;Specular Power;45;0;Create;True;0;0;0;False;0;False;50;50;0;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;385;-684.8522,695.3685;Inherit;False;Property;_SpecularShiftMin;Specular Shift Min;48;0;Create;True;0;0;0;False;0;False;-0.25;-0.35;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;120;-1859.03,2413.89;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.3436,922.4185;Inherit;False;Property;_RimTransmission;Rim Transmission;43;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;125;-1470.809,1819.168;Inherit;False;Property;_SmoothnessMax;Smoothness Max;14;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;180;-628.3543,542.955;Inherit;False;Property;_FlowMapFlipGreen;Flow Map Flip Green;41;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;177;-709.7319,353.5402;Inherit;True;Property;_FlowMap;Flow Map;40;0;Create;True;0;0;0;False;0;False;19;cc37af08370d26540b0e6725a8b8879e;8579ac50031568e4785cc1137028e924;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;24;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.2690152,0.1318038,0.04984008,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;50;-5668.366,1711.348;Inherit;True;Property;_IDMap;ID Map;26;0;Create;True;0;0;0;False;0;False;19;None;7d06f1ac237fbc6478837dd24c07351b;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;502;-4641.802,-723.1288;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector3Node;52;-4972.563,-178.1671;Inherit;False;Property;_HighlightADistribution;Highlight A Distribution;29;0;Create;True;0;0;0;False;0;False;0.1,0.2,0.3;0.6026,0.8363001,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SamplerNode;115;-2549.129,1937.093;Inherit;True;Property;_MaskMap;Mask Map;9;0;Create;True;0;0;0;False;0;False;19;None;029feea7e8792a84d835da2eac1638e1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;26;-5664.931,1926.134;Inherit;True;Property;_RootMap;Root Map;19;0;Create;True;0;0;0;False;0;False;19;None;9b9409a0e0d27a949a847e089243c757;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;54;-5017.305,-22.45101;Inherit;False;Property;_HighlightAOverlapEnd;Highlight A Overlap End;30;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;524;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;695;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;-694.5977,-200.0366;Inherit;False;Property;_AOOccludeAll;AO Occlude All;11;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;124;-1469.813,1734.574;Inherit;False;Property;_SmoothnessMin;Smoothness Min;13;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;569;-590.8998,-125.8811;Inherit;False;282;normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;539;-680.1417,846.9451;Inherit;False;Property;_Tranlucency;Tranlucency;50;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-5017.905,-259.2123;Inherit;False;Property;_HighlightAStrength;Highlight A Strength;27;0;Create;True;0;0;0;False;0;False;1;0.738;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;532;-1205.033,2967.59;Inherit;False;Property;_ShadowClip;Shadow Clip;8;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;32;-5612.805,-421.4388;Inherit;False;Property;_EndColor;End Color;25;0;Create;True;0;0;0;False;0;False;0.6039216,0.454902,0.2862745,0;0.4475037,0.2778465,0.1318038,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;92;-4296.681,19.90401;Inherit;False;Property;_HighlightBColor;Highlight B Color;33;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.7048331,0.4975328,0.3391081,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;87;-4315.965,276.4831;Inherit;False;Property;_HighlightBDistribution;Highlight B Distribution;34;0;Create;True;0;0;0;False;0;False;0.1,0.2,0.3;0.2487,0.5152001,0.6487001;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;123;-1960.01,1976.442;Inherit;False;Property;_SmoothnessPower;Smoothness Power;12;0;Create;True;0;0;0;False;0;False;1.25;1;0.5;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;510;-3968.615,-191.6566;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;263;-677.0562,997.1207;Inherit;False;Property;_RimPower;Rim Power;42;0;Create;True;0;0;0;False;0;False;2;2;0.01;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;69;-4960.777,-437.1049;Inherit;False;Property;_HighlightAColor;Highlight A Color;28;0;Create;True;0;0;0;False;0;False;0.9137255,0.7803922,0.6352941,0;0.749388,0.5341862,0.3652521,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;534;118.7807,2382.774;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;99;-2001.331,16.97653;Inherit;False;Property;_BlendStrength;Blend Strength;18;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;91;-4364.522,197.3449;Inherit;False;Property;_HighlightBStrength;Highlight B Strength;32;0;Create;True;0;0;0;False;0;False;1;0.725;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;522;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;701;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;905.9279,1167.715;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992114575262;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;637788079052467337;  Phong;1;637788078022368415;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;5;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=D1E3B1CE4DD596192331795ED272105EFC1BED8B