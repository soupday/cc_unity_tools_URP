...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g917( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g915( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g915 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g915 = lerp( break109_g915.g , ( 1.0 - break109_g915.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g915 = (float3(break109_g915.r , lerpResult123_g915 , break109_g915.b));
				float3 NormalTS13_g917 = ( ( appendResult98_g915 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g917 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g917 = float3x3(ase_worldTangent, Binormal5_g917, ase_worldNormal);
				float3x3 TBN13_g917 = TBN1_g917;
				float3 localTangentToWorld13_g917 = TangentToWorld13_g917( NormalTS13_g917 , TBN13_g917 );
				float3 flowTangent107_g915 = localTangentToWorld13_g917;
				...
				float3 tanNormal85_g915 = normal282;
				float3 worldNormal85_g915 = normalize( float3(dot(tanToWorld0,tanNormal85_g915), dot(tanToWorld1,tanNormal85_g915), dot(tanToWorld2,tanNormal85_g915)) );
				float3 worldNormal86_g915 = worldNormal85_g915;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g915 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g916 = normalize( ( flowTangent107_g915 + ( worldNormal86_g915 * lerpResult81_g915 ) ) );
				float3 shiftedTangent119_g915 = normalizeResult10_g916;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g918 = ase_worldViewDir;
				float3 worldLight248_g915 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g918 = worldLight248_g915;
				float3 normalizeResult14_g919 = normalize( ( viewDIr52_g918 + lightDir55_g918 ) );
				float dotResult16_g919 = dot( shiftedTangent119_g915 , normalizeResult14_g919 );
				float smoothstepResult22_g919 = smoothstep( -1.0 , 0.0 , dotResult16_g919);
				...
				float temp_output_233_0_g915 = max( ( 1.0 - smoothness587 ) , 0.001 );
				float specularPower237_g915 = ( max( ( ( 2.0 / ( temp_output_233_0_g915 * temp_output_233_0_g915 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g915 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g915 = _SpecularTint;
				float4 temp_output_13_0_g918 = ( ( smoothstepResult22_g919 * pow( saturate( ( 1.0 - ( dotResult16_g919 * dotResult16_g919 ) ) ) , specularPower237_g915 ) ) * temp_output_132_0_g915 * temp_output_131_0_g915 );
				...
				float3 From8_g803 = _HighlightADistribution;
				float ID8_g803 = idMap383;
				float Fac8_g803 = _HighlightAStrength;
				float localThreePointDistribution8_g803 = ThreePointDistribution( From8_g803 , ID8_g803 , Fac8_g803 );
				float temp_output_24_0_g803 = root58;
				float lerpResult16_g803 = lerp( ( 1.0 - temp_output_24_0_g803 ) , temp_output_24_0_g803 , _HighlightAOverlapInvert);
				float4 lerpResult18_g803 = lerp( lerpResult6_g920 , _HighlightAColor , saturate( ( localThreePointDistribution8_g803 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g803 ) ) ) ) ));
				float3 From8_g804 = _HighlightBDistribution;
				float ID8_g804 = idMap383;
				float Fac8_g804 = _HighlightBStrength;
				float localThreePointDistribution8_g804 = ThreePointDistribution( From8_g804 , ID8_g804 , Fac8_g804 );
				float temp_output_24_0_g804 = root58;
				float lerpResult16_g804 = lerp( ( 1.0 - temp_output_24_0_g804 ) , temp_output_24_0_g804 , _HighlightBOverlapInvert);
				float4 lerpResult18_g804 = lerp( lerpResult18_g803 , _HighlightBColor , saturate( ( localThreePointDistribution8_g804 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g804 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g804;
				#else
				...
				float4 temp_output_42_0_g915 = baseColor331;
				float4 temp_output_32_0_g918 = temp_output_42_0_g915;
				float temp_output_172_0_g915 = _SpecularMix;
				float4 lerpResult36_g918 = lerp( temp_output_13_0_g918 , ( temp_output_13_0_g918 * temp_output_32_0_g918 ) , temp_output_172_0_g915);
				float3 temp_output_24_0_g918 = worldNormal86_g915;
				float dotResult15_g918 = dot( lightDir55_g918 , temp_output_24_0_g918 );
				float temp_output_200_0_g915 = _Translucency;
				float temp_output_40_0_g918 = temp_output_200_0_g915;
				float dotResult54_g918 = dot( temp_output_24_0_g918 , viewDIr52_g918 );
				float dotResult57_g918 = dot( viewDIr52_g918 , lightDir55_g918 );
				float temp_output_208_0_g915 = _RimPower;
				float temp_output_207_0_g915 = _RimTransmissionIntensity;
				float3 Color126_g915 = temp_output_42_0_g915.rgb;
				float3 TangentWorld126_g915 = shiftedTangent119_g915;
				float3 ViewDir126_g915 = ase_worldViewDir;
				float3 NormalWorld126_g915 = worldNormal86_g915;
				float3 SpecularColor126_g915 = temp_output_131_0_g915.rgb;
				float SpecularTint126_g915 = temp_output_172_0_g915;
				float SpecularPower126_g915 = specularPower237_g915;
				float SpecularMultiplier126_g915 = temp_output_132_0_g915;
				float3 worldPosition129_g915 = WorldPosition;
				float3 PositionWorld126_g915 = worldPosition129_g915;
				float Translucency126_g915 = temp_output_200_0_g915;
				float RimTransmission126_g915 = temp_output_207_0_g915;
				float RimPower126_g915 = temp_output_208_0_g915;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g915 = RL_Amplify_Expression_HairLighting_Additional126_g915( Color126_g915 , TangentWorld126_g915 , ViewDir126_g915 , NormalWorld126_g915 , SpecularColor126_g915 , SpecularTint126_g915 , SpecularPower126_g915 , SpecularMultiplier126_g915 , PositionWorld126_g915 , Translucency126_g915 , RimTransmission126_g915 , RimPower126_g915 );
				float3 tanNormal53_g915 = worldNormal86_g915;
				float3 bakedGI53_g915 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g915), dot(tanToWorld1,tanNormal53_g915), dot(tanToWorld2,tanNormal53_g915)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g915), dot(tanToWorld1,tanNormal53_g915), dot(tanToWorld2,tanNormal53_g915)), bakedGI53_g915, half4(0,0,0,0));
				float ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
				float temp_output_161_0_g915 = ambientOcclusion570;
				float temp_output_178_0_g915 = _AOOccludeAll;
				float lerpResult180_g915 = lerp( temp_output_161_0_g915 , 1.0 , temp_output_178_0_g915);
				float lerpResult183_g915 = lerp( 1.0 , temp_output_161_0_g915 , temp_output_178_0_g915);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g918 + ( ( saturate( ( ( dotResult15_g918 * ( 1.0 - temp_output_40_0_g918 ) ) + temp_output_40_0_g918 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g918 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g918 ) , 0.0 ) ) , temp_output_208_0_g915 ) * temp_output_207_0_g915 ) ) * temp_output_32_0_g918 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g915 , 0.0 ) ) + ( float4( bakedGI53_g915 , 0.0 ) * temp_output_42_0_g915 * lerpResult180_g915 ) ) * lerpResult183_g915 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;1976.035;-94.18666;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;591;-689.9429,353.1747;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;47;0;Create;False;0;0;0;False;0;False;2;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;524;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;804;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=43FBCD1288B61BEB88D2544477B64F332E9B1A61