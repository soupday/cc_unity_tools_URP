	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 From8_g709 = _HighlightADistribution;
				float ID8_g709 = idMap383;
				float Fac8_g709 = _HighlightAStrength;
				float localThreePointDistribution8_g709 = ThreePointDistribution( From8_g709 , ID8_g709 , Fac8_g709 );
				float temp_output_24_0_g709 = root58;
				float lerpResult16_g709 = lerp( ( 1.0 - temp_output_24_0_g709 ) , temp_output_24_0_g709 , _HighlightAOverlapInvert);
				float4 lerpResult18_g709 = lerp( lerpResult6_g707 , _HighlightAColor , saturate( ( localThreePointDistribution8_g709 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g709 ) ) ) ) ));
				float3 From8_g708 = _HighlightBDistribution;
				float ID8_g708 = idMap383;
				float Fac8_g708 = _HighlightBStrength;
				float localThreePointDistribution8_g708 = ThreePointDistribution( From8_g708 , ID8_g708 , Fac8_g708 );
				float temp_output_24_0_g708 = root58;
				float lerpResult16_g708 = lerp( ( 1.0 - temp_output_24_0_g708 ) , temp_output_24_0_g708 , _HighlightBOverlapInvert);
				float4 lerpResult18_g708 = lerp( lerpResult18_g709 , _HighlightBColor , saturate( ( localThreePointDistribution8_g708 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g708 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g708;
				#else
...
/*ASEBEGIN
Version=18934
1913;7;1920;1011;2568.638;903.2897;2.643575;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-677.0562,997.1207;Inherit;False;Property;_RimPower;Rim Power;42;0;Create;True;0;0;0;False;0;False;4;2;1;10;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=0438C6B695C3CEA82952026182F8B91D9BEFBEAD