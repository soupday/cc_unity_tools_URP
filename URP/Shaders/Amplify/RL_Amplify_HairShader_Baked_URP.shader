...
Shader "Reallusion/Amplify/RL_HairShader_Baked_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g850( float3 NormalTS, float3x3 TBN )
			{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 NormalTS13_g850 = ( ( appendResult98_g849 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g850 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g850 = float3x3(ase_worldTangent, Binormal5_g850, ase_worldNormal);
				float3x3 TBN13_g850 = TBN1_g850;
				float3 localTangentToWorld13_g850 = TangentToWorld13_g850( NormalTS13_g850 , TBN13_g850 );
				float3 flowTangent107_g849 = localTangentToWorld13_g850;
				...
				float3 normalizeResult10_g853 = normalize( ( flowTangent107_g849 + ( worldNormal86_g849 * lerpResult81_g849 ) ) );
				float3 shiftedTangent119_g849 = normalizeResult10_g853;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g851 = ase_worldViewDir;
				float3 lightDir55_g851 = SafeNormalize(_MainLightPosition.xyz);
				...
				float temp_output_132_0_g849 = _SpecularMultiplier;
				float4 temp_output_131_0_g849 = _SpecularTint;
				float4 temp_output_13_0_g851 = ( ( smoothstepResult22_g852 * pow( saturate( ( 1.0 - ( dotResult16_g852 * dotResult16_g852 ) ) ) , specularPower237_g849 ) ) * temp_output_132_0_g849 * temp_output_131_0_g849 );
				...
				float4 lerpResult36_g851 = lerp( temp_output_13_0_g851 , ( temp_output_13_0_g851 * temp_output_32_0_g851 ) , temp_output_172_0_g849);
				...
				float temp_output_40_0_g851 = temp_output_200_0_g849;
				...
				float ambientOcclusion570 = ( 1.0 - ( _OcclusionStrength * ( 1.0 - tex2D( _OcclusionMap, uv_OcclusionMap ).g ) ) );
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g851 + ( ( saturate( ( ( dotResult15_g851 * ( 1.0 - temp_output_40_0_g851 ) ) + temp_output_40_0_g851 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g851 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g851 ) , 0.0 ) ) , temp_output_208_0_g849 ) * temp_output_207_0_g849 ) ) * temp_output_32_0_g851 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g849 , 0.0 ) ) + ( float4( bakedGI53_g849 , 0.0 ) * temp_output_42_0_g849 * lerpResult180_g849 ) ) * lerpResult183_g849 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1913;6;1920;1023;4742.145;941.2488;3.968221;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;162;-131.2039,1552.618;Inherit;False;Property;_AlphaClip2;Alpha Clip;9;0;Create;False;0;0;0;False;0;False;0.15;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;596;-689.4732,354.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;22;0;Create;False;0;0;0;False;0;False;2;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-689.9268,277.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;21;0;Create;False;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;532;425.2342,1859.563;Inherit;False;Property;_ShadowClip;Shadow Clip;11;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=957A1C26CF6AFD3631C7F4F7E0CA2B592F2CC815