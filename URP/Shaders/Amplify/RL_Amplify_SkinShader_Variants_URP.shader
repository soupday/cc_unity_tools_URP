	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				half2 texCoord10_g112 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;373;-1056,-688;Inherit;False;normalMap;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;59;-2128,-160;Inherit;False;Property;_NormalBlendStrength;Normal Blend Strength (Head);35;0;Create;False;0;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;376;-1056,-592;Inherit;False;367;normalWrinkle;1;0;OBJECT;;False;1;FLOAT3;0
