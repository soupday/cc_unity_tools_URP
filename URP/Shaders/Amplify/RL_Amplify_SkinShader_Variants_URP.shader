	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				half2 texCoord308 = IN.ase_texcoord8.xy * temp_cast_10 + float2( 0,0 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				half2 texCoord308 = IN.ase_texcoord4.xy * temp_cast_9 + float2( 0,0 );
...
ASEEND*/
//CHKSM=38657B0DF9D7DAC52C0742CEFFCF2B192F3092AE