...
Shader "Reallusion/Amplify/RL_HairShader_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g962( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g961( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g961 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g961 = lerp( break109_g961.g , ( 1.0 - break109_g961.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g961 = (float3(break109_g961.r , lerpResult123_g961 , break109_g961.b));
				float3 NormalTS13_g962 = ( ( appendResult98_g961 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g962 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g962 = float3x3(ase_worldTangent, Binormal5_g962, ase_worldNormal);
				float3x3 TBN13_g962 = TBN1_g962;
				float3 localTangentToWorld13_g962 = TangentToWorld13_g962( NormalTS13_g962 , TBN13_g962 );
				float3 flowTangent107_g961 = localTangentToWorld13_g962;
				...
				float3 tanNormal85_g961 = normal282;
				float3 worldNormal85_g961 = normalize( float3(dot(tanToWorld0,tanNormal85_g961), dot(tanToWorld1,tanNormal85_g961), dot(tanToWorld2,tanNormal85_g961)) );
				float3 worldNormal86_g961 = worldNormal85_g961;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g961 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g963 = normalize( ( flowTangent107_g961 + ( worldNormal86_g961 * lerpResult81_g961 ) ) );
				float3 shiftedTangent119_g961 = normalizeResult10_g963;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g964 = ase_worldViewDir;
				float3 worldLight248_g961 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g964 = worldLight248_g961;
				float3 normalizeResult14_g965 = normalize( ( viewDIr52_g964 + lightDir55_g964 ) );
				float dotResult16_g965 = dot( shiftedTangent119_g961 , normalizeResult14_g965 );
				float smoothstepResult22_g965 = smoothstep( -1.0 , 0.0 , dotResult16_g965);
				...
				float temp_output_233_0_g961 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g961 = ( max( ( ( 2.0 / ( temp_output_233_0_g961 * temp_output_233_0_g961 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g961 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g961 = _SpecularTint;
				float4 temp_output_13_0_g964 = ( ( smoothstepResult22_g965 * pow( saturate( ( 1.0 - ( dotResult16_g965 * dotResult16_g965 ) ) ) , specularPower237_g961 ) ) * temp_output_132_0_g961 * temp_output_131_0_g961 );
				...
				float4 lerpResult18_g960 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g960 = root58;
				float lerpResult23_g960 = lerp( temp_output_27_0_g960 , ( 1.0 - temp_output_27_0_g960 ) , _InvertRootMap);
				float4 lerpResult3_g960 = lerp( _RootColor , _EndColor , lerpResult23_g960);
				float lerpResult40_g960 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g960);
				float4 lerpResult6_g960 = lerp( lerpResult18_g960 , lerpResult3_g960 , ( lerpResult40_g960 * _GlobalStrength ));
				float3 From8_g959 = _HighlightADistribution;
				float ID8_g959 = idMap383;
				float Fac8_g959 = _HighlightAStrength;
				float localThreePointDistribution8_g959 = ThreePointDistribution( From8_g959 , ID8_g959 , Fac8_g959 );
				float temp_output_24_0_g959 = root58;
				float lerpResult16_g959 = lerp( temp_output_24_0_g959 , ( 1.0 - temp_output_24_0_g959 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g959 = lerp( lerpResult6_g960 , _HighlightAColor , saturate( ( localThreePointDistribution8_g959 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g959 ) ) * _HighlightBlend ) ));
				float3 From8_g958 = _HighlightBDistribution;
				float ID8_g958 = idMap383;
				float Fac8_g958 = _HighlightBStrength;
				float localThreePointDistribution8_g958 = ThreePointDistribution( From8_g958 , ID8_g958 , Fac8_g958 );
				float temp_output_24_0_g958 = root58;
				float lerpResult16_g958 = lerp( temp_output_24_0_g958 , ( 1.0 - temp_output_24_0_g958 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g958 = lerp( lerpResult18_g959 , _HighlightBColor , saturate( ( localThreePointDistribution8_g958 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g958 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g958;
				#else
				...
				float4 temp_output_42_0_g961 = baseColor331;
				float4 temp_output_32_0_g964 = temp_output_42_0_g961;
				float temp_output_172_0_g961 = _SpecularMix;
				float4 lerpResult36_g964 = lerp( temp_output_13_0_g964 , ( temp_output_13_0_g964 * temp_output_32_0_g964 ) , temp_output_172_0_g961);
				float3 temp_output_24_0_g964 = worldNormal86_g961;
				float dotResult15_g964 = dot( lightDir55_g964 , temp_output_24_0_g964 );
				float temp_output_200_0_g961 = _Translucency;
				float temp_output_40_0_g964 = temp_output_200_0_g961;
				float dotResult54_g964 = dot( temp_output_24_0_g964 , viewDIr52_g964 );
				float dotResult57_g964 = dot( viewDIr52_g964 , lightDir55_g964 );
				float temp_output_208_0_g961 = _RimPower;
				float temp_output_207_0_g961 = _RimTransmissionIntensity;
				float3 Color126_g961 = temp_output_42_0_g961.rgb;
				float3 TangentWorld126_g961 = shiftedTangent119_g961;
				float3 ViewDir126_g961 = ase_worldViewDir;
				float3 NormalWorld126_g961 = worldNormal86_g961;
				float3 SpecularColor126_g961 = temp_output_131_0_g961.rgb;
				float SpecularTint126_g961 = temp_output_172_0_g961;
				float SpecularPower126_g961 = specularPower237_g961;
				float SpecularMultiplier126_g961 = temp_output_132_0_g961;
				float3 worldPosition129_g961 = WorldPosition;
				float3 PositionWorld126_g961 = worldPosition129_g961;
				float Translucency126_g961 = temp_output_200_0_g961;
				float RimTransmission126_g961 = temp_output_207_0_g961;
				float RimPower126_g961 = temp_output_208_0_g961;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g961 = RL_Amplify_Expression_HairLighting_Additional126_g961( Color126_g961 , TangentWorld126_g961 , ViewDir126_g961 , NormalWorld126_g961 , SpecularColor126_g961 , SpecularTint126_g961 , SpecularPower126_g961 , SpecularMultiplier126_g961 , PositionWorld126_g961 , Translucency126_g961 , RimTransmission126_g961 , RimPower126_g961 );
				float lerpResult627 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult627;
				float temp_output_161_0_g961 = ambientOcclusion570;
				float lerpResult280_g961 = lerp( 1.0 , temp_output_161_0_g961 , _AOOccludeAll);
				float3 tanNormal53_g961 = worldNormal86_g961;
				float3 bakedGI53_g961 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g961), dot(tanToWorld1,tanNormal53_g961), dot(tanToWorld2,tanNormal53_g961)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g961), dot(tanToWorld1,tanNormal53_g961), dot(tanToWorld2,tanNormal53_g961)), bakedGI53_g961, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g964 + ( ( saturate( ( ( dotResult15_g964 * ( 1.0 - temp_output_40_0_g964 ) ) + temp_output_40_0_g964 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g964 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g964 ) , 0.0 ) ) , temp_output_208_0_g961 ) * temp_output_207_0_g961 ) ) * temp_output_32_0_g964 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g961 , 0.0 ) ) * lerpResult280_g961 ) + ( float4( bakedGI53_g961 , 0.0 ) * temp_output_42_0_g961 * temp_output_161_0_g961 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;4031.78;1147.632;3.293759;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;52;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;630;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;960;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;624;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;959;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=8A6D51AB38EE1FAADF1119BEEDA196DE65E16A22