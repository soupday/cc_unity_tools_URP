	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 color10_g727 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 lerpResult18_g727 = lerp( color10_g727 , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g727 = root58;
				float lerpResult23_g727 = lerp( temp_output_27_0_g727 , ( 1.0 - temp_output_27_0_g727 ) , _InvertRootMap);
				float4 lerpResult3_g727 = lerp( _RootColor , _EndColor , lerpResult23_g727);
				float4 lerpResult6_g727 = lerp( lerpResult18_g727 , lerpResult3_g727 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g727 ) * _RootColorStrength ) + ( temp_output_27_0_g727 * _EndColorStrength ) ) ));
				float3 From8_g721 = _HighlightADistribution;
				float ID8_g721 = idMap383;
				float Fac8_g721 = _HighlightAStrength;
				float localThreePointDistribution8_g721 = ThreePointDistribution( From8_g721 , ID8_g721 , Fac8_g721 );
				float temp_output_24_0_g721 = root58;
				float lerpResult16_g721 = lerp( ( 1.0 - temp_output_24_0_g721 ) , temp_output_24_0_g721 , _HighlightAOverlapInvert);
				float4 lerpResult18_g721 = lerp( lerpResult6_g727 , _HighlightAColor , saturate( ( localThreePointDistribution8_g721 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g721 ) ) ) ) ));
				float3 From8_g720 = _HighlightBDistribution;
				float ID8_g720 = idMap383;
				float Fac8_g720 = _HighlightBStrength;
				float localThreePointDistribution8_g720 = ThreePointDistribution( From8_g720 , ID8_g720 , Fac8_g720 );
				float temp_output_24_0_g720 = root58;
				float lerpResult16_g720 = lerp( ( 1.0 - temp_output_24_0_g720 ) , temp_output_24_0_g720 , _HighlightBOverlapInvert);
				float4 lerpResult18_g720 = lerp( lerpResult18_g721 , _HighlightBColor , saturate( ( localThreePointDistribution8_g720 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g720 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g720;
				#else
...
/*ASEBEGIN
Version=18934
1921;1;1920;1017;1876.178;233.9187;1.666624;True;False
...
Node;AmplifyShaderEditor.FunctionNode;523;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;727;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-677.0562,997.1207;Inherit;False;Property;_RimPower;Rim Power;43;0;Create;True;0;0;0;False;0;False;2;2;0.01;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;524;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;720;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=CD6F833491978768F5AB645167E6AA7D5F3EB453