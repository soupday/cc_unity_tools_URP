...
Shader "Reallusion/Amplify/RL_HairShader_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g997( half3 NormalTS, half3x3 TBN )
			{
			...
			half3 RL_Amplify_Expression_HairLighting_Additional126_g996( half3 Color, half3 TangentWorld, half3 ViewDir, half3 NormalWorld, half3 SpecularColor, half SpecularTint, half SpecularPower, half SpecularMultiplier, half3 PositionWorld, half Translucency, half RimTransmission, half RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half4 break109_g996 = SAMPLE_TEXTURE2D( _FlowMap, sampler_DiffuseMap, uv_FlowMap );
				half lerpResult123_g996 = lerp( break109_g996.g , ( 1.0 - break109_g996.g ) , _FlowMapFlipGreen);
				half3 appendResult98_g996 = (half3(break109_g996.r , lerpResult123_g996 , break109_g996.b));
				half3 NormalTS13_g997 = ( ( appendResult98_g996 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_worldTangent = IN.ase_texcoord4.xyz;
				half3 ase_worldNormal = IN.ase_texcoord5.xyz;
				half3 Binormal5_g997 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g997 = float3x3(ase_worldTangent, Binormal5_g997, ase_worldNormal);
				half3x3 TBN13_g997 = TBN1_g997;
				half3 localTangentToWorld13_g997 = TangentToWorld13_g997( NormalTS13_g997 , TBN13_g997 );
				half3 flowTangent107_g996 = localTangentToWorld13_g997;
				...
				half3 worldNormal85_g996 = normalize( float3(dot(tanToWorld0,tanNormal85_g996), dot(tanToWorld1,tanNormal85_g996), dot(tanToWorld2,tanNormal85_g996)) );
				half3 worldNormal86_g996 = worldNormal85_g996;
				...
				half lerpResult81_g996 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				half3 normalizeResult10_g1000 = normalize( ( flowTangent107_g996 + ( worldNormal86_g996 * lerpResult81_g996 ) ) );
				half3 shiftedTangent119_g996 = normalizeResult10_g1000;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				half3 viewDIr52_g998 = ase_worldViewDir;
				half3 worldLight248_g996 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g998 = worldLight248_g996;
				half3 normalizeResult14_g999 = normalize( ( viewDIr52_g998 + lightDir55_g998 ) );
				half dotResult16_g999 = dot( shiftedTangent119_g996 , normalizeResult14_g999 );
				half smoothstepResult22_g999 = smoothstep( -1.0 , 0.0 , dotResult16_g999);
				...
				half temp_output_233_0_g996 = max( ( 1.0 - smoothness594 ) , 0.001 );
				half specularPower237_g996 = ( max( ( ( 2.0 / ( temp_output_233_0_g996 * temp_output_233_0_g996 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				half temp_output_132_0_g996 = ( SAMPLE_TEXTURE2D( _SpecularMap, sampler_DiffuseMap, uv_SpecularMap ).g * _SpecularMultiplier );
				half4 temp_output_131_0_g996 = _SpecularTint;
				half4 temp_output_13_0_g998 = ( ( smoothstepResult22_g999 * pow( saturate( ( 1.0 - ( dotResult16_g999 * dotResult16_g999 ) ) ) , specularPower237_g996 ) ) * temp_output_132_0_g996 * temp_output_131_0_g996 );
				...
				half4 temp_output_42_0_g996 = baseColor331;
				half4 temp_output_32_0_g998 = temp_output_42_0_g996;
				half temp_output_172_0_g996 = _SpecularMix;
				half4 lerpResult36_g998 = lerp( temp_output_13_0_g998 , ( temp_output_13_0_g998 * temp_output_32_0_g998 ) , temp_output_172_0_g996);
				half3 temp_output_24_0_g998 = worldNormal86_g996;
				half dotResult15_g998 = dot( lightDir55_g998 , temp_output_24_0_g998 );
				half temp_output_200_0_g996 = _Translucency;
				half temp_output_40_0_g998 = temp_output_200_0_g996;
				half dotResult54_g998 = dot( temp_output_24_0_g998 , viewDIr52_g998 );
				half dotResult57_g998 = dot( viewDIr52_g998 , lightDir55_g998 );
				half temp_output_208_0_g996 = _RimPower;
				half temp_output_207_0_g996 = _RimTransmissionIntensity;
				...
				half3 Color126_g996 = temp_output_42_0_g996.rgb;
				half3 TangentWorld126_g996 = shiftedTangent119_g996;
				half3 ViewDir126_g996 = ase_worldViewDir;
				half3 NormalWorld126_g996 = worldNormal86_g996;
				half3 SpecularColor126_g996 = temp_output_131_0_g996.rgb;
				half SpecularTint126_g996 = temp_output_172_0_g996;
				half SpecularPower126_g996 = specularPower237_g996;
				half SpecularMultiplier126_g996 = temp_output_132_0_g996;
				half3 worldPosition129_g996 = WorldPosition;
				half3 PositionWorld126_g996 = worldPosition129_g996;
				half Translucency126_g996 = temp_output_200_0_g996;
				half RimTransmission126_g996 = temp_output_207_0_g996;
				half RimPower126_g996 = temp_output_208_0_g996;
				half3 localRL_Amplify_Expression_HairLighting_Additional126_g996 = RL_Amplify_Expression_HairLighting_Additional126_g996( Color126_g996 , TangentWorld126_g996 , ViewDir126_g996 , NormalWorld126_g996 , SpecularColor126_g996 , SpecularTint126_g996 , SpecularPower126_g996 , SpecularMultiplier126_g996 , PositionWorld126_g996 , Translucency126_g996 , RimTransmission126_g996 , RimPower126_g996 );
				half lerpResult627 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				half ambientOcclusion570 = lerpResult627;
				half temp_output_161_0_g996 = ambientOcclusion570;
				half lerpResult280_g996 = lerp( 1.0 , temp_output_161_0_g996 , _AOOccludeAll);
				half3 bakedGI53_g996 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g996);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g998 + ( ( saturate( ( ( dotResult15_g998 * ( 1.0 - temp_output_40_0_g998 ) ) + temp_output_40_0_g998 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g998 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g998 ) , 0.0 ) ) , temp_output_208_0_g996 ) * temp_output_207_0_g996 ) ) * temp_output_32_0_g998 ) ) * ase_lightColor ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g996 , 0.0 ) ) * lerpResult280_g996 ) + ( half4( bakedGI53_g996 , 0.0 ) * temp_output_42_0_g996 * temp_output_161_0_g996 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;867.6932,1172.645;Half;False;True;-1;2;Reallusion.Import.CustomHairShaderGUI;0;13;Reallusion/Amplify/RL_HairShader_Variants_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Forward Only;1;638364368115681438;Cast Shadows;1;0;  Use Shadow Threshold;1;638364367834580070;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992251365997;DOTS Instancing;0;0;Meta Pass;0;638047171872173986;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;False;False;;True;0
...
Node;AmplifyShaderEditor.WireNode;641;126.6906,2394.86;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;641;0;532;0
ASEEND*/
//CHKSM=B8AEB57FED5757DEF53B3120297B7215735E49A0