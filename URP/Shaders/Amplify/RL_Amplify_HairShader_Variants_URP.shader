...
Shader "Reallusion/Amplify/RL_HairShader_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g886( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g884( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g884 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g884 = lerp( break109_g884.g , ( 1.0 - break109_g884.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g884 = (float3(break109_g884.r , lerpResult123_g884 , break109_g884.b));
				float3 NormalTS13_g886 = ( ( appendResult98_g884 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g886 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g886 = float3x3(ase_worldTangent, Binormal5_g886, ase_worldNormal);
				float3x3 TBN13_g886 = TBN1_g886;
				float3 localTangentToWorld13_g886 = TangentToWorld13_g886( NormalTS13_g886 , TBN13_g886 );
				float3 flowTangent107_g884 = localTangentToWorld13_g886;
				...
				float3 tanNormal85_g884 = normal282;
				float3 worldNormal85_g884 = normalize( float3(dot(tanToWorld0,tanNormal85_g884), dot(tanToWorld1,tanNormal85_g884), dot(tanToWorld2,tanNormal85_g884)) );
				float3 worldNormal86_g884 = worldNormal85_g884;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g884 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g885 = normalize( ( flowTangent107_g884 + ( worldNormal86_g884 * lerpResult81_g884 ) ) );
				float3 shiftedTangent119_g884 = normalizeResult10_g885;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g887 = ase_worldViewDir;
				float3 worldLight248_g884 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g887 = worldLight248_g884;
				float3 normalizeResult14_g888 = normalize( ( viewDIr52_g887 + lightDir55_g887 ) );
				float dotResult16_g888 = dot( shiftedTangent119_g884 , normalizeResult14_g888 );
				float smoothstepResult22_g888 = smoothstep( -1.0 , 0.0 , dotResult16_g888);
				...
				float temp_output_233_0_g884 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g884 = ( max( ( ( 2.0 / ( temp_output_233_0_g884 * temp_output_233_0_g884 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g884 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g884 = _SpecularTint;
				float4 temp_output_13_0_g887 = ( ( smoothstepResult22_g888 * pow( saturate( ( 1.0 - ( dotResult16_g888 * dotResult16_g888 ) ) ) , specularPower237_g884 ) ) * temp_output_132_0_g884 * temp_output_131_0_g884 );
				...
				float4 color10_g882 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 lerpResult18_g882 = lerp( color10_g882 , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g882 = root58;
				float lerpResult23_g882 = lerp( temp_output_27_0_g882 , ( 1.0 - temp_output_27_0_g882 ) , _InvertRootMap);
				float4 lerpResult3_g882 = lerp( _RootColor , _EndColor , lerpResult23_g882);
				float4 lerpResult6_g882 = lerp( lerpResult18_g882 , lerpResult3_g882 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g882 ) * _RootColorStrength ) + ( temp_output_27_0_g882 * _EndColorStrength ) ) ));
				float3 From8_g881 = _HighlightADistribution;
				float ID8_g881 = idMap383;
				float Fac8_g881 = _HighlightAStrength;
				float localThreePointDistribution8_g881 = ThreePointDistribution( From8_g881 , ID8_g881 , Fac8_g881 );
				float temp_output_24_0_g881 = root58;
				float lerpResult16_g881 = lerp( ( 1.0 - temp_output_24_0_g881 ) , temp_output_24_0_g881 , _HighlightAOverlapInvert);
				float4 lerpResult18_g881 = lerp( lerpResult6_g882 , _HighlightAColor , saturate( ( localThreePointDistribution8_g881 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g881 ) ) ) ) ));
				float3 From8_g883 = _HighlightBDistribution;
				float ID8_g883 = idMap383;
				float Fac8_g883 = _HighlightBStrength;
				float localThreePointDistribution8_g883 = ThreePointDistribution( From8_g883 , ID8_g883 , Fac8_g883 );
				float temp_output_24_0_g883 = root58;
				float lerpResult16_g883 = lerp( ( 1.0 - temp_output_24_0_g883 ) , temp_output_24_0_g883 , _HighlightBOverlapInvert);
				float4 lerpResult18_g883 = lerp( lerpResult18_g881 , _HighlightBColor , saturate( ( localThreePointDistribution8_g883 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g883 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g883;
				#else
				...
				float4 temp_output_42_0_g884 = baseColor331;
				float4 temp_output_32_0_g887 = temp_output_42_0_g884;
				float temp_output_172_0_g884 = _SpecularMix;
				float4 lerpResult36_g887 = lerp( temp_output_13_0_g887 , ( temp_output_13_0_g887 * temp_output_32_0_g887 ) , temp_output_172_0_g884);
				float3 temp_output_24_0_g887 = worldNormal86_g884;
				float dotResult15_g887 = dot( lightDir55_g887 , temp_output_24_0_g887 );
				float temp_output_200_0_g884 = _Translucency;
				float temp_output_40_0_g887 = temp_output_200_0_g884;
				float dotResult54_g887 = dot( temp_output_24_0_g887 , viewDIr52_g887 );
				float dotResult57_g887 = dot( viewDIr52_g887 , lightDir55_g887 );
				float temp_output_208_0_g884 = _RimPower;
				float temp_output_207_0_g884 = _RimTransmissionIntensity;
				float3 Color126_g884 = temp_output_42_0_g884.rgb;
				float3 TangentWorld126_g884 = shiftedTangent119_g884;
				float3 ViewDir126_g884 = ase_worldViewDir;
				float3 NormalWorld126_g884 = worldNormal86_g884;
				float3 SpecularColor126_g884 = temp_output_131_0_g884.rgb;
				float SpecularTint126_g884 = temp_output_172_0_g884;
				float SpecularPower126_g884 = specularPower237_g884;
				float SpecularMultiplier126_g884 = temp_output_132_0_g884;
				float3 worldPosition129_g884 = WorldPosition;
				float3 PositionWorld126_g884 = worldPosition129_g884;
				float Translucency126_g884 = temp_output_200_0_g884;
				float RimTransmission126_g884 = temp_output_207_0_g884;
				float RimPower126_g884 = temp_output_208_0_g884;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g884 = RL_Amplify_Expression_HairLighting_Additional126_g884( Color126_g884 , TangentWorld126_g884 , ViewDir126_g884 , NormalWorld126_g884 , SpecularColor126_g884 , SpecularTint126_g884 , SpecularPower126_g884 , SpecularMultiplier126_g884 , PositionWorld126_g884 , Translucency126_g884 , RimTransmission126_g884 , RimPower126_g884 );
				float3 tanNormal53_g884 = worldNormal86_g884;
				float3 bakedGI53_g884 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g884), dot(tanToWorld1,tanNormal53_g884), dot(tanToWorld2,tanNormal53_g884)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g884), dot(tanToWorld1,tanNormal53_g884), dot(tanToWorld2,tanNormal53_g884)), bakedGI53_g884, half4(0,0,0,0));
				float ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
				float temp_output_161_0_g884 = ambientOcclusion570;
				float temp_output_178_0_g884 = _AOOccludeAll;
				float lerpResult180_g884 = lerp( temp_output_161_0_g884 , 1.0 , temp_output_178_0_g884);
				float lerpResult183_g884 = lerp( 1.0 , temp_output_161_0_g884 , temp_output_178_0_g884);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g887 + ( ( saturate( ( ( dotResult15_g887 * ( 1.0 - temp_output_40_0_g887 ) ) + temp_output_40_0_g887 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g887 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g887 ) , 0.0 ) ) , temp_output_208_0_g884 ) * temp_output_207_0_g884 ) ) * temp_output_32_0_g887 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g884 , 0.0 ) ) + ( float4( bakedGI53_g884 , 0.0 ) * temp_output_42_0_g884 * lerpResult180_g884 ) ) * lerpResult183_g884 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
0;0;1920;1029;2396.674;-303.4251;1;True;False
...
Node;AmplifyShaderEditor.StaticSwitch;95;-2929.674,-76.43671;Inherit;False;Property;BOOLEAN_ENABLECOLOR;Enable Color;20;0;Create;False;0;0;0;False;0;False;0;0;0;True;BOOLEAN_ENABLECOLOR_ON;Toggle;2;Key0;Key1;Create;True;False;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;134;-1461.834,1309.566;Inherit;False;Property;_EmissiveColor;Emissive Color;52;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;385;-684.1522,771.6683;Inherit;False;Property;_SpecularShiftMin;Specular Shift Min;46;0;Create;True;0;0;0;False;0;False;-0.25;-0.25;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-676.3562,1073.421;Inherit;False;Property;_RimPower;Rim Hardness;49;0;Create;False;0;0;0;False;0;False;4;2.5;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;609;-1214.377,130.6914;Inherit;True;Property;_SpecularMap;Specular Map;41;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;378;-628.2301,-49.07933;Inherit;False;Property;_SpecularTint;Specular Tint;42;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;50;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;522;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;881;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;539;-679.4417,923.2449;Inherit;False;Property;_Translucency;Translucency;48;0;Create;True;0;0;0;False;0;False;0;0.15;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularMix;Specular Mix;45;0;Create;True;0;0;0;False;0;False;1;0.5;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;596;-689.4732,354.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;44;0;Create;False;0;0;0;False;0;False;2;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;133;-1503.434,1109.366;Inherit;True;Property;_EmissionMap;Emission Map;51;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;389;-681.8292,847.2004;Inherit;False;Property;_SpecularShiftMax;Specular Shift Max;47;0;Create;True;0;0;0;False;0;False;0.25;0.25;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;380;-1192.927,330.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;43;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=334C7ECC981C716D7C8181A180B4400640DCEBBD