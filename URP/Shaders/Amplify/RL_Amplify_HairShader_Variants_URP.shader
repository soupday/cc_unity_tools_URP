...
Shader "Reallusion/Amplify/RL_HairShader_Variants_URP"
{
	Properties
	{
		...
		[ASEEnd]_Translucency("Translucency", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g877( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g875( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g875 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g875 = lerp( break109_g875.g , ( 1.0 - break109_g875.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g875 = (float3(break109_g875.r , lerpResult123_g875 , break109_g875.b));
				float3 NormalTS13_g877 = ( ( appendResult98_g875 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g877 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g877 = float3x3(ase_worldTangent, Binormal5_g877, ase_worldNormal);
				float3x3 TBN13_g877 = TBN1_g877;
				float3 localTangentToWorld13_g877 = TangentToWorld13_g877( NormalTS13_g877 , TBN13_g877 );
				float3 flowTangent107_g875 = localTangentToWorld13_g877;
				float2 uv_NormalMap = IN.ase_texcoord3.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float3 normal282 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), 1.0f );
				float3 ase_worldBitangent = IN.ase_texcoord6.xyz;
				float3 tanToWorld0 = float3( ase_worldTangent.x, ase_worldBitangent.x, ase_worldNormal.x );
				float3 tanToWorld1 = float3( ase_worldTangent.y, ase_worldBitangent.y, ase_worldNormal.y );
				float3 tanToWorld2 = float3( ase_worldTangent.z, ase_worldBitangent.z, ase_worldNormal.z );
				float3 tanNormal85_g875 = normal282;
				float3 worldNormal85_g875 = normalize( float3(dot(tanToWorld0,tanNormal85_g875), dot(tanToWorld1,tanNormal85_g875), dot(tanToWorld2,tanNormal85_g875)) );
				float3 worldNormal86_g875 = worldNormal85_g875;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g875 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g876 = normalize( ( flowTangent107_g875 + ( worldNormal86_g875 * lerpResult81_g875 ) ) );
				float3 shiftedTangent119_g875 = normalizeResult10_g876;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g878 = ase_worldViewDir;
				float3 worldLight248_g875 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g878 = worldLight248_g875;
				float3 normalizeResult14_g879 = normalize( ( viewDIr52_g878 + lightDir55_g878 ) );
				float dotResult16_g879 = dot( shiftedTangent119_g875 , normalizeResult14_g879 );
				float smoothstepResult22_g879 = smoothstep( -1.0 , 0.0 , dotResult16_g879);
				...
				float temp_output_233_0_g875 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g875 = ( max( ( ( 2.0 / ( temp_output_233_0_g875 * temp_output_233_0_g875 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g875 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g875 = _SpecularTint;
				float4 temp_output_13_0_g878 = ( ( smoothstepResult22_g879 * pow( saturate( ( 1.0 - ( dotResult16_g879 * dotResult16_g879 ) ) ) , specularPower237_g875 ) ) * temp_output_132_0_g875 * temp_output_131_0_g875 );
				...
				float4 color10_g874 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 lerpResult18_g874 = lerp( color10_g874 , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g874 = root58;
				float lerpResult23_g874 = lerp( temp_output_27_0_g874 , ( 1.0 - temp_output_27_0_g874 ) , _InvertRootMap);
				float4 lerpResult3_g874 = lerp( _RootColor , _EndColor , lerpResult23_g874);
				float4 lerpResult6_g874 = lerp( lerpResult18_g874 , lerpResult3_g874 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g874 ) * _RootColorStrength ) + ( temp_output_27_0_g874 * _EndColorStrength ) ) ));
				float3 From8_g872 = _HighlightADistribution;
				float ID8_g872 = idMap383;
				float Fac8_g872 = _HighlightAStrength;
				float localThreePointDistribution8_g872 = ThreePointDistribution( From8_g872 , ID8_g872 , Fac8_g872 );
				float temp_output_24_0_g872 = root58;
				float lerpResult16_g872 = lerp( ( 1.0 - temp_output_24_0_g872 ) , temp_output_24_0_g872 , _HighlightAOverlapInvert);
				float4 lerpResult18_g872 = lerp( lerpResult6_g874 , _HighlightAColor , saturate( ( localThreePointDistribution8_g872 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g872 ) ) ) ) ));
				float3 From8_g873 = _HighlightBDistribution;
				float ID8_g873 = idMap383;
				float Fac8_g873 = _HighlightBStrength;
				float localThreePointDistribution8_g873 = ThreePointDistribution( From8_g873 , ID8_g873 , Fac8_g873 );
				float temp_output_24_0_g873 = root58;
				float lerpResult16_g873 = lerp( ( 1.0 - temp_output_24_0_g873 ) , temp_output_24_0_g873 , _HighlightBOverlapInvert);
				float4 lerpResult18_g873 = lerp( lerpResult18_g872 , _HighlightBColor , saturate( ( localThreePointDistribution8_g873 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g873 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g873;
				#else
				...
				float4 temp_output_42_0_g875 = baseColor331;
				float4 temp_output_32_0_g878 = temp_output_42_0_g875;
				float temp_output_172_0_g875 = _SpecularMix;
				float4 lerpResult36_g878 = lerp( temp_output_13_0_g878 , ( temp_output_13_0_g878 * temp_output_32_0_g878 ) , temp_output_172_0_g875);
				float3 temp_output_24_0_g878 = worldNormal86_g875;
				float dotResult15_g878 = dot( lightDir55_g878 , temp_output_24_0_g878 );
				float temp_output_200_0_g875 = _Translucency;
				float temp_output_40_0_g878 = temp_output_200_0_g875;
				float dotResult54_g878 = dot( temp_output_24_0_g878 , viewDIr52_g878 );
				float dotResult57_g878 = dot( viewDIr52_g878 , lightDir55_g878 );
				float temp_output_208_0_g875 = _RimPower;
				float temp_output_207_0_g875 = _RimTransmissionIntensity;
				float3 Color126_g875 = temp_output_42_0_g875.rgb;
				float3 TangentWorld126_g875 = shiftedTangent119_g875;
				float3 ViewDir126_g875 = ase_worldViewDir;
				float3 NormalWorld126_g875 = worldNormal86_g875;
				float3 SpecularColor126_g875 = temp_output_131_0_g875.rgb;
				float SpecularTint126_g875 = temp_output_172_0_g875;
				float SpecularPower126_g875 = specularPower237_g875;
				float SpecularMultiplier126_g875 = temp_output_132_0_g875;
				float3 worldPosition129_g875 = WorldPosition;
				float3 PositionWorld126_g875 = worldPosition129_g875;
				float Translucency126_g875 = temp_output_200_0_g875;
				float RimTransmission126_g875 = temp_output_207_0_g875;
				float RimPower126_g875 = temp_output_208_0_g875;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g875 = RL_Amplify_Expression_HairLighting_Additional126_g875( Color126_g875 , TangentWorld126_g875 , ViewDir126_g875 , NormalWorld126_g875 , SpecularColor126_g875 , SpecularTint126_g875 , SpecularPower126_g875 , SpecularMultiplier126_g875 , PositionWorld126_g875 , Translucency126_g875 , RimTransmission126_g875 , RimPower126_g875 );
				float3 tanNormal53_g875 = worldNormal86_g875;
				float3 bakedGI53_g875 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g875), dot(tanToWorld1,tanNormal53_g875), dot(tanToWorld2,tanNormal53_g875)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g875), dot(tanToWorld1,tanNormal53_g875), dot(tanToWorld2,tanNormal53_g875)), bakedGI53_g875, half4(0,0,0,0));
				float ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
				float temp_output_161_0_g875 = ambientOcclusion570;
				float temp_output_178_0_g875 = _AOOccludeAll;
				float lerpResult180_g875 = lerp( temp_output_161_0_g875 , 1.0 , temp_output_178_0_g875);
				float lerpResult183_g875 = lerp( 1.0 , temp_output_161_0_g875 , temp_output_178_0_g875);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g878 + ( ( saturate( ( ( dotResult15_g878 * ( 1.0 - temp_output_40_0_g878 ) ) + temp_output_40_0_g878 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g878 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g878 ) , 0.0 ) ) , temp_output_208_0_g875 ) * temp_output_207_0_g875 ) ) * temp_output_32_0_g878 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g875 , 0.0 ) ) + ( float4( bakedGI53_g875 , 0.0 ) * temp_output_42_0_g875 * lerpResult180_g875 ) ) * lerpResult183_g875 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;6089.112;1521.34;4.577472;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;121;-2526.007,-395.2434;Inherit;False;1611.361;818.9382;;14;331;96;104;97;101;105;106;107;113;98;112;99;380;609;Final Color Blending;0.514151,1,0.6056049,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1083.77;1575.508;;18;265;608;595;569;263;482;108;572;378;596;571;385;180;177;384;389;539;611;Specular Highlights;1,0.7932334,0.514151,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;524;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;873;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;609;-1214.377,130.6914;Inherit;True;Property;_SpecularMap;Specular Map;17;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularMix;Specular Mix;49;0;Create;True;0;0;0;False;0;False;1;0.5;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;32;-5612.805,-421.4388;Inherit;False;Property;_EndColor;End Color;27;0;Create;True;0;0;0;False;0;False;0.6039216,0.454902,0.2862745,0;0.6039216,0.454902,0.2862743,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;522;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;872;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;596;-689.4732,354.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;48;0;Create;False;0;0;0;False;0;False;2;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;26;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294116,0.1411763,0.05098024,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1192.927,330.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;47;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;115;-2785.541,1954.936;Inherit;True;Property;_MaskMap;Mask Map;10;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=32BA3E7E1FCA4B8525787AA4112072695D9DCD96