...
Shader "Reallusion/Amplify/RL_HairShader_Variants_URP"
{
	Properties
	{
		...
		[ASEEnd]_HighlightBOverlapInvert("Highlight B Overlap Invert", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g999( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g996( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g996 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g996 = lerp( break109_g996.g , ( 1.0 - break109_g996.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g996 = (float3(break109_g996.r , lerpResult123_g996 , break109_g996.b));
				float3 NormalTS13_g999 = ( ( appendResult98_g996 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g999 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g999 = float3x3(ase_worldTangent, Binormal5_g999, ase_worldNormal);
				float3x3 TBN13_g999 = TBN1_g999;
				float3 localTangentToWorld13_g999 = TangentToWorld13_g999( NormalTS13_g999 , TBN13_g999 );
				float3 flowTangent107_g996 = localTangentToWorld13_g999;
				...
				float3 tanNormal85_g996 = normal282;
				float3 worldNormal85_g996 = normalize( float3(dot(tanToWorld0,tanNormal85_g996), dot(tanToWorld1,tanNormal85_g996), dot(tanToWorld2,tanNormal85_g996)) );
				float3 worldNormal86_g996 = worldNormal85_g996;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g996 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g1000 = normalize( ( flowTangent107_g996 + ( worldNormal86_g996 * lerpResult81_g996 ) ) );
				float3 shiftedTangent119_g996 = normalizeResult10_g1000;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g997 = ase_worldViewDir;
				float3 worldLight248_g996 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g997 = worldLight248_g996;
				float3 normalizeResult14_g998 = normalize( ( viewDIr52_g997 + lightDir55_g997 ) );
				float dotResult16_g998 = dot( shiftedTangent119_g996 , normalizeResult14_g998 );
				float smoothstepResult22_g998 = smoothstep( -1.0 , 0.0 , dotResult16_g998);
				...
				float temp_output_233_0_g996 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g996 = ( max( ( ( 2.0 / ( temp_output_233_0_g996 * temp_output_233_0_g996 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g996 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g996 = _SpecularTint;
				float4 temp_output_13_0_g997 = ( ( smoothstepResult22_g998 * pow( saturate( ( 1.0 - ( dotResult16_g998 * dotResult16_g998 ) ) ) , specularPower237_g996 ) ) * temp_output_132_0_g996 * temp_output_131_0_g996 );
				...
				float4 temp_output_42_0_g996 = baseColor331;
				float4 temp_output_32_0_g997 = temp_output_42_0_g996;
				float temp_output_172_0_g996 = _SpecularMix;
				float4 lerpResult36_g997 = lerp( temp_output_13_0_g997 , ( temp_output_13_0_g997 * temp_output_32_0_g997 ) , temp_output_172_0_g996);
				float3 temp_output_24_0_g997 = worldNormal86_g996;
				float dotResult15_g997 = dot( lightDir55_g997 , temp_output_24_0_g997 );
				float temp_output_200_0_g996 = _Translucency;
				float temp_output_40_0_g997 = temp_output_200_0_g996;
				float dotResult54_g997 = dot( temp_output_24_0_g997 , viewDIr52_g997 );
				float dotResult57_g997 = dot( viewDIr52_g997 , lightDir55_g997 );
				float temp_output_208_0_g996 = _RimPower;
				float temp_output_207_0_g996 = _RimTransmissionIntensity;
				float3 Color126_g996 = temp_output_42_0_g996.rgb;
				float3 TangentWorld126_g996 = shiftedTangent119_g996;
				float3 ViewDir126_g996 = ase_worldViewDir;
				float3 NormalWorld126_g996 = worldNormal86_g996;
				float3 SpecularColor126_g996 = temp_output_131_0_g996.rgb;
				float SpecularTint126_g996 = temp_output_172_0_g996;
				float SpecularPower126_g996 = specularPower237_g996;
				float SpecularMultiplier126_g996 = temp_output_132_0_g996;
				float3 worldPosition129_g996 = WorldPosition;
				float3 PositionWorld126_g996 = worldPosition129_g996;
				float Translucency126_g996 = temp_output_200_0_g996;
				float RimTransmission126_g996 = temp_output_207_0_g996;
				float RimPower126_g996 = temp_output_208_0_g996;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g996 = RL_Amplify_Expression_HairLighting_Additional126_g996( Color126_g996 , TangentWorld126_g996 , ViewDir126_g996 , NormalWorld126_g996 , SpecularColor126_g996 , SpecularTint126_g996 , SpecularPower126_g996 , SpecularMultiplier126_g996 , PositionWorld126_g996 , Translucency126_g996 , RimTransmission126_g996 , RimPower126_g996 );
				float lerpResult627 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult627;
				float temp_output_161_0_g996 = ambientOcclusion570;
				float lerpResult280_g996 = lerp( 1.0 , temp_output_161_0_g996 , _AOOccludeAll);
				float3 bakedGI53_g996 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g996);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g996, bakedGI53_g996, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g997 + ( ( saturate( ( ( dotResult15_g997 * ( 1.0 - temp_output_40_0_g997 ) ) + temp_output_40_0_g997 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g997 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g997 ) , 0.0 ) ) , temp_output_208_0_g996 ) * temp_output_207_0_g996 ) ) * temp_output_32_0_g997 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g996 , 0.0 ) ) * lerpResult280_g996 ) + ( float4( bakedGI53_g996 , 0.0 ) * temp_output_42_0_g996 * temp_output_161_0_g996 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
Node;AmplifyShaderEditor.SamplerNode;177;-709.0319,429.8401;Inherit;True;Property;_FlowMap;Flow Map;20;0;Create;True;0;0;0;False;0;False;19;cc37af08370d26540b0e6725a8b8879e;cc37af08370d26540b0e6725a8b8879e;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;519;-5581.311,-960.5982;Inherit;False;517;diffuseMap;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;92;-4296.681,19.90401;Inherit;False;Property;_HighlightBColor;Highlight B Color;51;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;134;-1461.834,1309.566;Inherit;False;Property;_EmissiveColor;Emissive Color;33;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;41;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294116,0.1411763,0.05098024,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;32;-5612.805,-421.4388;Inherit;False;Property;_EndColor;End Color;42;0;Create;True;0;0;0;False;0;False;0.6039216,0.454902,0.2862745,0;0.6039216,0.454902,0.2862743,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;50;-5668.366,1711.348;Inherit;True;Property;_IDMap;ID Map;43;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;26;-5664.931,1926.134;Inherit;True;Property;_RootMap;Root Map;35;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;378;-628.2301,-49.07933;Inherit;False;Property;_SpecularTint;Specular Tint;23;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;609;-1214.377,130.6914;Inherit;True;Property;_SpecularMap;Specular Map;22;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;133;-1503.434,1109.366;Inherit;True;Property;_EmissionMap;Emission Map;32;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;69;-4960.777,-437.1049;Inherit;False;Property;_HighlightAColor;Highlight A Color;46;0;Create;True;0;0;0;False;0;False;0.9137255,0.7803922,0.6352941,0;0.9137255,0.7803922,0.635294,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;867.6932,1172.645;Float;False;True;-1;2;Reallusion.Import.CustomHairShaderGUI;0;13;Reallusion/Amplify/RL_HairShader_Variants_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Forward Only;1;638048889199488534;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992251365997;DOTS Instancing;0;0;Meta Pass;0;638047171872173986;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;True;False;;False;0
...
WireConnection;635;7;595;0
WireConnection;635;172;482;0
WireConnection;635;132;611;0
WireConnection;635;245;596;0
...
ASEEND*/
//CHKSM=D9125BD1FDA033D00F180862E196783E59A191EE