...
Shader "Reallusion/Amplify/RL_HairShader_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g895( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g893( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g893 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g893 = lerp( break109_g893.g , ( 1.0 - break109_g893.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g893 = (float3(break109_g893.r , lerpResult123_g893 , break109_g893.b));
				float3 NormalTS13_g895 = ( ( appendResult98_g893 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g895 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g895 = float3x3(ase_worldTangent, Binormal5_g895, ase_worldNormal);
				float3x3 TBN13_g895 = TBN1_g895;
				float3 localTangentToWorld13_g895 = TangentToWorld13_g895( NormalTS13_g895 , TBN13_g895 );
				float3 flowTangent107_g893 = localTangentToWorld13_g895;
				...
				float3 tanNormal85_g893 = normal282;
				float3 worldNormal85_g893 = normalize( float3(dot(tanToWorld0,tanNormal85_g893), dot(tanToWorld1,tanNormal85_g893), dot(tanToWorld2,tanNormal85_g893)) );
				float3 worldNormal86_g893 = worldNormal85_g893;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g893 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g894 = normalize( ( flowTangent107_g893 + ( worldNormal86_g893 * lerpResult81_g893 ) ) );
				float3 shiftedTangent119_g893 = normalizeResult10_g894;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g896 = ase_worldViewDir;
				float3 worldLight248_g893 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g896 = worldLight248_g893;
				float3 normalizeResult14_g897 = normalize( ( viewDIr52_g896 + lightDir55_g896 ) );
				float dotResult16_g897 = dot( shiftedTangent119_g893 , normalizeResult14_g897 );
				float smoothstepResult22_g897 = smoothstep( -1.0 , 0.0 , dotResult16_g897);
				...
				float temp_output_233_0_g893 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g893 = ( max( ( ( 2.0 / ( temp_output_233_0_g893 * temp_output_233_0_g893 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g893 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g893 = _SpecularTint;
				float4 temp_output_13_0_g896 = ( ( smoothstepResult22_g897 * pow( saturate( ( 1.0 - ( dotResult16_g897 * dotResult16_g897 ) ) ) , specularPower237_g893 ) ) * temp_output_132_0_g893 * temp_output_131_0_g893 );
				...
				float4 color10_g891 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 lerpResult18_g891 = lerp( color10_g891 , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g891 = root58;
				float lerpResult23_g891 = lerp( temp_output_27_0_g891 , ( 1.0 - temp_output_27_0_g891 ) , _InvertRootMap);
				float4 lerpResult3_g891 = lerp( _RootColor , _EndColor , lerpResult23_g891);
				float4 lerpResult6_g891 = lerp( lerpResult18_g891 , lerpResult3_g891 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g891 ) * _RootColorStrength ) + ( temp_output_27_0_g891 * _EndColorStrength ) ) ));
				float3 From8_g890 = _HighlightADistribution;
				float ID8_g890 = idMap383;
				float Fac8_g890 = _HighlightAStrength;
				float localThreePointDistribution8_g890 = ThreePointDistribution( From8_g890 , ID8_g890 , Fac8_g890 );
				float temp_output_24_0_g890 = root58;
				float lerpResult16_g890 = lerp( ( 1.0 - temp_output_24_0_g890 ) , temp_output_24_0_g890 , _HighlightAOverlapInvert);
				float4 lerpResult18_g890 = lerp( lerpResult6_g891 , _HighlightAColor , saturate( ( localThreePointDistribution8_g890 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g890 ) ) ) ) ));
				float3 From8_g892 = _HighlightBDistribution;
				float ID8_g892 = idMap383;
				float Fac8_g892 = _HighlightBStrength;
				float localThreePointDistribution8_g892 = ThreePointDistribution( From8_g892 , ID8_g892 , Fac8_g892 );
				float temp_output_24_0_g892 = root58;
				float lerpResult16_g892 = lerp( ( 1.0 - temp_output_24_0_g892 ) , temp_output_24_0_g892 , _HighlightBOverlapInvert);
				float4 lerpResult18_g892 = lerp( lerpResult18_g890 , _HighlightBColor , saturate( ( localThreePointDistribution8_g892 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g892 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g892;
				#else
				...
				float4 temp_output_42_0_g893 = baseColor331;
				float4 temp_output_32_0_g896 = temp_output_42_0_g893;
				float temp_output_172_0_g893 = _SpecularMix;
				float4 lerpResult36_g896 = lerp( temp_output_13_0_g896 , ( temp_output_13_0_g896 * temp_output_32_0_g896 ) , temp_output_172_0_g893);
				float3 temp_output_24_0_g896 = worldNormal86_g893;
				float dotResult15_g896 = dot( lightDir55_g896 , temp_output_24_0_g896 );
				float temp_output_200_0_g893 = _Translucency;
				float temp_output_40_0_g896 = temp_output_200_0_g893;
				float dotResult54_g896 = dot( temp_output_24_0_g896 , viewDIr52_g896 );
				float dotResult57_g896 = dot( viewDIr52_g896 , lightDir55_g896 );
				float temp_output_208_0_g893 = _RimPower;
				float temp_output_207_0_g893 = _RimTransmissionIntensity;
				float3 Color126_g893 = temp_output_42_0_g893.rgb;
				float3 TangentWorld126_g893 = shiftedTangent119_g893;
				float3 ViewDir126_g893 = ase_worldViewDir;
				float3 NormalWorld126_g893 = worldNormal86_g893;
				float3 SpecularColor126_g893 = temp_output_131_0_g893.rgb;
				float SpecularTint126_g893 = temp_output_172_0_g893;
				float SpecularPower126_g893 = specularPower237_g893;
				float SpecularMultiplier126_g893 = temp_output_132_0_g893;
				float3 worldPosition129_g893 = WorldPosition;
				float3 PositionWorld126_g893 = worldPosition129_g893;
				float Translucency126_g893 = temp_output_200_0_g893;
				float RimTransmission126_g893 = temp_output_207_0_g893;
				float RimPower126_g893 = temp_output_208_0_g893;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g893 = RL_Amplify_Expression_HairLighting_Additional126_g893( Color126_g893 , TangentWorld126_g893 , ViewDir126_g893 , NormalWorld126_g893 , SpecularColor126_g893 , SpecularTint126_g893 , SpecularPower126_g893 , SpecularMultiplier126_g893 , PositionWorld126_g893 , Translucency126_g893 , RimTransmission126_g893 , RimPower126_g893 );
				float3 tanNormal53_g893 = worldNormal86_g893;
				float3 bakedGI53_g893 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g893), dot(tanToWorld1,tanNormal53_g893), dot(tanToWorld2,tanNormal53_g893)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g893), dot(tanToWorld1,tanNormal53_g893), dot(tanToWorld2,tanNormal53_g893)), bakedGI53_g893, half4(0,0,0,0));
				float ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
				float temp_output_161_0_g893 = ambientOcclusion570;
				float temp_output_178_0_g893 = _AOOccludeAll;
				float lerpResult180_g893 = lerp( temp_output_161_0_g893 , 1.0 , temp_output_178_0_g893);
				float lerpResult183_g893 = lerp( 1.0 , temp_output_161_0_g893 , temp_output_178_0_g893);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g896 + ( ( saturate( ( ( dotResult15_g896 * ( 1.0 - temp_output_40_0_g896 ) ) + temp_output_40_0_g896 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g896 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g896 ) , 0.0 ) ) , temp_output_208_0_g893 ) * temp_output_207_0_g893 ) ) * temp_output_32_0_g896 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g893 , 0.0 ) ) + ( float4( bakedGI53_g893 , 0.0 ) * temp_output_42_0_g893 * lerpResult180_g893 ) ) * lerpResult183_g893 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;2394.456;572.2915;1.3;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;51;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;134;-1461.834,1309.566;Inherit;False;Property;_EmissiveColor;Emissive Color;53;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;133;-1503.434,1109.366;Inherit;True;Property;_EmissionMap;Emission Map;52;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;180;-627.6543,619.2548;Inherit;False;Property;_FlowMapFlipGreen;Flow Map Flip Green;41;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;177;-709.0319,429.8401;Inherit;True;Property;_FlowMap;Flow Map;40;0;Create;True;0;0;0;False;0;False;19;cc37af08370d26540b0e6725a8b8879e;cc37af08370d26540b0e6725a8b8879e;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1192.927,330.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;44;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;609;-1214.377,130.6914;Inherit;True;Property;_SpecularMap;Specular Map;42;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-1849.578,2316.963;Inherit;False;Property;_AOStrength;Ambient Occlusion Strength;12;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularMix;Specular Mix;46;0;Create;True;0;0;0;False;0;False;1;0.5;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-676.3562,1073.421;Inherit;False;Property;_RimPower;Rim Hardness;50;0;Create;False;0;0;0;False;0;False;4;2.5;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;524;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;892;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;596;-689.4732,354.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;45;0;Create;False;0;0;0;False;0;False;4;2;0;10;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C5F5C9DBC6FCD78603E10CFCFBDFCF0CA915399F