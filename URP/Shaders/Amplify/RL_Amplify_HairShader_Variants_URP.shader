...
Shader "Reallusion/Amplify/RL_HairShader_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g859( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g858( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g858 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g858 = lerp( break109_g858.g , ( 1.0 - break109_g858.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g858 = (float3(break109_g858.r , lerpResult123_g858 , break109_g858.b));
				float3 NormalTS13_g859 = ( ( appendResult98_g858 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g859 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g859 = float3x3(ase_worldTangent, Binormal5_g859, ase_worldNormal);
				float3x3 TBN13_g859 = TBN1_g859;
				float3 localTangentToWorld13_g859 = TangentToWorld13_g859( NormalTS13_g859 , TBN13_g859 );
				float3 flowTangent107_g858 = localTangentToWorld13_g859;
				...
				float3 tanNormal85_g858 = normal282;
				float3 worldNormal85_g858 = normalize( float3(dot(tanToWorld0,tanNormal85_g858), dot(tanToWorld1,tanNormal85_g858), dot(tanToWorld2,tanNormal85_g858)) );
				float3 worldNormal86_g858 = worldNormal85_g858;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g858 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g862 = normalize( ( flowTangent107_g858 + ( worldNormal86_g858 * lerpResult81_g858 ) ) );
				float3 shiftedTangent119_g858 = normalizeResult10_g862;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g860 = ase_worldViewDir;
				float3 lightDir55_g860 = SafeNormalize(_MainLightPosition.xyz);
				float3 normalizeResult14_g861 = normalize( ( viewDIr52_g860 + lightDir55_g860 ) );
				float dotResult16_g861 = dot( shiftedTangent119_g858 , normalizeResult14_g861 );
				float smoothstepResult22_g861 = smoothstep( -1.0 , 0.0 , dotResult16_g861);
				...
				float temp_output_233_0_g858 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g858 = ( max( ( ( 2.0 / ( temp_output_233_0_g858 * temp_output_233_0_g858 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float temp_output_132_0_g858 = _SpecularMultiplier;
				float4 temp_output_131_0_g858 = _SpecularTint;
				float4 temp_output_13_0_g860 = ( ( smoothstepResult22_g861 * pow( saturate( ( 1.0 - ( dotResult16_g861 * dotResult16_g861 ) ) ) , specularPower237_g858 ) ) * temp_output_132_0_g858 * temp_output_131_0_g858 );
				...
				float4 color10_g857 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 lerpResult18_g857 = lerp( color10_g857 , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g857 = root58;
				float lerpResult23_g857 = lerp( temp_output_27_0_g857 , ( 1.0 - temp_output_27_0_g857 ) , _InvertRootMap);
				float4 lerpResult3_g857 = lerp( _RootColor , _EndColor , lerpResult23_g857);
				float4 lerpResult6_g857 = lerp( lerpResult18_g857 , lerpResult3_g857 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g857 ) * _RootColorStrength ) + ( temp_output_27_0_g857 * _EndColorStrength ) ) ));
				...
				float4 lerpResult18_g863 = lerp( lerpResult6_g857 , _HighlightAColor , saturate( ( localThreePointDistribution8_g863 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g863 ) ) ) ) ));
				...
				float4 temp_output_42_0_g858 = baseColor331;
				float4 temp_output_32_0_g860 = temp_output_42_0_g858;
				float temp_output_172_0_g858 = _SpecularMix;
				float4 lerpResult36_g860 = lerp( temp_output_13_0_g860 , ( temp_output_13_0_g860 * temp_output_32_0_g860 ) , temp_output_172_0_g858);
				float3 temp_output_24_0_g860 = worldNormal86_g858;
				float dotResult15_g860 = dot( lightDir55_g860 , temp_output_24_0_g860 );
				float temp_output_200_0_g858 = _Translucency;
				float temp_output_40_0_g860 = temp_output_200_0_g858;
				float dotResult54_g860 = dot( temp_output_24_0_g860 , viewDIr52_g860 );
				float dotResult57_g860 = dot( viewDIr52_g860 , lightDir55_g860 );
				float temp_output_208_0_g858 = _RimPower;
				float temp_output_207_0_g858 = _RimTransmissionIntensity;
				float3 Color126_g858 = temp_output_42_0_g858.rgb;
				float3 TangentWorld126_g858 = shiftedTangent119_g858;
				float3 ViewDir126_g858 = ase_worldViewDir;
				float3 NormalWorld126_g858 = worldNormal86_g858;
				float3 SpecularColor126_g858 = temp_output_131_0_g858.rgb;
				float SpecularTint126_g858 = temp_output_172_0_g858;
				float SpecularPower126_g858 = specularPower237_g858;
				float SpecularMultiplier126_g858 = temp_output_132_0_g858;
				float3 worldPosition129_g858 = WorldPosition;
				float3 PositionWorld126_g858 = worldPosition129_g858;
				float Translucency126_g858 = temp_output_200_0_g858;
				float RimTransmission126_g858 = temp_output_207_0_g858;
				float RimPower126_g858 = temp_output_208_0_g858;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g858 = RL_Amplify_Expression_HairLighting_Additional126_g858( Color126_g858 , TangentWorld126_g858 , ViewDir126_g858 , NormalWorld126_g858 , SpecularColor126_g858 , SpecularTint126_g858 , SpecularPower126_g858 , SpecularMultiplier126_g858 , PositionWorld126_g858 , Translucency126_g858 , RimTransmission126_g858 , RimPower126_g858 );
				float3 tanNormal53_g858 = worldNormal86_g858;
				float3 bakedGI53_g858 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g858), dot(tanToWorld1,tanNormal53_g858), dot(tanToWorld2,tanNormal53_g858)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g858), dot(tanToWorld1,tanNormal53_g858), dot(tanToWorld2,tanNormal53_g858)), bakedGI53_g858, half4(0,0,0,0));
				float ambientOcclusion570 = ( 1.0 - ( _AOStrength * ( 1.0 - tex2DNode115.g ) ) );
				float temp_output_161_0_g858 = ambientOcclusion570;
				float temp_output_178_0_g858 = _AOOccludeAll;
				float lerpResult180_g858 = lerp( temp_output_161_0_g858 , 1.0 , temp_output_178_0_g858);
				float lerpResult183_g858 = lerp( 1.0 , temp_output_161_0_g858 , temp_output_178_0_g858);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g860 + ( ( saturate( ( ( dotResult15_g860 * ( 1.0 - temp_output_40_0_g860 ) ) + temp_output_40_0_g860 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g860 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g860 ) , 0.0 ) ) , temp_output_208_0_g858 ) * temp_output_207_0_g858 ) ) * temp_output_32_0_g860 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g858 , 0.0 ) ) + ( float4( bakedGI53_g858 , 0.0 ) * temp_output_42_0_g858 * lerpResult180_g858 ) ) * lerpResult183_g858 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1913;6;1920;1023;1422.292;314.7656;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;25;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294116,0.1411763,0.05098026,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;523;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;857;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C4E1B869C9750A7E364F17D91458241792256734