	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 From8_g1148 = _HighlightADistribution;
				float ID8_g1148 = idMap383;
				float Fac8_g1148 = _HighlightAStrength;
				float localThreePointDistribution8_g1148 = ThreePointDistribution( From8_g1148 , ID8_g1148 , Fac8_g1148 );
				float temp_output_24_0_g1148 = root58;
				float lerpResult16_g1148 = lerp( temp_output_24_0_g1148 , ( 1.0 - temp_output_24_0_g1148 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g1148 = lerp( lerpResult6_g1147 , _HighlightAColor , saturate( ( localThreePointDistribution8_g1148 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g1148 ) ) * _HighlightBlend ) ));
				...
				float4 lerpResult18_g1149 = lerp( lerpResult18_g1148 , _HighlightBColor , saturate( ( localThreePointDistribution8_g1149 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g1149 ) ) * _HighlightBlend ) ));
...
/*ASEBEGIN
Version=19001
1913;24;1920;1005;1455.381;98.0701;1;True;False
...
ASEEND*/
//CHKSM=8CD9058B9CFE8AD2374A5E0F17330036842B2B0B