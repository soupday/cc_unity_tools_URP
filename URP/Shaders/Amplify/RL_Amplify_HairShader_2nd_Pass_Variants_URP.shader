...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g790( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g786( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g786 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g786 = lerp( break109_g786.g , ( 1.0 - break109_g786.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g786 = (float3(break109_g786.r , lerpResult123_g786 , break109_g786.b));
				float3 NormalTS13_g790 = ( ( appendResult98_g786 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g790 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g790 = float3x3(ase_worldTangent, Binormal5_g790, ase_worldNormal);
				float3x3 TBN13_g790 = TBN1_g790;
				float3 localTangentToWorld13_g790 = TangentToWorld13_g790( NormalTS13_g790 , TBN13_g790 );
				float3 flowTangent107_g786 = localTangentToWorld13_g790;
				...
				float3 worldNormal85_g786 = float3(dot(tanToWorld0,tanNormal85_g786), dot(tanToWorld1,tanNormal85_g786), dot(tanToWorld2,tanNormal85_g786));
				float3 worldNormal86_g786 = worldNormal85_g786;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g786 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g787 = normalize( ( flowTangent107_g786 + ( worldNormal86_g786 * lerpResult81_g786 ) ) );
				float3 shiftedTangent119_g786 = normalizeResult10_g787;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g788 = ase_worldViewDir;
				float3 lightDir55_g788 = _MainLightPosition.xyz;
				float3 normalizeResult14_g789 = normalize( ( viewDIr52_g788 + lightDir55_g788 ) );
				float dotResult16_g789 = dot( shiftedTangent119_g786 , normalizeResult14_g789 );
				float smoothstepResult22_g789 = smoothstep( -1.0 , 0.0 , dotResult16_g789);
				float temp_output_7_0_g786 = _SpecularPower;
				float temp_output_132_0_g786 = _SpecularMultiplier;
				float4 temp_output_131_0_g786 = _SpecularColor;
				float4 temp_output_13_0_g788 = ( ( smoothstepResult22_g789 * pow( saturate( ( 1.0 - ( dotResult16_g789 * dotResult16_g789 ) ) ) , temp_output_7_0_g786 ) ) * temp_output_132_0_g786 * temp_output_131_0_g786 );
				...
				float4 color10_g701 = IsGammaSpace() ? float4(1,1,1,0) : float4(1,1,1,0);
				float4 lerpResult18_g701 = lerp( color10_g701 , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g701 = root58;
				float lerpResult23_g701 = lerp( temp_output_27_0_g701 , ( 1.0 - temp_output_27_0_g701 ) , _InvertRootMap);
				float4 lerpResult3_g701 = lerp( _RootColor , _EndColor , lerpResult23_g701);
				float4 lerpResult6_g701 = lerp( lerpResult18_g701 , lerpResult3_g701 , ( _GlobalStrength * ( ( ( 1.0 - temp_output_27_0_g701 ) * _RootColorStrength ) + ( temp_output_27_0_g701 * _EndColorStrength ) ) ));
				float3 From8_g703 = _HighlightADistribution;
				float ID8_g703 = idMap383;
				float Fac8_g703 = _HighlightAStrength;
				float localThreePointDistribution8_g703 = ThreePointDistribution( From8_g703 , ID8_g703 , Fac8_g703 );
				float temp_output_24_0_g703 = root58;
				float lerpResult16_g703 = lerp( ( 1.0 - temp_output_24_0_g703 ) , temp_output_24_0_g703 , _HighlightAOverlapInvert);
				float4 lerpResult18_g703 = lerp( lerpResult6_g701 , _HighlightAColor , saturate( ( localThreePointDistribution8_g703 * ( 1.0 - ( _HighlightAOverlapEnd * ( 1.0 - lerpResult16_g703 ) ) ) ) ));
				float3 From8_g702 = _HighlightBDistribution;
				float ID8_g702 = idMap383;
				float Fac8_g702 = _HighlightBStrength;
				float localThreePointDistribution8_g702 = ThreePointDistribution( From8_g702 , ID8_g702 , Fac8_g702 );
				float temp_output_24_0_g702 = root58;
				float lerpResult16_g702 = lerp( ( 1.0 - temp_output_24_0_g702 ) , temp_output_24_0_g702 , _HighlightBOverlapInvert);
				float4 lerpResult18_g702 = lerp( lerpResult18_g703 , _HighlightBColor , saturate( ( localThreePointDistribution8_g702 * ( 1.0 - ( _HighlightBOverlapEnd * ( 1.0 - lerpResult16_g702 ) ) ) ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g702;
				#else
				...
				float4 temp_output_42_0_g786 = baseColor331;
				float4 temp_output_32_0_g788 = temp_output_42_0_g786;
				float temp_output_172_0_g786 = _SpecularTint;
				float4 lerpResult36_g788 = lerp( temp_output_13_0_g788 , ( temp_output_13_0_g788 * temp_output_32_0_g788 ) , temp_output_172_0_g786);
				float3 temp_output_24_0_g788 = worldNormal86_g786;
				float dotResult15_g788 = dot( lightDir55_g788 , temp_output_24_0_g788 );
				float temp_output_200_0_g786 = _Tranlucency;
				float temp_output_40_0_g788 = temp_output_200_0_g786;
				float dotResult54_g788 = dot( temp_output_24_0_g788 , viewDIr52_g788 );
				float dotResult57_g788 = dot( viewDIr52_g788 , lightDir55_g788 );
				float temp_output_208_0_g786 = _RimPower;
				float temp_output_207_0_g786 = _RimTransmission;
				float3 Color126_g786 = temp_output_42_0_g786.rgb;
				float3 TangentWorld126_g786 = shiftedTangent119_g786;
				float3 ViewDir126_g786 = ase_worldViewDir;
				float3 NormalWorld126_g786 = worldNormal86_g786;
				float3 SpecularColor126_g786 = temp_output_131_0_g786.rgb;
				float SpecularTint126_g786 = temp_output_172_0_g786;
				float SpecularPower126_g786 = temp_output_7_0_g786;
				float SpecularMultiplier126_g786 = temp_output_132_0_g786;
				float3 worldPosition129_g786 = WorldPosition;
				float3 PositionWorld126_g786 = worldPosition129_g786;
				float Translucency126_g786 = temp_output_200_0_g786;
				float RimTransmission126_g786 = temp_output_207_0_g786;
				float RimPower126_g786 = temp_output_208_0_g786;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g786 = RL_Amplify_Expression_HairLighting_Additional126_g786( Color126_g786 , TangentWorld126_g786 , ViewDir126_g786 , NormalWorld126_g786 , SpecularColor126_g786 , SpecularTint126_g786 , SpecularPower126_g786 , SpecularMultiplier126_g786 , PositionWorld126_g786 , Translucency126_g786 , RimTransmission126_g786 , RimPower126_g786 );
				float3 tanNormal53_g786 = worldNormal86_g786;
				float3 bakedGI53_g786 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g786), dot(tanToWorld1,tanNormal53_g786), dot(tanToWorld2,tanNormal53_g786)));
				...
				float temp_output_161_0_g786 = ambientOcclusion570;
				float temp_output_178_0_g786 = _AOOccludeAll;
				float lerpResult180_g786 = lerp( temp_output_161_0_g786 , 1.0 , temp_output_178_0_g786);
				float lerpResult183_g786 = lerp( 1.0 , temp_output_161_0_g786 , temp_output_178_0_g786);
...
/*ASEBEGIN
Version=18934
1921;1;1920;1017;931.2826;241.2377;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;524;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;702;6afb608343a58854589726462adfdb8b;0;8;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-676.0562,997.1207;Inherit;False;Property;_RimPower;Rim Power;40;0;Create;True;0;0;0;False;0;False;2;2;0.01;10;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=692498A626ED087C1A7D5120BA420E7F890BA060