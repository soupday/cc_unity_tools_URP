	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult18_g1066 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g1066 = root58;
				float lerpResult23_g1066 = lerp( temp_output_27_0_g1066 , ( 1.0 - temp_output_27_0_g1066 ) , _InvertRootMap);
				float4 lerpResult3_g1066 = lerp( _RootColor , _EndColor , lerpResult23_g1066);
				float lerpResult40_g1066 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g1066);
				float4 lerpResult6_g1066 = lerp( lerpResult18_g1066 , lerpResult3_g1066 , ( lerpResult40_g1066 * _GlobalStrength ));
				...
				float4 lerpResult18_g1068 = lerp( lerpResult6_g1066 , _HighlightAColor , saturate( ( localThreePointDistribution8_g1068 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g1068 ) ) * _HighlightBlend ) ));
...
/*ASEBEGIN
Version=18935
1924;1;1920;1023;1455.381;107.0701;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;643;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;1066;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=822E91988F48236DFBD28C9DF9205CE191FD4F80