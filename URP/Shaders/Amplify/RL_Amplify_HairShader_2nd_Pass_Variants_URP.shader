...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g1049( half3 NormalTS, half3x3 TBN )
			{
			...
			half3 RL_Amplify_Expression_HairLighting_Additional126_g1048( half3 Color, half3 TangentWorld, half3 ViewDir, half3 NormalWorld, half3 SpecularColor, half SpecularTint, half SpecularPower, half SpecularMultiplier, half3 PositionWorld, half Translucency, half RimTransmission, half RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half4 break109_g1048 = tex2D( _FlowMap, uv_FlowMap );
				half lerpResult123_g1048 = lerp( break109_g1048.g , ( 1.0 - break109_g1048.g ) , _FlowMapFlipGreen);
				half3 appendResult98_g1048 = (half3(break109_g1048.r , lerpResult123_g1048 , break109_g1048.b));
				half3 NormalTS13_g1049 = ( ( appendResult98_g1048 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_worldTangent = IN.ase_texcoord4.xyz;
				half3 ase_worldNormal = IN.ase_texcoord5.xyz;
				half3 Binormal5_g1049 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g1049 = float3x3(ase_worldTangent, Binormal5_g1049, ase_worldNormal);
				half3x3 TBN13_g1049 = TBN1_g1049;
				half3 localTangentToWorld13_g1049 = TangentToWorld13_g1049( NormalTS13_g1049 , TBN13_g1049 );
				half3 flowTangent107_g1048 = localTangentToWorld13_g1049;
				...
				float3 tanNormal85_g1048 = normal282;
				half3 worldNormal85_g1048 = normalize( float3(dot(tanToWorld0,tanNormal85_g1048), dot(tanToWorld1,tanNormal85_g1048), dot(tanToWorld2,tanNormal85_g1048)) );
				half3 worldNormal86_g1048 = worldNormal85_g1048;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				half idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				half lerpResult81_g1048 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				half3 normalizeResult10_g1050 = normalize( ( flowTangent107_g1048 + ( worldNormal86_g1048 * lerpResult81_g1048 ) ) );
				half3 shiftedTangent119_g1048 = normalizeResult10_g1050;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				half3 viewDIr52_g1051 = ase_worldViewDir;
				half3 worldLight248_g1048 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g1051 = worldLight248_g1048;
				half3 normalizeResult14_g1052 = normalize( ( viewDIr52_g1051 + lightDir55_g1051 ) );
				half dotResult16_g1052 = dot( shiftedTangent119_g1048 , normalizeResult14_g1052 );
				half smoothstepResult22_g1052 = smoothstep( -1.0 , 0.0 , dotResult16_g1052);
				...
				half temp_output_233_0_g1048 = max( ( 1.0 - smoothness601 ) , 0.001 );
				half specularPower237_g1048 = ( max( ( ( 2.0 / ( temp_output_233_0_g1048 * temp_output_233_0_g1048 ) ) - 2.0 ) , 0.001 ) * _SpecularPower );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				half temp_output_132_0_g1048 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				half4 temp_output_131_0_g1048 = _SpecularTint;
				half4 temp_output_13_0_g1051 = ( ( smoothstepResult22_g1052 * pow( saturate( ( 1.0 - ( dotResult16_g1052 * dotResult16_g1052 ) ) ) , specularPower237_g1048 ) ) * temp_output_132_0_g1048 * temp_output_131_0_g1048 );
				...
				half4 lerpResult18_g1053 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				half root58 = tex2D( _RootMap, uv_RootMap ).r;
				half temp_output_27_0_g1053 = root58;
				half lerpResult23_g1053 = lerp( temp_output_27_0_g1053 , ( 1.0 - temp_output_27_0_g1053 ) , _InvertRootMap);
				half4 lerpResult3_g1053 = lerp( _RootColor , _EndColor , lerpResult23_g1053);
				half lerpResult40_g1053 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g1053);
				half4 lerpResult6_g1053 = lerp( lerpResult18_g1053 , lerpResult3_g1053 , ( lerpResult40_g1053 * _GlobalStrength ));
				half3 From8_g1055 = _HighlightADistribution;
				half ID8_g1055 = idMap383;
				half Fac8_g1055 = _HighlightAStrength;
				half localThreePointDistribution8_g1055 = ThreePointDistribution( From8_g1055 , ID8_g1055 , Fac8_g1055 );
				half temp_output_24_0_g1055 = root58;
				half lerpResult16_g1055 = lerp( temp_output_24_0_g1055 , ( 1.0 - temp_output_24_0_g1055 ) , _HighlightAOverlapInvert);
				half4 lerpResult18_g1055 = lerp( lerpResult6_g1053 , _HighlightAColor , saturate( ( localThreePointDistribution8_g1055 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g1055 ) ) * _HighlightBlend ) ));
				half3 From8_g1054 = _HighlightBDistribution;
				half ID8_g1054 = idMap383;
				half Fac8_g1054 = _HighlightBStrength;
				half localThreePointDistribution8_g1054 = ThreePointDistribution( From8_g1054 , ID8_g1054 , Fac8_g1054 );
				half temp_output_24_0_g1054 = root58;
				half lerpResult16_g1054 = lerp( temp_output_24_0_g1054 , ( 1.0 - temp_output_24_0_g1054 ) , _HighlightBOverlapInvert);
				half4 lerpResult18_g1054 = lerp( lerpResult18_g1055 , _HighlightBColor , saturate( ( localThreePointDistribution8_g1054 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g1054 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				half4 staticSwitch95 = lerpResult18_g1054;
				#else
				...
				half4 temp_output_42_0_g1048 = baseColor331;
				half4 temp_output_32_0_g1051 = temp_output_42_0_g1048;
				half temp_output_172_0_g1048 = _SpecularMix;
				half4 lerpResult36_g1051 = lerp( temp_output_13_0_g1051 , ( temp_output_13_0_g1051 * temp_output_32_0_g1051 ) , temp_output_172_0_g1048);
				half3 temp_output_24_0_g1051 = worldNormal86_g1048;
				half dotResult15_g1051 = dot( lightDir55_g1051 , temp_output_24_0_g1051 );
				half temp_output_200_0_g1048 = _Translucency;
				half temp_output_40_0_g1051 = temp_output_200_0_g1048;
				half dotResult54_g1051 = dot( temp_output_24_0_g1051 , viewDIr52_g1051 );
				half dotResult57_g1051 = dot( viewDIr52_g1051 , lightDir55_g1051 );
				half temp_output_208_0_g1048 = _RimPower;
				half temp_output_207_0_g1048 = _RimTransmissionIntensity;
				half3 Color126_g1048 = temp_output_42_0_g1048.rgb;
				half3 TangentWorld126_g1048 = shiftedTangent119_g1048;
				half3 ViewDir126_g1048 = ase_worldViewDir;
				half3 NormalWorld126_g1048 = worldNormal86_g1048;
				half3 SpecularColor126_g1048 = temp_output_131_0_g1048.rgb;
				half SpecularTint126_g1048 = temp_output_172_0_g1048;
				half SpecularPower126_g1048 = specularPower237_g1048;
				half SpecularMultiplier126_g1048 = temp_output_132_0_g1048;
				half3 worldPosition129_g1048 = WorldPosition;
				half3 PositionWorld126_g1048 = worldPosition129_g1048;
				half Translucency126_g1048 = temp_output_200_0_g1048;
				half RimTransmission126_g1048 = temp_output_207_0_g1048;
				half RimPower126_g1048 = temp_output_208_0_g1048;
				half3 localRL_Amplify_Expression_HairLighting_Additional126_g1048 = RL_Amplify_Expression_HairLighting_Additional126_g1048( Color126_g1048 , TangentWorld126_g1048 , ViewDir126_g1048 , NormalWorld126_g1048 , SpecularColor126_g1048 , SpecularTint126_g1048 , SpecularPower126_g1048 , SpecularMultiplier126_g1048 , PositionWorld126_g1048 , Translucency126_g1048 , RimTransmission126_g1048 , RimPower126_g1048 );
				half lerpResult644 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				half ambientOcclusion570 = lerpResult644;
				half temp_output_161_0_g1048 = ambientOcclusion570;
				half lerpResult280_g1048 = lerp( 1.0 , temp_output_161_0_g1048 , _AOOccludeAll);
				float3 tanNormal53_g1048 = worldNormal86_g1048;
				half3 bakedGI53_g1048 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g1048), dot(tanToWorld1,tanNormal53_g1048), dot(tanToWorld2,tanNormal53_g1048)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g1048), dot(tanToWorld1,tanNormal53_g1048), dot(tanToWorld2,tanNormal53_g1048)), bakedGI53_g1048, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g1051 + ( ( saturate( ( ( dotResult15_g1051 * ( 1.0 - temp_output_40_0_g1051 ) ) + temp_output_40_0_g1051 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1051 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1051 ) , 0.0 ) ) , temp_output_208_0_g1048 ) * temp_output_207_0_g1048 ) ) * temp_output_32_0_g1051 ) ) * _MainLightColor ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g1048 , 0.0 ) ) * lerpResult280_g1048 ) + ( half4( bakedGI53_g1048 , 0.0 ) * temp_output_42_0_g1048 * temp_output_161_0_g1048 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;3019.211;825.4268;2.240252;True;False
...
Node;AmplifyShaderEditor.FunctionNode;639;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;1054;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;640;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;1055;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-675.7505,1002.806;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;44;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;643;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;1053;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
WireConnection;648;42;572;0
WireConnection;648;161;571;0
WireConnection;648;178;108;0
WireConnection;648;84;569;0
WireConnection;648;131;378;0
WireConnection;648;7;602;0
WireConnection;648;172;482;0
WireConnection;648;132;632;0
WireConnection;648;245;609;0
WireConnection;648;108;177;0
WireConnection;648;112;180;0
WireConnection;648;71;384;0
WireConnection;648;75;385;0
WireConnection;648;80;389;0
WireConnection;648;200;539;0
WireConnection;648;207;265;0
WireConnection;648;208;263;0
WireConnection;297;2;574;0
WireConnection;297;3;521;0
WireConnection;297;4;578;0
ASEEND*/
//CHKSM=E54C056E8ECE1A8DC6A8274B435C9731BFF4D8C1