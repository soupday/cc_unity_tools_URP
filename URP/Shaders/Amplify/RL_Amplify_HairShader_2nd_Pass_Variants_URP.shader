...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g1153( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g1150( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g1150 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g1150 = lerp( break109_g1150.g , ( 1.0 - break109_g1150.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g1150 = (float3(break109_g1150.r , lerpResult123_g1150 , break109_g1150.b));
				float3 NormalTS13_g1153 = ( ( appendResult98_g1150 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g1153 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g1153 = float3x3(ase_worldTangent, Binormal5_g1153, ase_worldNormal);
				float3x3 TBN13_g1153 = TBN1_g1153;
				float3 localTangentToWorld13_g1153 = TangentToWorld13_g1153( NormalTS13_g1153 , TBN13_g1153 );
				float3 flowTangent107_g1150 = localTangentToWorld13_g1153;
				...
				float3 worldNormal85_g1150 = normalize( float3(dot(tanToWorld0,tanNormal85_g1150), dot(tanToWorld1,tanNormal85_g1150), dot(tanToWorld2,tanNormal85_g1150)) );
				float3 worldNormal86_g1150 = worldNormal85_g1150;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g1150 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g1154 = normalize( ( flowTangent107_g1150 + ( worldNormal86_g1150 * lerpResult81_g1150 ) ) );
				float3 shiftedTangent119_g1150 = normalizeResult10_g1154;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g1151 = ase_worldViewDir;
				float3 worldLight248_g1150 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g1151 = worldLight248_g1150;
				float3 normalizeResult14_g1152 = normalize( ( viewDIr52_g1151 + lightDir55_g1151 ) );
				float dotResult16_g1152 = dot( shiftedTangent119_g1150 , normalizeResult14_g1152 );
				float smoothstepResult22_g1152 = smoothstep( -1.0 , 0.0 , dotResult16_g1152);
				...
				float temp_output_233_0_g1150 = max( ( 1.0 - smoothness601 ) , 0.001 );
				float specularPower237_g1150 = ( max( ( ( 2.0 / ( temp_output_233_0_g1150 * temp_output_233_0_g1150 ) ) - 2.0 ) , 0.001 ) * _SpecularPower );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g1150 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g1150 = _SpecularTint;
				float4 temp_output_13_0_g1151 = ( ( smoothstepResult22_g1152 * pow( saturate( ( 1.0 - ( dotResult16_g1152 * dotResult16_g1152 ) ) ) , specularPower237_g1150 ) ) * temp_output_132_0_g1150 * temp_output_131_0_g1150 );
				...
				float4 temp_output_42_0_g1150 = baseColor331;
				float4 temp_output_32_0_g1151 = temp_output_42_0_g1150;
				float temp_output_172_0_g1150 = _SpecularMix;
				float4 lerpResult36_g1151 = lerp( temp_output_13_0_g1151 , ( temp_output_13_0_g1151 * temp_output_32_0_g1151 ) , temp_output_172_0_g1150);
				float3 temp_output_24_0_g1151 = worldNormal86_g1150;
				float dotResult15_g1151 = dot( lightDir55_g1151 , temp_output_24_0_g1151 );
				float temp_output_200_0_g1150 = _Translucency;
				float temp_output_40_0_g1151 = temp_output_200_0_g1150;
				float dotResult54_g1151 = dot( temp_output_24_0_g1151 , viewDIr52_g1151 );
				float dotResult57_g1151 = dot( viewDIr52_g1151 , lightDir55_g1151 );
				float temp_output_208_0_g1150 = _RimPower;
				float temp_output_207_0_g1150 = _RimTransmissionIntensity;
				float3 Color126_g1150 = temp_output_42_0_g1150.rgb;
				float3 TangentWorld126_g1150 = shiftedTangent119_g1150;
				float3 ViewDir126_g1150 = ase_worldViewDir;
				float3 NormalWorld126_g1150 = worldNormal86_g1150;
				float3 SpecularColor126_g1150 = temp_output_131_0_g1150.rgb;
				float SpecularTint126_g1150 = temp_output_172_0_g1150;
				float SpecularPower126_g1150 = specularPower237_g1150;
				float SpecularMultiplier126_g1150 = temp_output_132_0_g1150;
				float3 worldPosition129_g1150 = WorldPosition;
				float3 PositionWorld126_g1150 = worldPosition129_g1150;
				float Translucency126_g1150 = temp_output_200_0_g1150;
				float RimTransmission126_g1150 = temp_output_207_0_g1150;
				float RimPower126_g1150 = temp_output_208_0_g1150;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g1150 = RL_Amplify_Expression_HairLighting_Additional126_g1150( Color126_g1150 , TangentWorld126_g1150 , ViewDir126_g1150 , NormalWorld126_g1150 , SpecularColor126_g1150 , SpecularTint126_g1150 , SpecularPower126_g1150 , SpecularMultiplier126_g1150 , PositionWorld126_g1150 , Translucency126_g1150 , RimTransmission126_g1150 , RimPower126_g1150 );
				float lerpResult644 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult644;
				float temp_output_161_0_g1150 = ambientOcclusion570;
				float lerpResult280_g1150 = lerp( 1.0 , temp_output_161_0_g1150 , _AOOccludeAll);
				float3 bakedGI53_g1150 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g1150);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g1151 + ( ( saturate( ( ( dotResult15_g1151 * ( 1.0 - temp_output_40_0_g1151 ) ) + temp_output_40_0_g1151 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1151 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1151 ) , 0.0 ) ) , temp_output_208_0_g1150 ) * temp_output_207_0_g1150 ) ) * temp_output_32_0_g1151 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g1150 , 0.0 ) ) * lerpResult280_g1150 ) + ( float4( bakedGI53_g1150 , 0.0 ) * temp_output_42_0_g1150 * temp_output_161_0_g1150 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
ASEEND*/
//CHKSM=05CB95627584B8A903DACDDFEC337CD0DDB9F560