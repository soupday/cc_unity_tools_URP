...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g1145( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g1142( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g1142 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g1142 = lerp( break109_g1142.g , ( 1.0 - break109_g1142.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g1142 = (float3(break109_g1142.r , lerpResult123_g1142 , break109_g1142.b));
				float3 NormalTS13_g1145 = ( ( appendResult98_g1142 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g1145 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g1145 = float3x3(ase_worldTangent, Binormal5_g1145, ase_worldNormal);
				float3x3 TBN13_g1145 = TBN1_g1145;
				float3 localTangentToWorld13_g1145 = TangentToWorld13_g1145( NormalTS13_g1145 , TBN13_g1145 );
				float3 flowTangent107_g1142 = localTangentToWorld13_g1145;
				...
				float3 tanNormal85_g1142 = normal282;
				float3 worldNormal85_g1142 = normalize( float3(dot(tanToWorld0,tanNormal85_g1142), dot(tanToWorld1,tanNormal85_g1142), dot(tanToWorld2,tanNormal85_g1142)) );
				float3 worldNormal86_g1142 = worldNormal85_g1142;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g1142 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g1146 = normalize( ( flowTangent107_g1142 + ( worldNormal86_g1142 * lerpResult81_g1142 ) ) );
				float3 shiftedTangent119_g1142 = normalizeResult10_g1146;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g1143 = ase_worldViewDir;
				float3 worldLight248_g1142 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g1143 = worldLight248_g1142;
				float3 normalizeResult14_g1144 = normalize( ( viewDIr52_g1143 + lightDir55_g1143 ) );
				float dotResult16_g1144 = dot( shiftedTangent119_g1142 , normalizeResult14_g1144 );
				float smoothstepResult22_g1144 = smoothstep( -1.0 , 0.0 , dotResult16_g1144);
				...
				float temp_output_233_0_g1142 = max( ( 1.0 - smoothness601 ) , 0.001 );
				float specularPower237_g1142 = ( max( ( ( 2.0 / ( temp_output_233_0_g1142 * temp_output_233_0_g1142 ) ) - 2.0 ) , 0.001 ) * _SpecularPower );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g1142 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g1142 = _SpecularTint;
				float4 temp_output_13_0_g1143 = ( ( smoothstepResult22_g1144 * pow( saturate( ( 1.0 - ( dotResult16_g1144 * dotResult16_g1144 ) ) ) , specularPower237_g1142 ) ) * temp_output_132_0_g1142 * temp_output_131_0_g1142 );
				...
				float4 lerpResult18_g1069 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g1069 = root58;
				float lerpResult23_g1069 = lerp( temp_output_27_0_g1069 , ( 1.0 - temp_output_27_0_g1069 ) , _InvertRootMap);
				float4 lerpResult3_g1069 = lerp( _RootColor , _EndColor , lerpResult23_g1069);
				float lerpResult40_g1069 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g1069);
				float4 lerpResult6_g1069 = lerp( lerpResult18_g1069 , lerpResult3_g1069 , ( lerpResult40_g1069 * _GlobalStrength ));
				float3 From8_g1068 = _HighlightADistribution;
				float ID8_g1068 = idMap383;
				float Fac8_g1068 = _HighlightAStrength;
				float localThreePointDistribution8_g1068 = ThreePointDistribution( From8_g1068 , ID8_g1068 , Fac8_g1068 );
				float temp_output_24_0_g1068 = root58;
				float lerpResult16_g1068 = lerp( temp_output_24_0_g1068 , ( 1.0 - temp_output_24_0_g1068 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g1068 = lerp( lerpResult6_g1069 , _HighlightAColor , saturate( ( localThreePointDistribution8_g1068 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g1068 ) ) * _HighlightBlend ) ));
				float3 From8_g1067 = _HighlightBDistribution;
				float ID8_g1067 = idMap383;
				float Fac8_g1067 = _HighlightBStrength;
				float localThreePointDistribution8_g1067 = ThreePointDistribution( From8_g1067 , ID8_g1067 , Fac8_g1067 );
				float temp_output_24_0_g1067 = root58;
				float lerpResult16_g1067 = lerp( temp_output_24_0_g1067 , ( 1.0 - temp_output_24_0_g1067 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g1067 = lerp( lerpResult18_g1068 , _HighlightBColor , saturate( ( localThreePointDistribution8_g1067 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g1067 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g1067;
				#else
				...
				float4 temp_output_42_0_g1142 = baseColor331;
				float4 temp_output_32_0_g1143 = temp_output_42_0_g1142;
				float temp_output_172_0_g1142 = _SpecularMix;
				float4 lerpResult36_g1143 = lerp( temp_output_13_0_g1143 , ( temp_output_13_0_g1143 * temp_output_32_0_g1143 ) , temp_output_172_0_g1142);
				float3 temp_output_24_0_g1143 = worldNormal86_g1142;
				float dotResult15_g1143 = dot( lightDir55_g1143 , temp_output_24_0_g1143 );
				float temp_output_200_0_g1142 = _Translucency;
				float temp_output_40_0_g1143 = temp_output_200_0_g1142;
				float dotResult54_g1143 = dot( temp_output_24_0_g1143 , viewDIr52_g1143 );
				float dotResult57_g1143 = dot( viewDIr52_g1143 , lightDir55_g1143 );
				float temp_output_208_0_g1142 = _RimPower;
				float temp_output_207_0_g1142 = _RimTransmissionIntensity;
				float3 Color126_g1142 = temp_output_42_0_g1142.rgb;
				float3 TangentWorld126_g1142 = shiftedTangent119_g1142;
				float3 ViewDir126_g1142 = ase_worldViewDir;
				float3 NormalWorld126_g1142 = worldNormal86_g1142;
				float3 SpecularColor126_g1142 = temp_output_131_0_g1142.rgb;
				float SpecularTint126_g1142 = temp_output_172_0_g1142;
				float SpecularPower126_g1142 = specularPower237_g1142;
				float SpecularMultiplier126_g1142 = temp_output_132_0_g1142;
				float3 worldPosition129_g1142 = WorldPosition;
				float3 PositionWorld126_g1142 = worldPosition129_g1142;
				float Translucency126_g1142 = temp_output_200_0_g1142;
				float RimTransmission126_g1142 = temp_output_207_0_g1142;
				float RimPower126_g1142 = temp_output_208_0_g1142;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g1142 = RL_Amplify_Expression_HairLighting_Additional126_g1142( Color126_g1142 , TangentWorld126_g1142 , ViewDir126_g1142 , NormalWorld126_g1142 , SpecularColor126_g1142 , SpecularTint126_g1142 , SpecularPower126_g1142 , SpecularMultiplier126_g1142 , PositionWorld126_g1142 , Translucency126_g1142 , RimTransmission126_g1142 , RimPower126_g1142 );
				float lerpResult644 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult644;
				float temp_output_161_0_g1142 = ambientOcclusion570;
				float lerpResult280_g1142 = lerp( 1.0 , temp_output_161_0_g1142 , _AOOccludeAll);
				float3 bakedGI53_g1142 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g1142);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g1142, bakedGI53_g1142, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g1143 + ( ( saturate( ( ( dotResult15_g1143 * ( 1.0 - temp_output_40_0_g1143 ) ) + temp_output_40_0_g1143 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1143 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1143 ) , 0.0 ) ) , temp_output_208_0_g1142 ) * temp_output_207_0_g1142 ) ) * temp_output_32_0_g1143 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g1142 , 0.0 ) ) * lerpResult280_g1142 ) + ( float4( bakedGI53_g1142 , 0.0 ) * temp_output_42_0_g1142 * temp_output_161_0_g1142 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=19001
1913;36;1920;993;1455.381;92.0701;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;640;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;1068;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;639;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;1067;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;917.0538,1167.637;Half;False;True;-1;2;ASEMaterialInspector;0;12;Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;2;False;;True;1;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637787991825921621;  Blend;0;0;Two Sided;0;637788651120112867;Cast Shadows;0;637788651025808361;  Use Shadow Threshold;0;637787998365867513;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637788650928858011;DOTS Instancing;0;0;Meta Pass;1;637793397155228723;Extra Pre Pass;0;637788651331004462;Tessellation;0;637997944492495216;  Phong;1;637788078609197688;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;5;False;True;False;True;True;False;;False;0
...
ASEEND*/
//CHKSM=210D3623731201C3E9E5F6D0F24BAA9E975BA7B3