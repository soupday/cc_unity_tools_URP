...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP12"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g1154( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g1151( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g1151 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g1151 = lerp( break109_g1151.g , ( 1.0 - break109_g1151.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g1151 = (float3(break109_g1151.r , lerpResult123_g1151 , break109_g1151.b));
				float3 NormalTS13_g1154 = ( ( appendResult98_g1151 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g1154 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g1154 = float3x3(ase_worldTangent, Binormal5_g1154, ase_worldNormal);
				float3x3 TBN13_g1154 = TBN1_g1154;
				float3 localTangentToWorld13_g1154 = TangentToWorld13_g1154( NormalTS13_g1154 , TBN13_g1154 );
				float3 flowTangent107_g1151 = localTangentToWorld13_g1154;
				...
				float3 tanNormal85_g1151 = normal282;
				float3 worldNormal85_g1151 = normalize( float3(dot(tanToWorld0,tanNormal85_g1151), dot(tanToWorld1,tanNormal85_g1151), dot(tanToWorld2,tanNormal85_g1151)) );
				float3 worldNormal86_g1151 = worldNormal85_g1151;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g1151 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g1155 = normalize( ( flowTangent107_g1151 + ( worldNormal86_g1151 * lerpResult81_g1151 ) ) );
				float3 shiftedTangent119_g1151 = normalizeResult10_g1155;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g1152 = ase_worldViewDir;
				float3 worldLight248_g1151 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g1152 = worldLight248_g1151;
				float3 normalizeResult14_g1153 = normalize( ( viewDIr52_g1152 + lightDir55_g1152 ) );
				float dotResult16_g1153 = dot( shiftedTangent119_g1151 , normalizeResult14_g1153 );
				float smoothstepResult22_g1153 = smoothstep( -1.0 , 0.0 , dotResult16_g1153);
				...
				float temp_output_233_0_g1151 = max( ( 1.0 - smoothness601 ) , 0.001 );
				float specularPower237_g1151 = ( max( ( ( 2.0 / ( temp_output_233_0_g1151 * temp_output_233_0_g1151 ) ) - 2.0 ) , 0.001 ) * _SpecularPower );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g1151 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g1151 = _SpecularTint;
				float4 temp_output_13_0_g1152 = ( ( smoothstepResult22_g1153 * pow( saturate( ( 1.0 - ( dotResult16_g1153 * dotResult16_g1153 ) ) ) , specularPower237_g1151 ) ) * temp_output_132_0_g1151 * temp_output_131_0_g1151 );
				...
				float4 lerpResult18_g1147 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g1147 = root58;
				float lerpResult23_g1147 = lerp( temp_output_27_0_g1147 , ( 1.0 - temp_output_27_0_g1147 ) , _InvertRootMap);
				float4 lerpResult3_g1147 = lerp( _RootColor , _EndColor , lerpResult23_g1147);
				float lerpResult40_g1147 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g1147);
				float4 lerpResult6_g1147 = lerp( lerpResult18_g1147 , lerpResult3_g1147 , ( lerpResult40_g1147 * _GlobalStrength ));
				float3 From8_g1150 = _HighlightADistribution;
				float ID8_g1150 = idMap383;
				float Fac8_g1150 = _HighlightAStrength;
				float localThreePointDistribution8_g1150 = ThreePointDistribution( From8_g1150 , ID8_g1150 , Fac8_g1150 );
				float temp_output_24_0_g1150 = root58;
				float lerpResult16_g1150 = lerp( temp_output_24_0_g1150 , ( 1.0 - temp_output_24_0_g1150 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g1150 = lerp( lerpResult6_g1147 , _HighlightAColor , saturate( ( localThreePointDistribution8_g1150 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g1150 ) ) * _HighlightBlend ) ));
				float3 From8_g1149 = _HighlightBDistribution;
				float ID8_g1149 = idMap383;
				float Fac8_g1149 = _HighlightBStrength;
				float localThreePointDistribution8_g1149 = ThreePointDistribution( From8_g1149 , ID8_g1149 , Fac8_g1149 );
				float temp_output_24_0_g1149 = root58;
				float lerpResult16_g1149 = lerp( temp_output_24_0_g1149 , ( 1.0 - temp_output_24_0_g1149 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g1149 = lerp( lerpResult18_g1150 , _HighlightBColor , saturate( ( localThreePointDistribution8_g1149 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g1149 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g1149;
				#else
				...
				float4 temp_output_42_0_g1151 = baseColor331;
				float4 temp_output_32_0_g1152 = temp_output_42_0_g1151;
				float temp_output_172_0_g1151 = _SpecularMix;
				float4 lerpResult36_g1152 = lerp( temp_output_13_0_g1152 , ( temp_output_13_0_g1152 * temp_output_32_0_g1152 ) , temp_output_172_0_g1151);
				float3 temp_output_24_0_g1152 = worldNormal86_g1151;
				float dotResult15_g1152 = dot( lightDir55_g1152 , temp_output_24_0_g1152 );
				float temp_output_200_0_g1151 = _Translucency;
				float temp_output_40_0_g1152 = temp_output_200_0_g1151;
				float dotResult54_g1152 = dot( temp_output_24_0_g1152 , viewDIr52_g1152 );
				float dotResult57_g1152 = dot( viewDIr52_g1152 , lightDir55_g1152 );
				float temp_output_208_0_g1151 = _RimPower;
				float temp_output_207_0_g1151 = _RimTransmissionIntensity;
				float3 Color126_g1151 = temp_output_42_0_g1151.rgb;
				float3 TangentWorld126_g1151 = shiftedTangent119_g1151;
				float3 ViewDir126_g1151 = ase_worldViewDir;
				float3 NormalWorld126_g1151 = worldNormal86_g1151;
				float3 SpecularColor126_g1151 = temp_output_131_0_g1151.rgb;
				float SpecularTint126_g1151 = temp_output_172_0_g1151;
				float SpecularPower126_g1151 = specularPower237_g1151;
				float SpecularMultiplier126_g1151 = temp_output_132_0_g1151;
				float3 worldPosition129_g1151 = WorldPosition;
				float3 PositionWorld126_g1151 = worldPosition129_g1151;
				float Translucency126_g1151 = temp_output_200_0_g1151;
				float RimTransmission126_g1151 = temp_output_207_0_g1151;
				float RimPower126_g1151 = temp_output_208_0_g1151;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g1151 = RL_Amplify_Expression_HairLighting_Additional126_g1151( Color126_g1151 , TangentWorld126_g1151 , ViewDir126_g1151 , NormalWorld126_g1151 , SpecularColor126_g1151 , SpecularTint126_g1151 , SpecularPower126_g1151 , SpecularMultiplier126_g1151 , PositionWorld126_g1151 , Translucency126_g1151 , RimTransmission126_g1151 , RimPower126_g1151 );
				float lerpResult644 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult644;
				float temp_output_161_0_g1151 = ambientOcclusion570;
				float lerpResult280_g1151 = lerp( 1.0 , temp_output_161_0_g1151 , _AOOccludeAll);
				float3 bakedGI53_g1151 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g1151);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g1151, bakedGI53_g1151, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g1152 + ( ( saturate( ( ( dotResult15_g1152 * ( 1.0 - temp_output_40_0_g1152 ) ) + temp_output_40_0_g1152 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1152 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1152 ) , 0.0 ) ) , temp_output_208_0_g1151 ) * temp_output_207_0_g1151 ) ) * temp_output_32_0_g1152 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g1151 , 0.0 ) ) * lerpResult280_g1151 ) + ( float4( bakedGI53_g1151 , 0.0 ) * temp_output_42_0_g1151 * temp_output_161_0_g1151 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=19001
1913;65;1920;963;1455.381;77.0701;1;True;False
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;917.0538,1167.637;Half;False;True;-1;2;ASEMaterialInspector;0;12;Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP12;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;2;False;;True;1;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;1;637787991825921621;  Blend;0;0;Two Sided;0;637788651120112867;Forward Only;0;0;Cast Shadows;0;637788651025808361;  Use Shadow Threshold;0;637787998365867513;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637788650928858011;DOTS Instancing;0;0;Meta Pass;1;637793397155228723;Extra Pre Pass;0;637788651331004462;Tessellation;0;637997944492495216;  Phong;1;637788078609197688;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=9F31E13DE55EB14C1355BA238BC2C43F87CFCC42