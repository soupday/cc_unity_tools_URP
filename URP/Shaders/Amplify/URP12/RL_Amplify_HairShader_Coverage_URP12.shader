...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_URP12"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g985( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g982( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g982 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g982 = lerp( break109_g982.g , ( 1.0 - break109_g982.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g982 = (float3(break109_g982.r , lerpResult123_g982 , break109_g982.b));
				float3 NormalTS13_g985 = ( ( appendResult98_g982 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g985 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g985 = float3x3(ase_worldTangent, Binormal5_g985, ase_worldNormal);
				float3x3 TBN13_g985 = TBN1_g985;
				float3 localTangentToWorld13_g985 = TangentToWorld13_g985( NormalTS13_g985 , TBN13_g985 );
				float3 flowTangent107_g982 = localTangentToWorld13_g985;
				...
				float3 tanNormal85_g982 = normal282;
				float3 worldNormal85_g982 = normalize( float3(dot(tanToWorld0,tanNormal85_g982), dot(tanToWorld1,tanNormal85_g982), dot(tanToWorld2,tanNormal85_g982)) );
				float3 worldNormal86_g982 = worldNormal85_g982;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g982 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g986 = normalize( ( flowTangent107_g982 + ( worldNormal86_g982 * lerpResult81_g982 ) ) );
				float3 shiftedTangent119_g982 = normalizeResult10_g986;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g983 = ase_worldViewDir;
				float3 worldLight248_g982 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g983 = worldLight248_g982;
				float3 normalizeResult14_g984 = normalize( ( viewDIr52_g983 + lightDir55_g983 ) );
				float dotResult16_g984 = dot( shiftedTangent119_g982 , normalizeResult14_g984 );
				float smoothstepResult22_g984 = smoothstep( -1.0 , 0.0 , dotResult16_g984);
				...
				float temp_output_233_0_g982 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g982 = ( max( ( ( 2.0 / ( temp_output_233_0_g982 * temp_output_233_0_g982 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g982 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g982 = _SpecularTint;
				float4 temp_output_13_0_g983 = ( ( smoothstepResult22_g984 * pow( saturate( ( 1.0 - ( dotResult16_g984 * dotResult16_g984 ) ) ) , specularPower237_g982 ) ) * temp_output_132_0_g982 * temp_output_131_0_g982 );
				...
				float lerpResult16_g981 = lerp( temp_output_24_0_g981 , ( 1.0 - temp_output_24_0_g981 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g981 = lerp( lerpResult6_g987 , _HighlightAColor , saturate( ( localThreePointDistribution8_g981 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g981 ) ) * _HighlightBlend ) ));
				...
				float4 lerpResult18_g980 = lerp( lerpResult18_g981 , _HighlightBColor , saturate( ( localThreePointDistribution8_g980 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g980 ) ) * _HighlightBlend ) ));
				...
				float4 temp_output_42_0_g982 = baseColor331;
				float4 temp_output_32_0_g983 = temp_output_42_0_g982;
				float temp_output_172_0_g982 = _SpecularMix;
				float4 lerpResult36_g983 = lerp( temp_output_13_0_g983 , ( temp_output_13_0_g983 * temp_output_32_0_g983 ) , temp_output_172_0_g982);
				float3 temp_output_24_0_g983 = worldNormal86_g982;
				float dotResult15_g983 = dot( lightDir55_g983 , temp_output_24_0_g983 );
				float temp_output_200_0_g982 = _Translucency;
				float temp_output_40_0_g983 = temp_output_200_0_g982;
				float dotResult54_g983 = dot( temp_output_24_0_g983 , viewDIr52_g983 );
				float dotResult57_g983 = dot( viewDIr52_g983 , lightDir55_g983 );
				float temp_output_208_0_g982 = _RimPower;
				float temp_output_207_0_g982 = _RimTransmissionIntensity;
				float3 Color126_g982 = temp_output_42_0_g982.rgb;
				float3 TangentWorld126_g982 = shiftedTangent119_g982;
				float3 ViewDir126_g982 = ase_worldViewDir;
				float3 NormalWorld126_g982 = worldNormal86_g982;
				float3 SpecularColor126_g982 = temp_output_131_0_g982.rgb;
				float SpecularTint126_g982 = temp_output_172_0_g982;
				float SpecularPower126_g982 = specularPower237_g982;
				float SpecularMultiplier126_g982 = temp_output_132_0_g982;
				float3 worldPosition129_g982 = WorldPosition;
				float3 PositionWorld126_g982 = worldPosition129_g982;
				float Translucency126_g982 = temp_output_200_0_g982;
				float RimTransmission126_g982 = temp_output_207_0_g982;
				float RimPower126_g982 = temp_output_208_0_g982;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g982 = RL_Amplify_Expression_HairLighting_Additional126_g982( Color126_g982 , TangentWorld126_g982 , ViewDir126_g982 , NormalWorld126_g982 , SpecularColor126_g982 , SpecularTint126_g982 , SpecularPower126_g982 , SpecularMultiplier126_g982 , PositionWorld126_g982 , Translucency126_g982 , RimTransmission126_g982 , RimPower126_g982 );
				float lerpResult632 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult632;
				float temp_output_161_0_g982 = ambientOcclusion570;
				float lerpResult280_g982 = lerp( 1.0 , temp_output_161_0_g982 , _AOOccludeAll);
				float3 bakedGI53_g982 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g982);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g982, bakedGI53_g982, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g983 + ( ( saturate( ( ( dotResult15_g983 * ( 1.0 - temp_output_40_0_g983 ) ) + temp_output_40_0_g983 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g983 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g983 ) , 0.0 ) ) , temp_output_208_0_g982 ) * temp_output_207_0_g982 ) ) * temp_output_32_0_g983 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g982 , 0.0 ) ) * lerpResult280_g982 ) + ( float4( bakedGI53_g982 , 0.0 ) * temp_output_42_0_g982 * temp_output_161_0_g982 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=19001
1913;65;1920;963;1874.827;-685.8317;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;628;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;981;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;978.6932,1167.645;Float;False;True;-1;2;ASEMaterialInspector;0;12;Reallusion/Amplify/RL_HairShader_Coverage_URP12;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992251365997;DOTS Instancing;0;0;Meta Pass;1;637793397279481765;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=C7460DFA0B2939706F3AB18D3CDEBE56ABF01BF2