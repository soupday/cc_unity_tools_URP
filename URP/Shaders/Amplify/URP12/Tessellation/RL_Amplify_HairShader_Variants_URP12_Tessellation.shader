...
Shader "Reallusion/Amplify/RL_HairShader_Variants_URP12_Tessellation"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult18_g985 = lerp( lerpResult18_g984 , _HighlightBColor , saturate( ( localThreePointDistribution8_g985 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g985 ) ) * _HighlightBlend ) ));
...
/*ASEBEGIN
Version=19001
1913;77;1920;951;1824.145;-479.5041;1;True;False
...
ASEEND*/
//CHKSM=56F695DB2261015EECC1819044F0D8F494FDBEDC