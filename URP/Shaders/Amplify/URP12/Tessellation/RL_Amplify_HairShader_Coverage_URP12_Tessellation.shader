...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_URP12_Tessellation"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g984( float3 NormalTS, float3x3 TBN )
			{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g981 = tex2D( _FlowMap, uv_FlowMap );
				...
				float3 NormalTS13_g984 = ( ( appendResult98_g981 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g984 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g984 = float3x3(ase_worldTangent, Binormal5_g984, ase_worldNormal);
				float3x3 TBN13_g984 = TBN1_g984;
				float3 localTangentToWorld13_g984 = TangentToWorld13_g984( NormalTS13_g984 , TBN13_g984 );
				float3 flowTangent107_g981 = localTangentToWorld13_g984;
				...
				float3 normalizeResult10_g985 = normalize( ( flowTangent107_g981 + ( worldNormal86_g981 * lerpResult81_g981 ) ) );
				float3 shiftedTangent119_g981 = normalizeResult10_g985;
				...
				float3 lightDir55_g982 = worldLight248_g981;
				float3 normalizeResult14_g983 = normalize( ( viewDIr52_g982 + lightDir55_g982 ) );
				float dotResult16_g983 = dot( shiftedTangent119_g981 , normalizeResult14_g983 );
				...
				float temp_output_132_0_g981 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g981 = _SpecularTint;
				float4 temp_output_13_0_g982 = ( ( smoothstepResult22_g983 * pow( saturate( ( 1.0 - ( dotResult16_g983 * dotResult16_g983 ) ) ) , specularPower237_g981 ) ) * temp_output_132_0_g981 * temp_output_131_0_g981 );
				...
				float3 From8_g988 = _HighlightADistribution;
				float ID8_g988 = idMap383;
				float Fac8_g988 = _HighlightAStrength;
				float localThreePointDistribution8_g988 = ThreePointDistribution( From8_g988 , ID8_g988 , Fac8_g988 );
				float temp_output_24_0_g988 = root58;
				float lerpResult16_g988 = lerp( temp_output_24_0_g988 , ( 1.0 - temp_output_24_0_g988 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g988 = lerp( lerpResult6_g987 , _HighlightAColor , saturate( ( localThreePointDistribution8_g988 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g988 ) ) * _HighlightBlend ) ));
				...
				float4 lerpResult18_g989 = lerp( lerpResult18_g988 , _HighlightBColor , saturate( ( localThreePointDistribution8_g989 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g989 ) ) * _HighlightBlend ) ));
				...
				float4 temp_output_32_0_g982 = temp_output_42_0_g981;
				float temp_output_172_0_g981 = _SpecularMix;
				float4 lerpResult36_g982 = lerp( temp_output_13_0_g982 , ( temp_output_13_0_g982 * temp_output_32_0_g982 ) , temp_output_172_0_g981);
				float3 temp_output_24_0_g982 = worldNormal86_g981;
				float dotResult15_g982 = dot( lightDir55_g982 , temp_output_24_0_g982 );
				float temp_output_200_0_g981 = _Translucency;
				float temp_output_40_0_g982 = temp_output_200_0_g981;
				...
				float3 ViewDir126_g981 = ase_worldViewDir;
				...
				float3 bakedGI53_g981 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g981);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g982 + ( ( saturate( ( ( dotResult15_g982 * ( 1.0 - temp_output_40_0_g982 ) ) + temp_output_40_0_g982 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g982 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g982 ) , 0.0 ) ) , temp_output_208_0_g981 ) * temp_output_207_0_g981 ) ) * temp_output_32_0_g982 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g981 , 0.0 ) ) * lerpResult280_g981 ) + ( float4( bakedGI53_g981 , 0.0 ) * temp_output_42_0_g981 * temp_output_161_0_g981 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=19001
1913;77;1920;951;1874.827;-691.8317;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;628;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;988;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=7295DF7B61682D313A68F84FBAFAA1B212962B13