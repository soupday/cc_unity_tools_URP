...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP12_Tessellation"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g1163( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g1160( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g1160 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g1160 = lerp( break109_g1160.g , ( 1.0 - break109_g1160.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g1160 = (float3(break109_g1160.r , lerpResult123_g1160 , break109_g1160.b));
				float3 NormalTS13_g1163 = ( ( appendResult98_g1160 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g1163 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g1163 = float3x3(ase_worldTangent, Binormal5_g1163, ase_worldNormal);
				float3x3 TBN13_g1163 = TBN1_g1163;
				float3 localTangentToWorld13_g1163 = TangentToWorld13_g1163( NormalTS13_g1163 , TBN13_g1163 );
				float3 flowTangent107_g1160 = localTangentToWorld13_g1163;
				...
				float3 tanNormal85_g1160 = normal282;
				float3 worldNormal85_g1160 = normalize( float3(dot(tanToWorld0,tanNormal85_g1160), dot(tanToWorld1,tanNormal85_g1160), dot(tanToWorld2,tanNormal85_g1160)) );
				float3 worldNormal86_g1160 = worldNormal85_g1160;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g1160 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g1164 = normalize( ( flowTangent107_g1160 + ( worldNormal86_g1160 * lerpResult81_g1160 ) ) );
				float3 shiftedTangent119_g1160 = normalizeResult10_g1164;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g1161 = ase_worldViewDir;
				float3 worldLight248_g1160 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g1161 = worldLight248_g1160;
				float3 normalizeResult14_g1162 = normalize( ( viewDIr52_g1161 + lightDir55_g1161 ) );
				float dotResult16_g1162 = dot( shiftedTangent119_g1160 , normalizeResult14_g1162 );
				float smoothstepResult22_g1162 = smoothstep( -1.0 , 0.0 , dotResult16_g1162);
				...
				float temp_output_233_0_g1160 = max( ( 1.0 - smoothness601 ) , 0.001 );
				float specularPower237_g1160 = ( max( ( ( 2.0 / ( temp_output_233_0_g1160 * temp_output_233_0_g1160 ) ) - 2.0 ) , 0.001 ) * _SpecularPower );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g1160 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g1160 = _SpecularTint;
				float4 temp_output_13_0_g1161 = ( ( smoothstepResult22_g1162 * pow( saturate( ( 1.0 - ( dotResult16_g1162 * dotResult16_g1162 ) ) ) , specularPower237_g1160 ) ) * temp_output_132_0_g1160 * temp_output_131_0_g1160 );
				...
				float4 lerpResult18_g1165 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g1165 = root58;
				float lerpResult23_g1165 = lerp( temp_output_27_0_g1165 , ( 1.0 - temp_output_27_0_g1165 ) , _InvertRootMap);
				float4 lerpResult3_g1165 = lerp( _RootColor , _EndColor , lerpResult23_g1165);
				float lerpResult40_g1165 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g1165);
				float4 lerpResult6_g1165 = lerp( lerpResult18_g1165 , lerpResult3_g1165 , ( lerpResult40_g1165 * _GlobalStrength ));
				float3 From8_g1167 = _HighlightADistribution;
				float ID8_g1167 = idMap383;
				float Fac8_g1167 = _HighlightAStrength;
				float localThreePointDistribution8_g1167 = ThreePointDistribution( From8_g1167 , ID8_g1167 , Fac8_g1167 );
				float temp_output_24_0_g1167 = root58;
				float lerpResult16_g1167 = lerp( temp_output_24_0_g1167 , ( 1.0 - temp_output_24_0_g1167 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g1167 = lerp( lerpResult6_g1165 , _HighlightAColor , saturate( ( localThreePointDistribution8_g1167 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g1167 ) ) * _HighlightBlend ) ));
				float3 From8_g1166 = _HighlightBDistribution;
				float ID8_g1166 = idMap383;
				float Fac8_g1166 = _HighlightBStrength;
				float localThreePointDistribution8_g1166 = ThreePointDistribution( From8_g1166 , ID8_g1166 , Fac8_g1166 );
				float temp_output_24_0_g1166 = root58;
				float lerpResult16_g1166 = lerp( temp_output_24_0_g1166 , ( 1.0 - temp_output_24_0_g1166 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g1166 = lerp( lerpResult18_g1167 , _HighlightBColor , saturate( ( localThreePointDistribution8_g1166 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g1166 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g1166;
				#else
				...
				float4 temp_output_42_0_g1160 = baseColor331;
				float4 temp_output_32_0_g1161 = temp_output_42_0_g1160;
				float temp_output_172_0_g1160 = _SpecularMix;
				float4 lerpResult36_g1161 = lerp( temp_output_13_0_g1161 , ( temp_output_13_0_g1161 * temp_output_32_0_g1161 ) , temp_output_172_0_g1160);
				float3 temp_output_24_0_g1161 = worldNormal86_g1160;
				float dotResult15_g1161 = dot( lightDir55_g1161 , temp_output_24_0_g1161 );
				float temp_output_200_0_g1160 = _Translucency;
				float temp_output_40_0_g1161 = temp_output_200_0_g1160;
				float dotResult54_g1161 = dot( temp_output_24_0_g1161 , viewDIr52_g1161 );
				float dotResult57_g1161 = dot( viewDIr52_g1161 , lightDir55_g1161 );
				float temp_output_208_0_g1160 = _RimPower;
				float temp_output_207_0_g1160 = _RimTransmissionIntensity;
				float3 Color126_g1160 = temp_output_42_0_g1160.rgb;
				float3 TangentWorld126_g1160 = shiftedTangent119_g1160;
				float3 ViewDir126_g1160 = ase_worldViewDir;
				float3 NormalWorld126_g1160 = worldNormal86_g1160;
				float3 SpecularColor126_g1160 = temp_output_131_0_g1160.rgb;
				float SpecularTint126_g1160 = temp_output_172_0_g1160;
				float SpecularPower126_g1160 = specularPower237_g1160;
				float SpecularMultiplier126_g1160 = temp_output_132_0_g1160;
				float3 worldPosition129_g1160 = WorldPosition;
				float3 PositionWorld126_g1160 = worldPosition129_g1160;
				float Translucency126_g1160 = temp_output_200_0_g1160;
				float RimTransmission126_g1160 = temp_output_207_0_g1160;
				float RimPower126_g1160 = temp_output_208_0_g1160;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g1160 = RL_Amplify_Expression_HairLighting_Additional126_g1160( Color126_g1160 , TangentWorld126_g1160 , ViewDir126_g1160 , NormalWorld126_g1160 , SpecularColor126_g1160 , SpecularTint126_g1160 , SpecularPower126_g1160 , SpecularMultiplier126_g1160 , PositionWorld126_g1160 , Translucency126_g1160 , RimTransmission126_g1160 , RimPower126_g1160 );
				float lerpResult644 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult644;
				float temp_output_161_0_g1160 = ambientOcclusion570;
				float lerpResult280_g1160 = lerp( 1.0 , temp_output_161_0_g1160 , _AOOccludeAll);
				float3 bakedGI53_g1160 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g1160);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g1160, bakedGI53_g1160, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g1161 + ( ( saturate( ( ( dotResult15_g1161 * ( 1.0 - temp_output_40_0_g1161 ) ) + temp_output_40_0_g1161 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1161 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1161 ) , 0.0 ) ) , temp_output_208_0_g1160 ) * temp_output_207_0_g1160 ) ) * temp_output_32_0_g1161 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g1160 , 0.0 ) ) * lerpResult280_g1160 ) + ( float4( bakedGI53_g1160 , 0.0 ) * temp_output_42_0_g1160 * temp_output_161_0_g1160 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=19001
1913;77;1920;951;1455.381;71.0701;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;385;-682.259,775.7559;Inherit;False;Property;_SpecularShiftMin;Specular Shift Min;49;0;Create;True;0;0;0;False;0;False;-0.25;-0.25;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;635;-4952.412,275.6267;Inherit;False;Property;_HighlightBlend;Highlight Blend;27;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;539;-677.5486,927.3325;Inherit;False;Property;_Translucency;Translucency;51;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;643;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;1165;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;180;-625.7612,623.3423;Inherit;False;Property;_FlowMapFlipGreen;Flow Map Flip Green;42;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;640;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;1167;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;639;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;1166;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-1861.578,2419.963;Inherit;False;Property;_AOStrength;Ambient Occlusion Strength;9;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;177;-707.1387,433.9277;Inherit;True;Property;_FlowMap;Flow Map;41;0;Create;True;0;0;0;False;0;False;19;cc37af08370d26540b0e6725a8b8879e;cc37af08370d26540b0e6725a8b8879e;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;521;448.291,1436.518;Inherit;False;518;alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;389;-679.936,851.2879;Inherit;False;Property;_SpecularShiftMax;Specular Shift Max;50;0;Create;True;0;0;0;False;0;False;0.25;0.25;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-675.7505,1002.806;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;44;0;Create;True;0;0;0;False;0;False;4;10;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;609;-689.9568,355.3112;Inherit;False;Property;_SpecularPower;Specular Smoothness;47;0;Create;False;0;0;0;False;0;False;4;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;917.0538,1167.637;Half;False;True;-1;2;ASEMaterialInspector;0;12;Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP12_Tessellation;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;6;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;2;False;;True;1;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;1;637787991825921621;  Blend;0;0;Two Sided;0;637788651120112867;Forward Only;0;0;Cast Shadows;0;637788651025808361;  Use Shadow Threshold;0;637787998365867513;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637788650928858011;DOTS Instancing;0;0;Meta Pass;1;637793397155228723;Extra Pre Pass;0;637788651331004462;Tessellation;1;637999710243746644;  Phong;1;637788078609197688;  Strength;0.5,False,;637999710352977927;  Type;2;637999719930449855;  Tess;16,False,;637999710393859068;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=728054B0E1F1E6450B6BD3510CF1C5B07962EF66