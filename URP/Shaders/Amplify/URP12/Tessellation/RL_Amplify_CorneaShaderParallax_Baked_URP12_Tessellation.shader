...
Shader "Reallusion/Amplify/RL_CorneaShaderParallax_Baked_URP12_Tessellation"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 tex2DNode370 = tex2D( _DetailMask, uv_DetailMask );
				float pupilScaleMask372 = tex2DNode370.g;
				float lerpResult83 = lerp( 1.0 , ( ( 0.333 / ( 0.333 + irisDepth219 ) ) * _PupilScale ) , pupilScaleMask372);
				...
				float temp_output_122_0 = ( 1.0 / ( ( irisDepth219 * _PMod ) + 0.91 ) );
				float parallaxHeightMask375 = tex2DNode370.b;
				float2 lerpResult136 = lerp( texCoord93 , (( texCoord93 - ( (normalizeResult117).xy * irisDepth219 ) )*temp_output_122_0 + ( ( 1.0 - temp_output_122_0 ) * 0.5 )) , parallaxHeightMask375);
				float eyeBlendMask374 = tex2DNode370.r;
				float4 lerpResult383 = lerp( tex2D( _BaseMap, uv_BaseMap ) , tex2D( _BaseMap, lerpResult136 ) , eyeBlendMask374);
				float4 baseColor418 = ( lerpResult383 * _BaseColor );
				
				float2 uv_BumpMap = IN.ase_texcoord8.xy * _BumpMap_ST.xy + _BumpMap_ST.zw;
				float3 unpack406 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap ), _BumpScale );
				...
				float microNormalMask376 = tex2DNode370.a;
				float3 unpack404 = UnpackNormalScale( tex2D( _DetailNormalMap, uv_DetailNormalMap ), ( _DetailNormalMapScale * microNormalMask376 ) );
				...
				float4 tex2DNode412 = tex2D( _MetallicGlossMap, uv_MetallicGlossMap );
...
/*ASEBEGIN
Version=19001
1913;77;1920;951;2726.191;-1735.127;2.120663;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;377;-2428.254,283.1136;Inherit;False;375;parallaxHeightMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;13;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=C3103D5261F134FECAB875A05B6AA0F0AC365BF6