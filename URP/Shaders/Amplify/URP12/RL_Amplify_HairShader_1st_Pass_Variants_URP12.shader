...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP12"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g1098( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g1095( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g1095 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g1095 = lerp( break109_g1095.g , ( 1.0 - break109_g1095.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g1095 = (float3(break109_g1095.r , lerpResult123_g1095 , break109_g1095.b));
				float3 NormalTS13_g1098 = ( ( appendResult98_g1095 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g1098 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g1098 = float3x3(ase_worldTangent, Binormal5_g1098, ase_worldNormal);
				float3x3 TBN13_g1098 = TBN1_g1098;
				float3 localTangentToWorld13_g1098 = TangentToWorld13_g1098( NormalTS13_g1098 , TBN13_g1098 );
				float3 flowTangent107_g1095 = localTangentToWorld13_g1098;
				...
				float3 tanNormal85_g1095 = normal282;
				float3 worldNormal85_g1095 = normalize( float3(dot(tanToWorld0,tanNormal85_g1095), dot(tanToWorld1,tanNormal85_g1095), dot(tanToWorld2,tanNormal85_g1095)) );
				float3 worldNormal86_g1095 = worldNormal85_g1095;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g1095 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g1099 = normalize( ( flowTangent107_g1095 + ( worldNormal86_g1095 * lerpResult81_g1095 ) ) );
				float3 shiftedTangent119_g1095 = normalizeResult10_g1099;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g1096 = ase_worldViewDir;
				float3 worldLight248_g1095 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g1096 = worldLight248_g1095;
				float3 normalizeResult14_g1097 = normalize( ( viewDIr52_g1096 + lightDir55_g1096 ) );
				float dotResult16_g1097 = dot( shiftedTangent119_g1095 , normalizeResult14_g1097 );
				float smoothstepResult22_g1097 = smoothstep( -1.0 , 0.0 , dotResult16_g1097);
				...
				float temp_output_233_0_g1095 = max( ( 1.0 - smoothness587 ) , 0.001 );
				float specularPower237_g1095 = ( max( ( ( 2.0 / ( temp_output_233_0_g1095 * temp_output_233_0_g1095 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g1095 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g1095 = _SpecularTint;
				float4 temp_output_13_0_g1096 = ( ( smoothstepResult22_g1097 * pow( saturate( ( 1.0 - ( dotResult16_g1097 * dotResult16_g1097 ) ) ) , specularPower237_g1095 ) ) * temp_output_132_0_g1095 * temp_output_131_0_g1095 );
				...
				float4 lerpResult18_g1100 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g1100 = root58;
				float lerpResult23_g1100 = lerp( temp_output_27_0_g1100 , ( 1.0 - temp_output_27_0_g1100 ) , _InvertRootMap);
				float4 lerpResult3_g1100 = lerp( _RootColor , _EndColor , lerpResult23_g1100);
				float lerpResult40_g1100 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g1100);
				float4 lerpResult6_g1100 = lerp( lerpResult18_g1100 , lerpResult3_g1100 , ( lerpResult40_g1100 * _GlobalStrength ));
				float3 From8_g1093 = _HighlightADistribution;
				float ID8_g1093 = idMap383;
				float Fac8_g1093 = _HighlightAStrength;
				float localThreePointDistribution8_g1093 = ThreePointDistribution( From8_g1093 , ID8_g1093 , Fac8_g1093 );
				float temp_output_24_0_g1093 = root58;
				float lerpResult16_g1093 = lerp( temp_output_24_0_g1093 , ( 1.0 - temp_output_24_0_g1093 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g1093 = lerp( lerpResult6_g1100 , _HighlightAColor , saturate( ( localThreePointDistribution8_g1093 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g1093 ) ) * _HighlightBlend ) ));
				float3 From8_g1094 = _HighlightBDistribution;
				float ID8_g1094 = idMap383;
				float Fac8_g1094 = _HighlightBStrength;
				float localThreePointDistribution8_g1094 = ThreePointDistribution( From8_g1094 , ID8_g1094 , Fac8_g1094 );
				float temp_output_24_0_g1094 = root58;
				float lerpResult16_g1094 = lerp( temp_output_24_0_g1094 , ( 1.0 - temp_output_24_0_g1094 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g1094 = lerp( lerpResult18_g1093 , _HighlightBColor , saturate( ( localThreePointDistribution8_g1094 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g1094 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g1094;
				#else
				...
				float4 temp_output_42_0_g1095 = baseColor331;
				float4 temp_output_32_0_g1096 = temp_output_42_0_g1095;
				float temp_output_172_0_g1095 = _SpecularMix;
				float4 lerpResult36_g1096 = lerp( temp_output_13_0_g1096 , ( temp_output_13_0_g1096 * temp_output_32_0_g1096 ) , temp_output_172_0_g1095);
				float3 temp_output_24_0_g1096 = worldNormal86_g1095;
				float dotResult15_g1096 = dot( lightDir55_g1096 , temp_output_24_0_g1096 );
				float temp_output_200_0_g1095 = _Translucency;
				float temp_output_40_0_g1096 = temp_output_200_0_g1095;
				float dotResult54_g1096 = dot( temp_output_24_0_g1096 , viewDIr52_g1096 );
				float dotResult57_g1096 = dot( viewDIr52_g1096 , lightDir55_g1096 );
				float temp_output_208_0_g1095 = _RimPower;
				float temp_output_207_0_g1095 = _RimTransmissionIntensity;
				float3 Color126_g1095 = temp_output_42_0_g1095.rgb;
				float3 TangentWorld126_g1095 = shiftedTangent119_g1095;
				float3 ViewDir126_g1095 = ase_worldViewDir;
				float3 NormalWorld126_g1095 = worldNormal86_g1095;
				float3 SpecularColor126_g1095 = temp_output_131_0_g1095.rgb;
				float SpecularTint126_g1095 = temp_output_172_0_g1095;
				float SpecularPower126_g1095 = specularPower237_g1095;
				float SpecularMultiplier126_g1095 = temp_output_132_0_g1095;
				float3 worldPosition129_g1095 = WorldPosition;
				float3 PositionWorld126_g1095 = worldPosition129_g1095;
				float Translucency126_g1095 = temp_output_200_0_g1095;
				float RimTransmission126_g1095 = temp_output_207_0_g1095;
				float RimPower126_g1095 = temp_output_208_0_g1095;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g1095 = RL_Amplify_Expression_HairLighting_Additional126_g1095( Color126_g1095 , TangentWorld126_g1095 , ViewDir126_g1095 , NormalWorld126_g1095 , SpecularColor126_g1095 , SpecularTint126_g1095 , SpecularPower126_g1095 , SpecularMultiplier126_g1095 , PositionWorld126_g1095 , Translucency126_g1095 , RimTransmission126_g1095 , RimPower126_g1095 );
				float lerpResult631 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult631;
				float temp_output_161_0_g1095 = ambientOcclusion570;
				float lerpResult280_g1095 = lerp( 1.0 , temp_output_161_0_g1095 , _AOOccludeAll);
				float3 bakedGI53_g1095 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g1095);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g1095, bakedGI53_g1095, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g1096 + ( ( saturate( ( ( dotResult15_g1096 * ( 1.0 - temp_output_40_0_g1096 ) ) + temp_output_40_0_g1096 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1096 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1096 ) , 0.0 ) ) , temp_output_208_0_g1095 ) * temp_output_207_0_g1095 ) ) * temp_output_32_0_g1096 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g1095 , 0.0 ) ) * lerpResult280_g1095 ) + ( float4( bakedGI53_g1095 , 0.0 ) * temp_output_42_0_g1095 * temp_output_161_0_g1095 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=19001
1913;65;1920;963;1399.404;-623.5668;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;630;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;1100;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;905.9279,1167.715;Half;False;True;-1;2;ASEMaterialInspector;0;12;Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP12;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992114575262;DOTS Instancing;0;0;Meta Pass;1;637793397055987464;Extra Pre Pass;0;0;Tessellation;0;637788079052467337;  Phong;1;637788078022368415;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=58F5B012866D2090F1201E311BFE57C938D61723