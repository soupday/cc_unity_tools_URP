	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 tanNormal53_g854 = worldNormal86_g854;
				float3 bakedGI53_g854 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g854), dot(tanToWorld1,tanNormal53_g854), dot(tanToWorld2,tanNormal53_g854)));
				MixRealtimeAndBakedGI(ase_mainLight, float3(dot(tanToWorld0,tanNormal53_g854), dot(tanToWorld1,tanNormal53_g854), dot(tanToWorld2,tanNormal53_g854)), bakedGI53_g854, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g857 + ( ( saturate( ( ( dotResult15_g857 * ( 1.0 - temp_output_40_0_g857 ) ) + temp_output_40_0_g857 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g857 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g857 ) , 0.0 ) ) , temp_output_208_0_g854 ) * temp_output_207_0_g854 ) ) * temp_output_32_0_g857 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g854 , 0.0 ) ) * lerpResult280_g854 ) + ( float4( bakedGI53_g854 , 0.0 ) * temp_output_42_0_g854 * temp_output_161_0_g854 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1920;0;1920;1029;2475.22;-1769.336;1;True;False
...
ASEEND*/
//CHKSM=AF2B44AC9C86CA7A772B1B074DBBB147C2F7275A