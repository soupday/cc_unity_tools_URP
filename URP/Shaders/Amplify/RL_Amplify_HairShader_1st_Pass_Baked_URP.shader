...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Baked_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g851( half3 NormalTS, half3x3 TBN )
			{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 NormalTS13_g851 = ( ( appendResult98_g849 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_worldTangent = IN.ase_texcoord4.xyz;
				half3 ase_worldNormal = IN.ase_texcoord5.xyz;
				half3 Binormal5_g851 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g851 = float3x3(ase_worldTangent, Binormal5_g851, ase_worldNormal);
				half3x3 TBN13_g851 = TBN1_g851;
				half3 localTangentToWorld13_g851 = TangentToWorld13_g851( NormalTS13_g851 , TBN13_g851 );
				half3 flowTangent107_g849 = localTangentToWorld13_g851;
				...
				half3 viewDIr52_g852 = ase_worldViewDir;
				half3 worldLight248_g849 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g852 = worldLight248_g849;
				half3 normalizeResult14_g853 = normalize( ( viewDIr52_g852 + lightDir55_g852 ) );
				half dotResult16_g853 = dot( shiftedTangent119_g849 , normalizeResult14_g853 );
				half smoothstepResult22_g853 = smoothstep( -1.0 , 0.0 , dotResult16_g853);
				...
				half temp_output_132_0_g849 = ( specularMask644 * _SpecularMultiplier );
				half4 temp_output_131_0_g849 = _SpecularTint;
				half4 temp_output_13_0_g852 = ( ( smoothstepResult22_g853 * pow( saturate( ( 1.0 - ( dotResult16_g853 * dotResult16_g853 ) ) ) , specularPower237_g849 ) ) * temp_output_132_0_g849 * temp_output_131_0_g849 );
				...
				half4 temp_output_32_0_g852 = temp_output_42_0_g849;
				half temp_output_172_0_g849 = _SpecularMix;
				half4 lerpResult36_g852 = lerp( temp_output_13_0_g852 , ( temp_output_13_0_g852 * temp_output_32_0_g852 ) , temp_output_172_0_g849);
				half3 temp_output_24_0_g852 = worldNormal86_g849;
				half dotResult15_g852 = dot( lightDir55_g852 , temp_output_24_0_g852 );
				half temp_output_200_0_g849 = _Translucency;
				half temp_output_40_0_g852 = temp_output_200_0_g849;
				half dotResult54_g852 = dot( temp_output_24_0_g852 , viewDIr52_g852 );
				half dotResult57_g852 = dot( viewDIr52_g852 , lightDir55_g852 );
...
/*ASEBEGIN
Version=18935
0;0;1920;1029;2049.689;-230.6622;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1085.333;1589.565;;18;378;571;595;263;569;180;108;482;608;572;177;596;389;385;384;539;265;647;Specular Highlights;1,0.7932334,0.514151,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;612;-2173.329,2229.718;Inherit;False;1268.577;322.7186;Comment;7;570;637;627;623;622;617;644;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;632;-1656.992,1810.155;Inherit;True;Property;_MetallicGlossMap;Metallic Gloss Map;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;633;-1480.79,1140.893;Inherit;True;Property;_EmissionMap;Emission Map;11;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;622;-1740.753,2366.718;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1196.927,335.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;20;0;Create;False;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=328ECD2FAF7E7432C7FFA0A619B0F866D8486D59