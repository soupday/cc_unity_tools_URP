...
Shader "Reallusion/Amplify/RL_HairShader_1st_Pass_Baked_URP"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g850( half3 NormalTS, half3x3 TBN )
			{
			...
			half3 RL_Amplify_Expression_HairLighting_Additional126_g849( half3 Color, half3 TangentWorld, half3 ViewDir, half3 NormalWorld, half3 SpecularColor, half SpecularTint, half SpecularPower, half SpecularMultiplier, half3 PositionWorld, half Translucency, half RimTransmission, half RimPower )
			{
				half3 addColor = 0;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 NormalTS13_g850 = ( ( appendResult98_g849 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_worldTangent = IN.ase_texcoord4.xyz;
				half3 ase_worldNormal = IN.ase_texcoord5.xyz;
				half3 Binormal5_g850 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g850 = float3x3(ase_worldTangent, Binormal5_g850, ase_worldNormal);
				half3x3 TBN13_g850 = TBN1_g850;
				half3 localTangentToWorld13_g850 = TangentToWorld13_g850( NormalTS13_g850 , TBN13_g850 );
				half3 flowTangent107_g849 = localTangentToWorld13_g850;
				...
				half3 worldNormal85_g849 = normalize( float3(dot(tanToWorld0,tanNormal85_g849), dot(tanToWorld1,tanNormal85_g849), dot(tanToWorld2,tanNormal85_g849)) );
				half3 worldNormal86_g849 = worldNormal85_g849;
				...
				half3 normalizeResult10_g853 = normalize( ( flowTangent107_g849 + ( worldNormal86_g849 * lerpResult81_g849 ) ) );
				half3 shiftedTangent119_g849 = normalizeResult10_g853;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				half3 viewDIr52_g851 = ase_worldViewDir;
				half3 lightDir55_g851 = SafeNormalize(_MainLightPosition.xyz);
				half3 normalizeResult14_g852 = normalize( ( viewDIr52_g851 + lightDir55_g851 ) );
				...
				half temp_output_132_0_g849 = _SpecularMultiplier;
				half4 temp_output_131_0_g849 = _SpecularTint;
				half4 temp_output_13_0_g851 = ( ( smoothstepResult22_g852 * pow( saturate( ( 1.0 - ( dotResult16_g852 * dotResult16_g852 ) ) ) , specularPower237_g849 ) ) * temp_output_132_0_g849 * temp_output_131_0_g849 );
				...
				half temp_output_172_0_g849 = _SpecularMix;
				half4 lerpResult36_g851 = lerp( temp_output_13_0_g851 , ( temp_output_13_0_g851 * temp_output_32_0_g851 ) , temp_output_172_0_g849);
				half3 temp_output_24_0_g851 = worldNormal86_g849;
				half dotResult15_g851 = dot( lightDir55_g851 , temp_output_24_0_g851 );
				half temp_output_200_0_g849 = _Translucency;
				half temp_output_40_0_g851 = temp_output_200_0_g849;
				half dotResult54_g851 = dot( temp_output_24_0_g851 , viewDIr52_g851 );
				half dotResult57_g851 = dot( viewDIr52_g851 , lightDir55_g851 );
				half temp_output_208_0_g849 = _RimPower;
				half temp_output_207_0_g849 = _RimTransmissionIntensity;
				half3 Color126_g849 = temp_output_42_0_g849.rgb;
				half3 TangentWorld126_g849 = shiftedTangent119_g849;
				half3 ViewDir126_g849 = ase_worldViewDir;
				half3 NormalWorld126_g849 = worldNormal86_g849;
				half3 SpecularColor126_g849 = temp_output_131_0_g849.rgb;
				half SpecularTint126_g849 = temp_output_172_0_g849;
				half SpecularPower126_g849 = specularPower237_g849;
				half SpecularMultiplier126_g849 = temp_output_132_0_g849;
				half3 worldPosition129_g849 = WorldPosition;
				half3 PositionWorld126_g849 = worldPosition129_g849;
				half Translucency126_g849 = temp_output_200_0_g849;
				half RimTransmission126_g849 = temp_output_207_0_g849;
				half RimPower126_g849 = temp_output_208_0_g849;
				half3 localRL_Amplify_Expression_HairLighting_Additional126_g849 = RL_Amplify_Expression_HairLighting_Additional126_g849( Color126_g849 , TangentWorld126_g849 , ViewDir126_g849 , NormalWorld126_g849 , SpecularColor126_g849 , SpecularTint126_g849 , SpecularPower126_g849 , SpecularMultiplier126_g849 , PositionWorld126_g849 , Translucency126_g849 , RimTransmission126_g849 , RimPower126_g849 );
				float3 tanNormal53_g849 = worldNormal86_g849;
				half3 bakedGI53_g849 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, float3(dot(tanToWorld0,tanNormal53_g849), dot(tanToWorld1,tanNormal53_g849), dot(tanToWorld2,tanNormal53_g849)));
				...
				half ambientOcclusion570 = ( 1.0 - ( _OcclusionStrength * ( 1.0 - tex2D( _OcclusionMap, uv_OcclusionMap ).g ) ) );
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g851 + ( ( saturate( ( ( dotResult15_g851 * ( 1.0 - temp_output_40_0_g851 ) ) + temp_output_40_0_g851 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g851 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g851 ) , 0.0 ) ) , temp_output_208_0_g849 ) * temp_output_207_0_g849 ) ) * temp_output_32_0_g851 ) ) * _MainLightColor ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g849 , 0.0 ) ) + ( half4( bakedGI53_g849 , 0.0 ) * temp_output_42_0_g849 * lerpResult180_g849 ) ) * lerpResult183_g849 ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=18935
1913;30;1920;999;981.4528;-413.6387;1.647716;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;612;-2173.329,2229.718;Inherit;False;1268.577;322.7186;Comment;6;570;637;627;623;622;617;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1085.333;1589.565;;18;378;571;595;263;569;180;108;482;608;572;177;596;389;385;384;380;539;265;Specular Highlights;1,0.7932334,0.514151,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;177;-709.0319,429.8401;Inherit;True;Property;_FlowMap;Flow Map;15;0;Create;True;0;0;0;False;0;False;19;cc37af08370d26540b0e6725a8b8879e;cc37af08370d26540b0e6725a8b8879e;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;622;-1737.753,2426.718;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;18;0;Create;True;0;0;0;False;0;False;10;10;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;162;416.7961,1525.618;Inherit;False;Property;_AlphaClip2;Alpha Clip;8;0;Create;False;0;0;0;False;0;False;0.15;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;532;416.9387,1624.154;Inherit;False;Property;_ShadowClip;Shadow Clip;10;0;Create;True;0;0;0;False;0;False;0.25;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;634;-1399.275,1353.574;Inherit;False;Property;_EmissiveColor;Emissive Color;12;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;596;-689.4732,354.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;21;0;Create;False;0;0;0;False;0;False;2;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-689.9268,277.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;20;0;Create;False;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;629;-1490.091,623.4471;Inherit;True;Property;_BumpMap;Bump Map;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=62CB73C834460F1DD29BF0B8DC57AF83FF830B97