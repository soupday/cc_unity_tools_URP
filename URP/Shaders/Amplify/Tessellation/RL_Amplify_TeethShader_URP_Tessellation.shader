	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				half2 texCoord77 = IN.ase_texcoord7.xy * temp_cast_2 + float2( 0,0 );
...
ASEEND*/
//CHKSM=1086D221ECDC47D8F40E1C30D1F0BC1D66FD977C