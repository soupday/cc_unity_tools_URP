	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 Binormal5_g1151 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g1151 = float3x3(ase_worldTangent, Binormal5_g1151, ase_worldNormal);
				...
				half3 viewDIr52_g1152 = ase_worldViewDir;
				half3 worldLight248_g1150 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g1152 = worldLight248_g1150;
				half3 normalizeResult14_g1153 = normalize( ( viewDIr52_g1152 + lightDir55_g1152 ) );
				half dotResult16_g1153 = dot( shiftedTangent119_g1150 , normalizeResult14_g1153 );
				half smoothstepResult22_g1153 = smoothstep( -1.0 , 0.0 , dotResult16_g1153);
				...
				half4 temp_output_13_0_g1152 = ( ( smoothstepResult22_g1153 * pow( saturate( ( 1.0 - ( dotResult16_g1153 * dotResult16_g1153 ) ) ) , specularPower237_g1150 ) ) * temp_output_132_0_g1150 * temp_output_131_0_g1150 );
				...
				half4 temp_output_32_0_g1152 = temp_output_42_0_g1150;
				half temp_output_172_0_g1150 = _SpecularMix;
				half4 lerpResult36_g1152 = lerp( temp_output_13_0_g1152 , ( temp_output_13_0_g1152 * temp_output_32_0_g1152 ) , temp_output_172_0_g1150);
				half3 temp_output_24_0_g1152 = worldNormal86_g1150;
				half dotResult15_g1152 = dot( lightDir55_g1152 , temp_output_24_0_g1152 );
				half temp_output_200_0_g1150 = _Translucency;
				half temp_output_40_0_g1152 = temp_output_200_0_g1150;
				half dotResult54_g1152 = dot( temp_output_24_0_g1152 , viewDIr52_g1152 );
				half dotResult57_g1152 = dot( viewDIr52_g1152 , lightDir55_g1152 );
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * saturate( ( ( lerpResult36_g1152 + ( ( saturate( ( ( dotResult15_g1152 * ( 1.0 - temp_output_40_0_g1152 ) ) + temp_output_40_0_g1152 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1152 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1152 ) , 0.0 ) ) , temp_output_208_0_g1150 ) * temp_output_207_0_g1150 ) ) * temp_output_32_0_g1152 ) ) * ase_lightColor ) ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g1150 , 0.0 ) ) * lerpResult280_g1150 ) + ( half4( max( bakedGI53_g1150 , float3( 0,0,0 ) ) , 0.0 ) * temp_output_42_0_g1150 * temp_output_161_0_g1150 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;917.0538,1167.637;Half;False;True;-1;2;ASEMaterialInspector;0;13;Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP_Tessellation;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;6;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;True;True;2;False;;True;1;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;1;637787991825921621;  Blend;0;0;Two Sided;0;637788651120112867;Forward Only;1;638364372833503686;Cast Shadows;0;637788651025808361;  Use Shadow Threshold;0;637787998365867513;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637788650928858011;Meta Pass;0;638047162170683407;Extra Pre Pass;0;637788651331004462;Tessellation;1;638047089480803373;  Phong;1;637788078609197688;  Strength;0.5,False,;0;  Type;2;638047089532790812;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;True;0
...
ASEEND*/
//CHKSM=848F7F0ABFC6FDC42529DF20555D0BCC734597EC