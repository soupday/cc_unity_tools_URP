	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 lerpResult18_g1156 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g1156 = root58;
				float lerpResult23_g1156 = lerp( temp_output_27_0_g1156 , ( 1.0 - temp_output_27_0_g1156 ) , _InvertRootMap);
				float4 lerpResult3_g1156 = lerp( _RootColor , _EndColor , lerpResult23_g1156);
				float lerpResult40_g1156 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g1156);
				float4 lerpResult6_g1156 = lerp( lerpResult18_g1156 , lerpResult3_g1156 , ( lerpResult40_g1156 * _GlobalStrength ));
				float3 From8_g1158 = _HighlightADistribution;
				float ID8_g1158 = idMap383;
				float Fac8_g1158 = _HighlightAStrength;
				float localThreePointDistribution8_g1158 = ThreePointDistribution( From8_g1158 , ID8_g1158 , Fac8_g1158 );
				float temp_output_24_0_g1158 = root58;
				float lerpResult16_g1158 = lerp( temp_output_24_0_g1158 , ( 1.0 - temp_output_24_0_g1158 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g1158 = lerp( lerpResult6_g1156 , _HighlightAColor , saturate( ( localThreePointDistribution8_g1158 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g1158 ) ) * _HighlightBlend ) ));
				float3 From8_g1159 = _HighlightBDistribution;
				float ID8_g1159 = idMap383;
				float Fac8_g1159 = _HighlightBStrength;
				float localThreePointDistribution8_g1159 = ThreePointDistribution( From8_g1159 , ID8_g1159 , Fac8_g1159 );
				float temp_output_24_0_g1159 = root58;
				float lerpResult16_g1159 = lerp( temp_output_24_0_g1159 , ( 1.0 - temp_output_24_0_g1159 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g1159 = lerp( lerpResult18_g1158 , _HighlightBColor , saturate( ( localThreePointDistribution8_g1159 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g1159 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g1159;
				#else
...
/*ASEBEGIN
Version=19001
1913;42;1920;987;1455.381;89.0701;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;643;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;1156;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;639;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;1159;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;640;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;1158;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=4B6E1DA57D94C9AC492004BEC69F882C3F183F65