...
Shader "Reallusion/Amplify/RL_HairShader_2nd_Pass_Variants_URP_Tessellation"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g1172( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g1169( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g1169 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g1169 = lerp( break109_g1169.g , ( 1.0 - break109_g1169.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g1169 = (float3(break109_g1169.r , lerpResult123_g1169 , break109_g1169.b));
				float3 NormalTS13_g1172 = ( ( appendResult98_g1169 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g1172 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g1172 = float3x3(ase_worldTangent, Binormal5_g1172, ase_worldNormal);
				float3x3 TBN13_g1172 = TBN1_g1172;
				float3 localTangentToWorld13_g1172 = TangentToWorld13_g1172( NormalTS13_g1172 , TBN13_g1172 );
				float3 flowTangent107_g1169 = localTangentToWorld13_g1172;
				...
				float3 tanNormal85_g1169 = normal282;
				float3 worldNormal85_g1169 = normalize( float3(dot(tanToWorld0,tanNormal85_g1169), dot(tanToWorld1,tanNormal85_g1169), dot(tanToWorld2,tanNormal85_g1169)) );
				float3 worldNormal86_g1169 = worldNormal85_g1169;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g1169 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g1173 = normalize( ( flowTangent107_g1169 + ( worldNormal86_g1169 * lerpResult81_g1169 ) ) );
				float3 shiftedTangent119_g1169 = normalizeResult10_g1173;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g1170 = ase_worldViewDir;
				float3 worldLight248_g1169 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g1170 = worldLight248_g1169;
				float3 normalizeResult14_g1171 = normalize( ( viewDIr52_g1170 + lightDir55_g1170 ) );
				float dotResult16_g1171 = dot( shiftedTangent119_g1169 , normalizeResult14_g1171 );
				float smoothstepResult22_g1171 = smoothstep( -1.0 , 0.0 , dotResult16_g1171);
				...
				float temp_output_233_0_g1169 = max( ( 1.0 - smoothness601 ) , 0.001 );
				float specularPower237_g1169 = ( max( ( ( 2.0 / ( temp_output_233_0_g1169 * temp_output_233_0_g1169 ) ) - 2.0 ) , 0.001 ) * _SpecularPower );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g1169 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g1169 = _SpecularTint;
				float4 temp_output_13_0_g1170 = ( ( smoothstepResult22_g1171 * pow( saturate( ( 1.0 - ( dotResult16_g1171 * dotResult16_g1171 ) ) ) , specularPower237_g1169 ) ) * temp_output_132_0_g1169 * temp_output_131_0_g1169 );
				...
				float3 From8_g1168 = _HighlightBDistribution;
				float ID8_g1168 = idMap383;
				float Fac8_g1168 = _HighlightBStrength;
				float localThreePointDistribution8_g1168 = ThreePointDistribution( From8_g1168 , ID8_g1168 , Fac8_g1168 );
				float temp_output_24_0_g1168 = root58;
				float lerpResult16_g1168 = lerp( temp_output_24_0_g1168 , ( 1.0 - temp_output_24_0_g1168 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g1168 = lerp( lerpResult18_g1167 , _HighlightBColor , saturate( ( localThreePointDistribution8_g1168 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g1168 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g1168;
				#else
				...
				float4 temp_output_42_0_g1169 = baseColor331;
				float4 temp_output_32_0_g1170 = temp_output_42_0_g1169;
				float temp_output_172_0_g1169 = _SpecularMix;
				float4 lerpResult36_g1170 = lerp( temp_output_13_0_g1170 , ( temp_output_13_0_g1170 * temp_output_32_0_g1170 ) , temp_output_172_0_g1169);
				float3 temp_output_24_0_g1170 = worldNormal86_g1169;
				float dotResult15_g1170 = dot( lightDir55_g1170 , temp_output_24_0_g1170 );
				float temp_output_200_0_g1169 = _Translucency;
				float temp_output_40_0_g1170 = temp_output_200_0_g1169;
				float dotResult54_g1170 = dot( temp_output_24_0_g1170 , viewDIr52_g1170 );
				float dotResult57_g1170 = dot( viewDIr52_g1170 , lightDir55_g1170 );
				float temp_output_208_0_g1169 = _RimPower;
				float temp_output_207_0_g1169 = _RimTransmissionIntensity;
				float3 Color126_g1169 = temp_output_42_0_g1169.rgb;
				float3 TangentWorld126_g1169 = shiftedTangent119_g1169;
				float3 ViewDir126_g1169 = ase_worldViewDir;
				float3 NormalWorld126_g1169 = worldNormal86_g1169;
				float3 SpecularColor126_g1169 = temp_output_131_0_g1169.rgb;
				float SpecularTint126_g1169 = temp_output_172_0_g1169;
				float SpecularPower126_g1169 = specularPower237_g1169;
				float SpecularMultiplier126_g1169 = temp_output_132_0_g1169;
				float3 worldPosition129_g1169 = WorldPosition;
				float3 PositionWorld126_g1169 = worldPosition129_g1169;
				float Translucency126_g1169 = temp_output_200_0_g1169;
				float RimTransmission126_g1169 = temp_output_207_0_g1169;
				float RimPower126_g1169 = temp_output_208_0_g1169;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g1169 = RL_Amplify_Expression_HairLighting_Additional126_g1169( Color126_g1169 , TangentWorld126_g1169 , ViewDir126_g1169 , NormalWorld126_g1169 , SpecularColor126_g1169 , SpecularTint126_g1169 , SpecularPower126_g1169 , SpecularMultiplier126_g1169 , PositionWorld126_g1169 , Translucency126_g1169 , RimTransmission126_g1169 , RimPower126_g1169 );
				float lerpResult644 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult644;
				float temp_output_161_0_g1169 = ambientOcclusion570;
				float lerpResult280_g1169 = lerp( 1.0 , temp_output_161_0_g1169 , _AOOccludeAll);
				float3 bakedGI53_g1169 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g1169);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g1169, bakedGI53_g1169, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g1170 + ( ( saturate( ( ( dotResult15_g1170 * ( 1.0 - temp_output_40_0_g1170 ) ) + temp_output_40_0_g1170 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1170 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1170 ) , 0.0 ) ) , temp_output_208_0_g1169 ) * temp_output_207_0_g1169 ) ) * temp_output_32_0_g1170 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g1169 , 0.0 ) ) * lerpResult280_g1169 ) + ( float4( bakedGI53_g1169 , 0.0 ) * temp_output_42_0_g1169 * temp_output_161_0_g1169 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=19001
1920;0;1920;1029;1455.381;110.0701;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;639;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;1168;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
ASEEND*/
//CHKSM=5AA3BDD61E21D7E6ECA2D5CF4D5AF91207C236C7