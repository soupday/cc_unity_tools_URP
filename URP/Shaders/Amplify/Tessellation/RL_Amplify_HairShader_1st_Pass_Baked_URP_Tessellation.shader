	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				half3 viewDIr52_g862 = ase_worldViewDir;
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * saturate( ( ( lerpResult36_g862 + ( ( saturate( ( ( dotResult15_g862 * ( 1.0 - temp_output_40_0_g862 ) ) + temp_output_40_0_g862 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g862 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g862 ) , 0.0 ) ) , temp_output_208_0_g859 ) * temp_output_207_0_g859 ) ) * temp_output_32_0_g862 ) ) * ase_lightColor ) ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g859 , 0.0 ) ) * lerpResult280_g859 ) + ( half4( bakedGI53_g859 , 0.0 ) * temp_output_42_0_g859 * temp_output_161_0_g859 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
ASEEND*/
//CHKSM=63EBA4ACD5426CC314650E88A68365BF17AFDB4C