	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 normalizeResult10_g985 = normalize( ( flowTangent107_g981 + ( worldNormal86_g981 * lerpResult81_g981 ) ) );
				half3 shiftedTangent119_g981 = normalizeResult10_g985;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				half3 viewDIr52_g983 = ase_worldViewDir;
				half3 worldLight248_g981 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g983 = worldLight248_g981;
				half3 normalizeResult14_g984 = normalize( ( viewDIr52_g983 + lightDir55_g983 ) );
				half dotResult16_g984 = dot( shiftedTangent119_g981 , normalizeResult14_g984 );
				half smoothstepResult22_g984 = smoothstep( -1.0 , 0.0 , dotResult16_g984);
				...
				half4 temp_output_13_0_g983 = ( ( smoothstepResult22_g984 * pow( saturate( ( 1.0 - ( dotResult16_g984 * dotResult16_g984 ) ) ) , specularPower237_g981 ) ) * temp_output_132_0_g981 * temp_output_131_0_g981 );
				...
				half4 temp_output_32_0_g983 = temp_output_42_0_g981;
				half temp_output_172_0_g981 = _SpecularMix;
				half4 lerpResult36_g983 = lerp( temp_output_13_0_g983 , ( temp_output_13_0_g983 * temp_output_32_0_g983 ) , temp_output_172_0_g981);
				half3 temp_output_24_0_g983 = worldNormal86_g981;
				half dotResult15_g983 = dot( lightDir55_g983 , temp_output_24_0_g983 );
				half temp_output_200_0_g981 = _Translucency;
				half temp_output_40_0_g983 = temp_output_200_0_g981;
				half dotResult54_g983 = dot( temp_output_24_0_g983 , viewDIr52_g983 );
				half dotResult57_g983 = dot( viewDIr52_g983 , lightDir55_g983 );
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g983 + ( ( saturate( ( ( dotResult15_g983 * ( 1.0 - temp_output_40_0_g983 ) ) + temp_output_40_0_g983 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g983 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g983 ) , 0.0 ) ) , temp_output_208_0_g981 ) * temp_output_207_0_g981 ) ) * temp_output_32_0_g983 ) ) * ase_lightColor ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g981 , 0.0 ) ) * lerpResult280_g981 ) + ( half4( bakedGI53_g981 , 0.0 ) * temp_output_42_0_g981 * temp_output_161_0_g981 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
Node;AmplifyShaderEditor.ColorNode;32;-5612.805,-421.4388;Inherit;False;Property;_EndColor;End Color;40;0;Create;True;0;0;0;False;0;False;0.6039216,0.454902,0.2862745,0;0.6039216,0.454902,0.2862743,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;39;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294116,0.1411763,0.05098024,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;177;-709.0319,429.8401;Inherit;True;Property;_FlowMap;Flow Map;18;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0324E65343809B5E29783D8B1AFCD0FFD7F94063