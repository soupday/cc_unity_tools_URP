...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_URP_Tessellation"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g984( half3 NormalTS, half3x3 TBN )
			{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 NormalTS13_g984 = ( ( appendResult98_g981 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_worldTangent = IN.ase_texcoord4.xyz;
				half3 ase_worldNormal = IN.ase_texcoord5.xyz;
				half3 Binormal5_g984 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g984 = float3x3(ase_worldTangent, Binormal5_g984, ase_worldNormal);
				half3x3 TBN13_g984 = TBN1_g984;
				half3 localTangentToWorld13_g984 = TangentToWorld13_g984( NormalTS13_g984 , TBN13_g984 );
				half3 flowTangent107_g981 = localTangentToWorld13_g984;
				...
				half3 viewDIr52_g982 = ase_worldViewDir;
				half3 worldLight248_g981 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g982 = worldLight248_g981;
				half3 normalizeResult14_g983 = normalize( ( viewDIr52_g982 + lightDir55_g982 ) );
				half dotResult16_g983 = dot( shiftedTangent119_g981 , normalizeResult14_g983 );
				half smoothstepResult22_g983 = smoothstep( -1.0 , 0.0 , dotResult16_g983);
				...
				half4 temp_output_13_0_g982 = ( ( smoothstepResult22_g983 * pow( saturate( ( 1.0 - ( dotResult16_g983 * dotResult16_g983 ) ) ) , specularPower237_g981 ) ) * temp_output_132_0_g981 * temp_output_131_0_g981 );
				...
				half4 temp_output_32_0_g982 = temp_output_42_0_g981;
				half temp_output_172_0_g981 = _SpecularMix;
				half4 lerpResult36_g982 = lerp( temp_output_13_0_g982 , ( temp_output_13_0_g982 * temp_output_32_0_g982 ) , temp_output_172_0_g981);
				half3 temp_output_24_0_g982 = worldNormal86_g981;
				half dotResult15_g982 = dot( lightDir55_g982 , temp_output_24_0_g982 );
				half temp_output_200_0_g981 = _Translucency;
				half temp_output_40_0_g982 = temp_output_200_0_g981;
				half dotResult54_g982 = dot( temp_output_24_0_g982 , viewDIr52_g982 );
				half dotResult57_g982 = dot( viewDIr52_g982 , lightDir55_g982 );
...
ASEEND*/
//CHKSM=8727EC606F9AD7565A0CF412E5CC27ADAA8EB2E4