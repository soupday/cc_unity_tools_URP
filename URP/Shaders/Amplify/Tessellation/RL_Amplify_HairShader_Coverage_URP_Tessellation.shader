	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Binormal5_g982 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g982 = float3x3(ase_worldTangent, Binormal5_g982, ase_worldNormal);
				...
				float3 lightDir55_g983 = worldLight248_g981;
				float3 normalizeResult14_g984 = normalize( ( viewDIr52_g983 + lightDir55_g983 ) );
				float dotResult16_g984 = dot( shiftedTangent119_g981 , normalizeResult14_g984 );
				...
				float4 temp_output_13_0_g983 = ( ( smoothstepResult22_g984 * pow( saturate( ( 1.0 - ( dotResult16_g984 * dotResult16_g984 ) ) ) , specularPower237_g981 ) ) * temp_output_132_0_g981 * temp_output_131_0_g981 );
				...
				float4 temp_output_32_0_g983 = temp_output_42_0_g981;
				float temp_output_172_0_g981 = _SpecularMix;
				float4 lerpResult36_g983 = lerp( temp_output_13_0_g983 , ( temp_output_13_0_g983 * temp_output_32_0_g983 ) , temp_output_172_0_g981);
				float3 temp_output_24_0_g983 = worldNormal86_g981;
				float dotResult15_g983 = dot( lightDir55_g983 , temp_output_24_0_g983 );
				float temp_output_200_0_g981 = _Translucency;
				float temp_output_40_0_g983 = temp_output_200_0_g981;
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * saturate( ( ( lerpResult36_g983 + ( ( saturate( ( ( dotResult15_g983 * ( 1.0 - temp_output_40_0_g983 ) ) + temp_output_40_0_g983 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g983 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g983 ) , 0.0 ) ) , temp_output_208_0_g981 ) * temp_output_207_0_g981 ) ) * temp_output_32_0_g983 ) ) * ase_lightColor ) ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g981 , 0.0 ) ) * lerpResult280_g981 ) + ( float4( max( bakedGI53_g981 , float3( 0,0,0 ) ) , 0.0 ) * temp_output_42_0_g981 * temp_output_161_0_g981 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
Node;AmplifyShaderEditor.RangedFloatNode;539;-679.4417,923.2449;Inherit;False;Property;_Translucency;Translucency;27;0;Create;True;0;0;0;False;0;False;0;0.15;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;29;0;Create;True;0;0;0;False;0;False;10;10;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularMix;Specular Mix;24;0;Create;True;0;0;0;False;0;False;1;0.75;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-676.3562,1073.421;Inherit;False;Property;_RimPower;Rim Hardness;28;0;Create;False;0;0;0;False;0;False;4;2.5;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;39;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294116,0.1411763,0.05098028,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;978.6932,1167.645;Float;False;True;-1;2;ASEMaterialInspector;0;13;Reallusion/Amplify/RL_HairShader_Coverage_URP_Tessellation;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;6;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Forward Only;1;638364369699960060;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992251365997;Meta Pass;0;638047162328304058;Extra Pre Pass;0;0;Tessellation;1;638047089588697188;  Phong;1;638047089599858817;  Strength;0.5,False,;0;  Type;2;638047089617967541;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;False;False;;True;0
...
ASEEND*/
//CHKSM=969E5AC39AD4F224739052CCD9FDBE2D11E2AC89