...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_URP_Tessellation"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g982( half3 NormalTS, half3x3 TBN )
			{
			...
			half3 RL_Amplify_Expression_HairLighting_Additional126_g981( half3 Color, half3 TangentWorld, half3 ViewDir, half3 NormalWorld, half3 SpecularColor, half SpecularTint, half SpecularPower, half SpecularMultiplier, half3 PositionWorld, half Translucency, half RimTransmission, half RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half4 break109_g981 = SAMPLE_TEXTURE2D( _FlowMap, sampler_DiffuseMap, uv_FlowMap );
				half lerpResult123_g981 = lerp( break109_g981.g , ( 1.0 - break109_g981.g ) , _FlowMapFlipGreen);
				half3 appendResult98_g981 = (half3(break109_g981.r , lerpResult123_g981 , break109_g981.b));
				half3 NormalTS13_g982 = ( ( appendResult98_g981 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_worldTangent = IN.ase_texcoord5.xyz;
				half3 ase_worldNormal = IN.ase_texcoord6.xyz;
				half3 Binormal5_g982 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g982 = float3x3(ase_worldTangent, Binormal5_g982, ase_worldNormal);
				half3x3 TBN13_g982 = TBN1_g982;
				half3 localTangentToWorld13_g982 = TangentToWorld13_g982( NormalTS13_g982 , TBN13_g982 );
				half3 flowTangent107_g981 = localTangentToWorld13_g982;
				...
				half3 worldNormal85_g981 = normalize( float3(dot(tanToWorld0,tanNormal85_g981), dot(tanToWorld1,tanNormal85_g981), dot(tanToWorld2,tanNormal85_g981)) );
				half3 worldNormal86_g981 = worldNormal85_g981;
				...
				half lerpResult81_g981 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				half3 normalizeResult10_g983 = normalize( ( flowTangent107_g981 + ( worldNormal86_g981 * lerpResult81_g981 ) ) );
				half3 shiftedTangent119_g981 = normalizeResult10_g983;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				half3 viewDIr52_g984 = ase_worldViewDir;
				half3 worldLight248_g981 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g984 = worldLight248_g981;
				half3 normalizeResult14_g985 = normalize( ( viewDIr52_g984 + lightDir55_g984 ) );
				half dotResult16_g985 = dot( shiftedTangent119_g981 , normalizeResult14_g985 );
				half smoothstepResult22_g985 = smoothstep( -1.0 , 0.0 , dotResult16_g985);
				...
				half temp_output_233_0_g981 = max( ( 1.0 - smoothness594 ) , 0.001 );
				half specularPower237_g981 = ( max( ( ( 2.0 / ( temp_output_233_0_g981 * temp_output_233_0_g981 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord4.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				half temp_output_132_0_g981 = ( SAMPLE_TEXTURE2D( _SpecularMap, sampler_DiffuseMap, uv_SpecularMap ).g * _SpecularMultiplier );
				half4 temp_output_131_0_g981 = _SpecularTint;
				half4 temp_output_13_0_g984 = ( ( smoothstepResult22_g985 * pow( saturate( ( 1.0 - ( dotResult16_g985 * dotResult16_g985 ) ) ) , specularPower237_g981 ) ) * temp_output_132_0_g981 * temp_output_131_0_g981 );
				...
				half4 temp_output_42_0_g981 = baseColor331;
				half4 temp_output_32_0_g984 = temp_output_42_0_g981;
				half temp_output_172_0_g981 = _SpecularMix;
				half4 lerpResult36_g984 = lerp( temp_output_13_0_g984 , ( temp_output_13_0_g984 * temp_output_32_0_g984 ) , temp_output_172_0_g981);
				half3 temp_output_24_0_g984 = worldNormal86_g981;
				half dotResult15_g984 = dot( lightDir55_g984 , temp_output_24_0_g984 );
				half temp_output_200_0_g981 = _Translucency;
				half temp_output_40_0_g984 = temp_output_200_0_g981;
				half dotResult54_g984 = dot( temp_output_24_0_g984 , viewDIr52_g984 );
				half dotResult57_g984 = dot( viewDIr52_g984 , lightDir55_g984 );
				half temp_output_208_0_g981 = _RimPower;
				half temp_output_207_0_g981 = _RimTransmissionIntensity;
				...
				half3 Color126_g981 = temp_output_42_0_g981.rgb;
				half3 TangentWorld126_g981 = shiftedTangent119_g981;
				half3 ViewDir126_g981 = ase_worldViewDir;
				half3 NormalWorld126_g981 = worldNormal86_g981;
				half3 SpecularColor126_g981 = temp_output_131_0_g981.rgb;
				half SpecularTint126_g981 = temp_output_172_0_g981;
				half SpecularPower126_g981 = specularPower237_g981;
				half SpecularMultiplier126_g981 = temp_output_132_0_g981;
				half3 worldPosition129_g981 = WorldPosition;
				half3 PositionWorld126_g981 = worldPosition129_g981;
				half Translucency126_g981 = temp_output_200_0_g981;
				half RimTransmission126_g981 = temp_output_207_0_g981;
				half RimPower126_g981 = temp_output_208_0_g981;
				half3 localRL_Amplify_Expression_HairLighting_Additional126_g981 = RL_Amplify_Expression_HairLighting_Additional126_g981( Color126_g981 , TangentWorld126_g981 , ViewDir126_g981 , NormalWorld126_g981 , SpecularColor126_g981 , SpecularTint126_g981 , SpecularPower126_g981 , SpecularMultiplier126_g981 , PositionWorld126_g981 , Translucency126_g981 , RimTransmission126_g981 , RimPower126_g981 );
				half lerpResult632 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				half ambientOcclusion570 = lerpResult632;
				half temp_output_161_0_g981 = ambientOcclusion570;
				half lerpResult280_g981 = lerp( 1.0 , temp_output_161_0_g981 , _AOOccludeAll);
				half3 bakedGI53_g981 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g981);
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-5293.459,1333.562;Inherit;False;Property;_AlphaPower;Alpha Power;5;0;Create;True;0;0;0;False;0;False;1;0.5;0.01;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;134;-1461.834,1309.566;Inherit;False;Property;_EmissiveColor;Emissive Color;31;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;50;-5668.366,1711.348;Inherit;True;Property;_IDMap;ID Map;41;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;133;-1503.434,1109.366;Inherit;True;Property;_EmissionMap;Emission Map;30;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;539;-679.4417,923.2449;Inherit;False;Property;_Translucency;Translucency;27;0;Create;True;0;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;29;0;Create;True;0;0;0;False;0;False;10;15;0;50;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;596;-689.4732,354.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;23;0;Create;False;0;0;0;False;0;False;4;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;625;-4796.458,288.7647;Inherit;False;Property;_HighlightBlend;Highlight Blend;42;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;623;-1450.903,-298.3369;Inherit;False;Property;_DiffuseColor;Diffuse Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;115;-2785.541,1954.936;Inherit;True;Property;_MaskMap;Mask Map;8;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;32;-5612.805,-421.4388;Inherit;False;Property;_EndColor;End Color;40;0;Create;True;0;0;0;False;0;False;0.6039216,0.454902,0.2862745,0;0.6039216,0.454902,0.2862743,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;620;-1217.625,141.5345;Inherit;True;Property;_SpecularMap;Specular Map;20;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1199.927,338.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;22;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularMix;Specular Mix;24;0;Create;True;0;0;0;False;0;False;1;0.5;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-676.3562,1073.421;Inherit;False;Property;_RimPower;Rim Hardness;28;0;Create;False;0;0;0;False;0;False;4;4;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;180;-627.6543,619.2548;Inherit;False;Property;_FlowMapFlipGreen;Flow Map Flip Green;19;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;39;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294116,0.1411763,0.05098024,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;92;-4296.681,19.90401;Inherit;False;Property;_HighlightBColor;Highlight B Color;49;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;69;-4960.777,-437.1049;Inherit;False;Property;_HighlightAColor;Highlight A Color;44;0;Create;True;0;0;0;False;0;False;0.9137255,0.7803922,0.6352941,0;0.9137255,0.7803922,0.635294,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-1865.578,2437.963;Inherit;False;Property;_AOStrength;Ambient Occlusion Strength;9;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;378;-628.2301,-49.07933;Inherit;False;Property;_SpecularTint;Specular Tint;21;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;978.6932,1167.645;Half;False;True;-1;2;ASEMaterialInspector;0;13;Reallusion/Amplify/RL_HairShader_Coverage_URP_Tessellation;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;6;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;21;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992251365997;Meta Pass;0;638047162328304058;Extra Pre Pass;0;0;Tessellation;1;638047089588697188;  Phong;1;638047089599858817;  Strength;0.5,False,;0;  Type;2;638047089617967541;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;5;False;True;True;True;False;False;;True;0
...
ASEEND*/
//CHKSM=E5B064753283F8165E388DFBC665A4A34E239359