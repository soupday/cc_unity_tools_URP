...
Shader "Reallusion/Amplify/RL_HairShader_Coverage_URP_Tessellation"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 TangentToWorld13_g993( float3 NormalTS, float3x3 TBN )
			{
			...
			float3 RL_Amplify_Expression_HairLighting_Additional126_g990( float3 Color, float3 TangentWorld, float3 ViewDir, float3 NormalWorld, float3 SpecularColor, float SpecularTint, float SpecularPower, float SpecularMultiplier, float3 PositionWorld, float Translucency, float RimTransmission, float RimPower )
			{
				half3 addColor = 0;
				half4 shadowMask = 1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 break109_g990 = tex2D( _FlowMap, uv_FlowMap );
				float lerpResult123_g990 = lerp( break109_g990.g , ( 1.0 - break109_g990.g ) , _FlowMapFlipGreen);
				float3 appendResult98_g990 = (float3(break109_g990.r , lerpResult123_g990 , break109_g990.b));
				float3 NormalTS13_g993 = ( ( appendResult98_g990 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				float3 ase_worldTangent = IN.ase_texcoord4.xyz;
				float3 ase_worldNormal = IN.ase_texcoord5.xyz;
				float3 Binormal5_g993 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				float3x3 TBN1_g993 = float3x3(ase_worldTangent, Binormal5_g993, ase_worldNormal);
				float3x3 TBN13_g993 = TBN1_g993;
				float3 localTangentToWorld13_g993 = TangentToWorld13_g993( NormalTS13_g993 , TBN13_g993 );
				float3 flowTangent107_g990 = localTangentToWorld13_g993;
				...
				float3 tanNormal85_g990 = normal282;
				float3 worldNormal85_g990 = normalize( float3(dot(tanToWorld0,tanNormal85_g990), dot(tanToWorld1,tanNormal85_g990), dot(tanToWorld2,tanNormal85_g990)) );
				float3 worldNormal86_g990 = worldNormal85_g990;
				float2 uv_IDMap = IN.ase_texcoord3.xy * _IDMap_ST.xy + _IDMap_ST.zw;
				float idMap383 = tex2D( _IDMap, uv_IDMap ).r;
				float lerpResult81_g990 = lerp( _SpecularShiftMin , _SpecularShiftMax , idMap383);
				float3 normalizeResult10_g994 = normalize( ( flowTangent107_g990 + ( worldNormal86_g990 * lerpResult81_g990 ) ) );
				float3 shiftedTangent119_g990 = normalizeResult10_g994;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				float3 viewDIr52_g991 = ase_worldViewDir;
				float3 worldLight248_g990 = SafeNormalize(_MainLightPosition.xyz);
				float3 lightDir55_g991 = worldLight248_g990;
				float3 normalizeResult14_g992 = normalize( ( viewDIr52_g991 + lightDir55_g991 ) );
				float dotResult16_g992 = dot( shiftedTangent119_g990 , normalizeResult14_g992 );
				float smoothstepResult22_g992 = smoothstep( -1.0 , 0.0 , dotResult16_g992);
				...
				float temp_output_233_0_g990 = max( ( 1.0 - smoothness594 ) , 0.001 );
				float specularPower237_g990 = ( max( ( ( 2.0 / ( temp_output_233_0_g990 * temp_output_233_0_g990 ) ) - 2.0 ) , 0.001 ) * _SpecularPowerScale );
				float2 uv_SpecularMap = IN.ase_texcoord3.xy * _SpecularMap_ST.xy + _SpecularMap_ST.zw;
				float temp_output_132_0_g990 = ( tex2D( _SpecularMap, uv_SpecularMap ).g * _SpecularMultiplier );
				float4 temp_output_131_0_g990 = _SpecularTint;
				float4 temp_output_13_0_g991 = ( ( smoothstepResult22_g992 * pow( saturate( ( 1.0 - ( dotResult16_g992 * dotResult16_g992 ) ) ) , specularPower237_g990 ) ) * temp_output_132_0_g990 * temp_output_131_0_g990 );
				...
				float4 lerpResult18_g996 = lerp( float4( 1,1,1,0 ) , diffuseMap517 , _BaseColorStrength);
				float2 uv_RootMap = IN.ase_texcoord3.xy * _RootMap_ST.xy + _RootMap_ST.zw;
				float root58 = tex2D( _RootMap, uv_RootMap ).r;
				float temp_output_27_0_g996 = root58;
				float lerpResult23_g996 = lerp( temp_output_27_0_g996 , ( 1.0 - temp_output_27_0_g996 ) , _InvertRootMap);
				float4 lerpResult3_g996 = lerp( _RootColor , _EndColor , lerpResult23_g996);
				float lerpResult40_g996 = lerp( _RootColorStrength , _EndColorStrength , lerpResult23_g996);
				float4 lerpResult6_g996 = lerp( lerpResult18_g996 , lerpResult3_g996 , ( lerpResult40_g996 * _GlobalStrength ));
				float3 From8_g995 = _HighlightADistribution;
				float ID8_g995 = idMap383;
				float Fac8_g995 = _HighlightAStrength;
				float localThreePointDistribution8_g995 = ThreePointDistribution( From8_g995 , ID8_g995 , Fac8_g995 );
				float temp_output_24_0_g995 = root58;
				float lerpResult16_g995 = lerp( temp_output_24_0_g995 , ( 1.0 - temp_output_24_0_g995 ) , _HighlightAOverlapInvert);
				float4 lerpResult18_g995 = lerp( lerpResult6_g996 , _HighlightAColor , saturate( ( localThreePointDistribution8_g995 * ( 1.0 - ( _HighlightAOverlapEnd * lerpResult16_g995 ) ) * _HighlightBlend ) ));
				float3 From8_g989 = _HighlightBDistribution;
				float ID8_g989 = idMap383;
				float Fac8_g989 = _HighlightBStrength;
				...
				float lerpResult16_g989 = lerp( temp_output_24_0_g989 , ( 1.0 - temp_output_24_0_g989 ) , _HighlightBOverlapInvert);
				float4 lerpResult18_g989 = lerp( lerpResult18_g995 , _HighlightBColor , saturate( ( localThreePointDistribution8_g989 * ( 1.0 - ( _HighlightBOverlapEnd * lerpResult16_g989 ) ) * _HighlightBlend ) ));
				#ifdef BOOLEAN_ENABLECOLOR_ON
				float4 staticSwitch95 = lerpResult18_g989;
				#else
				...
				float4 temp_output_42_0_g990 = baseColor331;
				float4 temp_output_32_0_g991 = temp_output_42_0_g990;
				float temp_output_172_0_g990 = _SpecularMix;
				float4 lerpResult36_g991 = lerp( temp_output_13_0_g991 , ( temp_output_13_0_g991 * temp_output_32_0_g991 ) , temp_output_172_0_g990);
				float3 temp_output_24_0_g991 = worldNormal86_g990;
				float dotResult15_g991 = dot( lightDir55_g991 , temp_output_24_0_g991 );
				float temp_output_200_0_g990 = _Translucency;
				float temp_output_40_0_g991 = temp_output_200_0_g990;
				float dotResult54_g991 = dot( temp_output_24_0_g991 , viewDIr52_g991 );
				float dotResult57_g991 = dot( viewDIr52_g991 , lightDir55_g991 );
				float temp_output_208_0_g990 = _RimPower;
				float temp_output_207_0_g990 = _RimTransmissionIntensity;
				float3 Color126_g990 = temp_output_42_0_g990.rgb;
				float3 TangentWorld126_g990 = shiftedTangent119_g990;
				float3 ViewDir126_g990 = ase_worldViewDir;
				float3 NormalWorld126_g990 = worldNormal86_g990;
				float3 SpecularColor126_g990 = temp_output_131_0_g990.rgb;
				float SpecularTint126_g990 = temp_output_172_0_g990;
				float SpecularPower126_g990 = specularPower237_g990;
				float SpecularMultiplier126_g990 = temp_output_132_0_g990;
				float3 worldPosition129_g990 = WorldPosition;
				float3 PositionWorld126_g990 = worldPosition129_g990;
				float Translucency126_g990 = temp_output_200_0_g990;
				float RimTransmission126_g990 = temp_output_207_0_g990;
				float RimPower126_g990 = temp_output_208_0_g990;
				float3 localRL_Amplify_Expression_HairLighting_Additional126_g990 = RL_Amplify_Expression_HairLighting_Additional126_g990( Color126_g990 , TangentWorld126_g990 , ViewDir126_g990 , NormalWorld126_g990 , SpecularColor126_g990 , SpecularTint126_g990 , SpecularPower126_g990 , SpecularMultiplier126_g990 , PositionWorld126_g990 , Translucency126_g990 , RimTransmission126_g990 , RimPower126_g990 );
				float lerpResult632 = lerp( 1.0 , tex2DNode115.g , _AOStrength);
				float ambientOcclusion570 = lerpResult632;
				float temp_output_161_0_g990 = ambientOcclusion570;
				float lerpResult280_g990 = lerp( 1.0 , temp_output_161_0_g990 , _AOOccludeAll);
				float3 bakedGI53_g990 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g990);
				MixRealtimeAndBakedGI(ase_mainLight, worldNormal86_g990, bakedGI53_g990, half4(0,0,0,0));
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * ( ( lerpResult36_g991 + ( ( saturate( ( ( dotResult15_g991 * ( 1.0 - temp_output_40_0_g991 ) ) + temp_output_40_0_g991 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g991 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g991 ) , 0.0 ) ) , temp_output_208_0_g990 ) * temp_output_207_0_g990 ) ) * temp_output_32_0_g991 ) ) * _MainLightColor ) ) + float4( localRL_Amplify_Expression_HairLighting_Additional126_g990 , 0.0 ) ) * lerpResult280_g990 ) + ( float4( bakedGI53_g990 , 0.0 ) * temp_output_42_0_g990 * temp_output_161_0_g990 ) ) + ( tex2D( _EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
/*ASEBEGIN
Version=19001
1920;0;1920;1029;1874.827;-652.8317;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;573;-759.7318,-401.0714;Inherit;False;1077.37;1516.308;;16;539;571;569;108;263;572;389;177;180;385;384;482;378;265;595;596;Specular Highlights;1,0.7932334,0.514151,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;121;-2526.007,-395.2434;Inherit;False;1611.361;818.9382;;16;331;96;104;97;101;105;106;107;113;98;112;99;380;620;624;623;Final Color Blending;0.514151,1,0.6056049,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;516;-5730.066,-1036.8;Inherit;False;2272.674;1645.196;;26;91;88;92;87;84;508;69;53;52;54;55;503;519;504;27;31;32;33;29;30;28;59;510;509;502;625;Hair Color Blending;0.5330188,1,0.6022252,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;122;-1933.03,2270.963;Inherit;False;994.7638;256.5405;;4;155;116;632;570;Ambient Occlusion;0.504717,1,0.9766926,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;482;-691.7015,199.9869;Inherit;False;Property;_SpecularMix;Specular Mix;49;0;Create;True;0;0;0;False;0;False;1;0.75;0.5;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;624;-1233.396,-164.2825;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;385;-684.1522,771.6683;Inherit;False;Property;_SpecularShiftMin;Specular Shift Min;50;0;Create;True;0;0;0;False;0;False;-0.25;-0.25;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;510;-3968.615,-191.6566;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;139;-1484.06,640.5557;Inherit;True;Property;_NormalMap;Normal Map;15;1;[Normal];Create;True;0;0;0;False;0;False;19;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;521;606.8756,1415.891;Inherit;False;518;alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;532;504.2272,1582.883;Inherit;False;Property;_ShadowClip;Shadow Clip;8;0;Create;True;0;0;0;False;0;False;0.25;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;180;-627.6543,619.2548;Inherit;False;Property;_FlowMapFlipGreen;Flow Map Flip Green;43;1;[Toggle];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;263;-676.3562,1073.421;Inherit;False;Property;_RimPower;Rim Hardness;44;0;Create;False;0;0;0;False;0;False;4;2.5;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;380;-1199.927,338.3215;Inherit;False;Property;_SpecularMultiplier;Specular Strength;47;0;Create;False;0;0;0;False;0;False;1;0.5;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;105;-1881.327,189.0002;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;629;-110.9783,9.531306;Inherit;False;RL_Amplify_Function_Hair_AnisotropicLighting;-1;;990;1c2ce0d33e6d0364e94912a58b37cdd2;1,88,0;18;42;COLOR;1,1,1,0;False;161;FLOAT;1;False;178;FLOAT;1;False;84;FLOAT3;0,0,1;False;26;FLOAT3;0,0,1;False;131;COLOR;1,1,1,0;False;7;FLOAT;50;False;172;FLOAT;0;False;132;FLOAT;1;False;245;FLOAT;2;False;108;COLOR;0,0,0,0;False;112;FLOAT;0;False;71;FLOAT;0.5;False;75;FLOAT;-0.1;False;80;FLOAT;0.1;False;200;FLOAT;0;False;207;FLOAT;0;False;208;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;628;-4431.044,-426.122;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;995;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;508;-4260.21,-59.08698;Inherit;False;383;idMap;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;125;-1707.221,1837.011;Inherit;False;Property;_SmoothnessMax;Smoothness Max;14;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-1865.578,2437.963;Inherit;False;Property;_AOStrength;Ambient Occlusion Strength;10;0;Create;False;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;631;-5087.463,-880.7275;Inherit;False;RL_Amplify_Function_Hair_RootBlend;-1;;996;3304ef6ee2139bd4cab5d899498bc3dd;0;9;26;COLOR;0,0,0,0;False;37;FLOAT;1;False;27;FLOAT;0;False;31;FLOAT;1;False;35;COLOR;0.3294118,0.1411765,0.05098039,0;False;36;COLOR;0.6039216,0.454902,0.2862745,0;False;32;FLOAT;1;False;33;FLOAT;1;False;34;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;177;-709.0319,429.8401;Inherit;True;Property;_FlowMap;Flow Map;42;0;Create;True;0;0;0;False;0;False;19;cc37af08370d26540b0e6725a8b8879e;cc37af08370d26540b0e6725a8b8879e;True;0;False;gray;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;31;-5612.955,-600.91;Inherit;False;Property;_RootColor;Root Color;25;0;Create;True;0;0;0;False;0;False;0.3294118,0.1411765,0.05098039,0;0.3294116,0.1411763,0.05098028,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;621;-854.3749,282.501;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;32;-5612.805,-421.4388;Inherit;False;Property;_EndColor;End Color;26;0;Create;True;0;0;0;False;0;False;0.6039216,0.454902,0.2862745,0;0.6039216,0.454902,0.2862743,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;155;-1890.458,2313.48;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;115;-2785.541,1954.936;Inherit;True;Property;_MaskMap;Mask Map;9;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;99;-2001.331,16.97653;Inherit;False;Property;_BlendStrength;Blend Strength;19;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;570;-1168.033,2344.833;Inherit;False;ambientOcclusion;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;627;-3805.556,-56.1289;Inherit;False;RL_Amplify_Function_Hair_IDBlend;-1;;989;6afb608343a58854589726462adfdb8b;0;9;26;COLOR;1,1,1,0;False;24;FLOAT;0.5;False;27;FLOAT;0.5;False;25;COLOR;0.9137256,0.7803922,0.6352941,0;False;21;FLOAT;1;False;20;FLOAT3;0.1,0.2,0.3;False;22;FLOAT;1;False;23;FLOAT;1;False;28;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.WireNode;622;-465.9995,291.0178;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;620;-1217.625,141.5345;Inherit;True;Property;_SpecularMap;Specular Map;18;0;Create;True;0;0;0;False;0;False;19;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;389;-681.8292,847.2004;Inherit;False;Property;_SpecularShiftMax;Specular Shift Max;51;0;Create;True;0;0;0;False;0;False;0.25;0.25;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;623;-1450.903,-298.3369;Inherit;False;Property;_DiffuseColor;Diffuse Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;596;-689.4732,354.8531;Inherit;False;Property;_SpecularPowerScale;Specular Smoothness;48;0;Create;False;0;0;0;False;0;False;4;2;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;265;-678.6436,998.7183;Inherit;False;Property;_RimTransmissionIntensity;Rim Transmission Intensity;45;0;Create;True;0;0;0;False;0;False;10;10;0;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;625;-4796.458,288.7647;Inherit;False;Property;_HighlightBlend;Highlight Blend;28;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;539;-679.4417,923.2449;Inherit;False;Property;_Translucency;Translucency;52;0;Create;True;0;0;0;False;0;False;0;0.15;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;504;-5567.181,-781.3913;Inherit;False;58;root;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;112;-1427.735,4.108437;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;978.6932,1167.645;Float;False;True;-1;2;ASEMaterialInspector;0;12;Reallusion/Amplify/RL_HairShader_Coverage_URP_Tessellation;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;6;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;23;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992251365997;DOTS Instancing;0;0;Meta Pass;1;637793397279481765;Extra Pre Pass;0;0;Tessellation;1;637999711131441535;  Phong;1;637999711141338886;  Strength;0.5,False,;0;  Type;2;637999719770196674;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=BA06BA54A568A3CC896DE37D97D465834BA14B50