	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 Binormal5_g1088 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g1088 = float3x3(ase_worldTangent, Binormal5_g1088, ase_worldNormal);
				...
				half3 normalizeResult10_g1091 = normalize( ( flowTangent107_g1087 + ( worldNormal86_g1087 * lerpResult81_g1087 ) ) );
				half3 shiftedTangent119_g1087 = normalizeResult10_g1091;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				half3 viewDIr52_g1089 = ase_worldViewDir;
				half3 worldLight248_g1087 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g1089 = worldLight248_g1087;
				half3 normalizeResult14_g1090 = normalize( ( viewDIr52_g1089 + lightDir55_g1089 ) );
				half dotResult16_g1090 = dot( shiftedTangent119_g1087 , normalizeResult14_g1090 );
				half smoothstepResult22_g1090 = smoothstep( -1.0 , 0.0 , dotResult16_g1090);
				...
				half4 temp_output_13_0_g1089 = ( ( smoothstepResult22_g1090 * pow( saturate( ( 1.0 - ( dotResult16_g1090 * dotResult16_g1090 ) ) ) , specularPower237_g1087 ) ) * temp_output_132_0_g1087 * temp_output_131_0_g1087 );
				...
				half4 temp_output_32_0_g1089 = temp_output_42_0_g1087;
				half temp_output_172_0_g1087 = _SpecularMix;
				half4 lerpResult36_g1089 = lerp( temp_output_13_0_g1089 , ( temp_output_13_0_g1089 * temp_output_32_0_g1089 ) , temp_output_172_0_g1087);
				half3 temp_output_24_0_g1089 = worldNormal86_g1087;
				half dotResult15_g1089 = dot( lightDir55_g1089 , temp_output_24_0_g1089 );
				half temp_output_200_0_g1087 = _Translucency;
				half temp_output_40_0_g1089 = temp_output_200_0_g1087;
				half dotResult54_g1089 = dot( temp_output_24_0_g1089 , viewDIr52_g1089 );
				half dotResult57_g1089 = dot( viewDIr52_g1089 , lightDir55_g1089 );
				...
				half3 ViewDir126_g1087 = ase_worldViewDir;
				...
				half3 bakedGI53_g1087 = ASEIndirectDiffuse( IN.lightmapUVOrVertexSH.xy, worldNormal86_g1087);
				...
				float3 Color = ( ( ( ( ( ase_lightAtten * saturate( ( ( lerpResult36_g1089 + ( ( saturate( ( ( dotResult15_g1089 * ( 1.0 - temp_output_40_0_g1089 ) ) + temp_output_40_0_g1089 ) ) + ( pow( ( max( ( 1.0 - abs( dotResult54_g1089 ) ) , 0.0 ) * max( ( 0.0 - dotResult57_g1089 ) , 0.0 ) ) , temp_output_208_0_g1087 ) * temp_output_207_0_g1087 ) ) * temp_output_32_0_g1089 ) ) * ase_lightColor ) ) ) + half4( localRL_Amplify_Expression_HairLighting_Additional126_g1087 , 0.0 ) ) * lerpResult280_g1087 ) + ( half4( max( bakedGI53_g1087 , float3( 0,0,0 ) ) , 0.0 ) * temp_output_42_0_g1087 * temp_output_161_0_g1087 ) ) + ( SAMPLE_TEXTURE2D( _EmissionMap, sampler_EmissionMap, uv_EmissionMap ) * _EmissiveColor ) ).rgb;
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;297;905.9279,1167.715;Half;False;True;-1;2;ASEMaterialInspector;0;13;Reallusion/Amplify/RL_HairShader_1st_Pass_Variants_URP_Tessellation;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;6;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;0;637786971353641789;Forward Only;1;638048887553535336;Cast Shadows;1;0;  Use Shadow Threshold;1;637787018088018178;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;1;637787992114575262;Meta Pass;0;638047162068978155;Extra Pre Pass;0;0;Tessellation;1;638047089346763986;  Phong;1;637788078022368415;  Strength;0.5,False,;0;  Type;2;638047089386213177;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;False;False;;True;0
...
ASEEND*/
//CHKSM=55BE0DEB9D4DEAE7E5CA382681D115F56385FF52