	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 normalizeResult10_g987 = normalize( ( flowTangent107_g985 + ( worldNormal86_g985 * lerpResult81_g985 ) ) );
				half3 shiftedTangent119_g985 = normalizeResult10_g987;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				ase_worldViewDir = SafeNormalize( ase_worldViewDir );
				half3 viewDIr52_g988 = ase_worldViewDir;
				half3 worldLight248_g985 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g988 = worldLight248_g985;
				half3 normalizeResult14_g989 = normalize( ( viewDIr52_g988 + lightDir55_g988 ) );
				half dotResult16_g989 = dot( shiftedTangent119_g985 , normalizeResult14_g989 );
				half smoothstepResult22_g989 = smoothstep( -1.0 , 0.0 , dotResult16_g989);
				...
				half4 temp_output_13_0_g988 = ( ( smoothstepResult22_g989 * pow( saturate( ( 1.0 - ( dotResult16_g989 * dotResult16_g989 ) ) ) , specularPower237_g985 ) ) * temp_output_132_0_g985 * temp_output_131_0_g985 );
				...
				half4 temp_output_32_0_g988 = temp_output_42_0_g985;
				half temp_output_172_0_g985 = _SpecularMix;
				half4 lerpResult36_g988 = lerp( temp_output_13_0_g988 , ( temp_output_13_0_g988 * temp_output_32_0_g988 ) , temp_output_172_0_g985);
				half3 temp_output_24_0_g988 = worldNormal86_g985;
				half dotResult15_g988 = dot( lightDir55_g988 , temp_output_24_0_g988 );
				half temp_output_200_0_g985 = _Translucency;
				half temp_output_40_0_g988 = temp_output_200_0_g985;
				half dotResult54_g988 = dot( temp_output_24_0_g988 , viewDIr52_g988 );
				half dotResult57_g988 = dot( viewDIr52_g988 , lightDir55_g988 );
...
ASEEND*/
//CHKSM=44FDDCAD3354065B94373EFEBC4A9FF282421252