...
Shader "Reallusion/Amplify/RL_HairShader_Variants_URP_Tessellation"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half3 TangentToWorld13_g986( half3 NormalTS, half3x3 TBN )
			{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				half3 NormalTS13_g986 = ( ( appendResult98_g985 * float3( 2,2,2 ) ) - float3( 1,1,1 ) );
				half3 ase_worldTangent = IN.ase_texcoord4.xyz;
				half3 ase_worldNormal = IN.ase_texcoord5.xyz;
				half3 Binormal5_g986 = ( ( IN.ase_tangent.w > 0.0 ? 1.0 : -1.0 ) * cross( ase_worldNormal , ase_worldTangent ) );
				half3x3 TBN1_g986 = float3x3(ase_worldTangent, Binormal5_g986, ase_worldNormal);
				half3x3 TBN13_g986 = TBN1_g986;
				half3 localTangentToWorld13_g986 = TangentToWorld13_g986( NormalTS13_g986 , TBN13_g986 );
				half3 flowTangent107_g985 = localTangentToWorld13_g986;
				...
				half3 viewDIr52_g987 = ase_worldViewDir;
				half3 worldLight248_g985 = SafeNormalize(_MainLightPosition.xyz);
				half3 lightDir55_g987 = worldLight248_g985;
				half3 normalizeResult14_g988 = normalize( ( viewDIr52_g987 + lightDir55_g987 ) );
				half dotResult16_g988 = dot( shiftedTangent119_g985 , normalizeResult14_g988 );
				half smoothstepResult22_g988 = smoothstep( -1.0 , 0.0 , dotResult16_g988);
				...
				half4 temp_output_13_0_g987 = ( ( smoothstepResult22_g988 * pow( saturate( ( 1.0 - ( dotResult16_g988 * dotResult16_g988 ) ) ) , specularPower237_g985 ) ) * temp_output_132_0_g985 * temp_output_131_0_g985 );
				...
				half4 temp_output_32_0_g987 = temp_output_42_0_g985;
				half temp_output_172_0_g985 = _SpecularMix;
				half4 lerpResult36_g987 = lerp( temp_output_13_0_g987 , ( temp_output_13_0_g987 * temp_output_32_0_g987 ) , temp_output_172_0_g985);
				half3 temp_output_24_0_g987 = worldNormal86_g985;
				half dotResult15_g987 = dot( lightDir55_g987 , temp_output_24_0_g987 );
				half temp_output_200_0_g985 = _Translucency;
				half temp_output_40_0_g987 = temp_output_200_0_g985;
				half dotResult54_g987 = dot( temp_output_24_0_g987 , viewDIr52_g987 );
				half dotResult57_g987 = dot( viewDIr52_g987 , lightDir55_g987 );
...
ASEEND*/
//CHKSM=BB4DA90D139D1C1DE63B40C8A3DE08C0307FEAC7